		...
		if ($responseData->success) {
            ...
            $input = mysqli_query($mysqli,"INSERT INTO al_white_papers (white_paper_id,white_paper_type,company_name,department_name,url_social_media,position,name,email,phone,verifikasi_code,verifikasi_type,whitepaper_regdate) VALUES('','$white_paper_type','$company_name','$department_name','$url_social_media','$position','$name','$email','$phone','$verifikasi_code','$type_dokumen','$whitepaper_regdate')");	
				...
				if ($formproc->ProcessForm()) {
						$msg = "<div class='alert alert-success' id='msg' role='alert'>Terima kasih telah melakukan pengisian formulir kami, silakan cek email Anda untuk mendapatkan link download Whitepaper. [<a href='".$base_url."layanan/penetration-test.php'>Klik Disini</a>] untuk kembali ke halaman Layanan Pembuatan Website LOGIQUE.</div>";
						$co = "1";
					}
...
<head>
    ...
    <meta name="description" itemprop="description"
        content="Download panduan lengkap mengenai langkah antisipasi & cara penanganan ancaman serangan terhadap aplikasi berbasis web / web application disini. | LOGIQUE">
    <meta name="keywords"
    ...
    <meta property="og:title" content="White Paper Download | Ancaman Serangan Pada Web App">
    ...
    <title>White Paper Download | Ancaman Serangan Pada Web App</title>

    <link rel="canonical" href="https://www.logique.co.id/white-paper-ancaman-serangan-web-application.php" />
                                    ...
                                    <div class="col-md-8 col-md-offset-2 col-sm-offset-1 col-sm-10">
                                        ...
                                        <div class="form-group">
                                           <select name="white_paper_type" id="white_paper_type" class="form-control">
												<option value="Ancaman Serangan pada Web Application">Ancaman Serangan pada Web Application</option>
										   </select>
                                        </div>
                                    </div>
									<div class="col-md-8 col-md-offset-2 col-sm-offset-1 col-sm-10">
                                    ...
                                    <div class="col-md-8 col-md-offset-2 col-sm-offset-1 col-sm-10">
                                        ...
                                        <div class="form-group">
                                            <input type="email" class="form-control" id="email" name="email" aria-label="Email"
                                                ...
                                                placeholder="PESAN" value="Ancaman Serangan pada Web Application"/>
												<input class="form-control" type="hidden" name="verifikasi_code" id="verifikasi_code" value="<?php echo $kodeBarang ?>"/>
												<input class="form-control" type="hidden" name="type_dokumen" id="type_dokumen" value="4"/>
