...
<style>
                    ...
                    <div class="col-sm-offset-1 col-sm-11">
                        <div class="container">
                            <ul class="list-inline">
                                ...
                                <li><a href="/layanan/pembuatan-web-klinik-gigi.php">ID</a></li>
    ...
    <!-- END HEADER -->
        ...
        <div class="content-area content-wrapper__">
            
            <div class="banner-content --top" style="margin:auto; max-width: 1600px">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <ol class="breadcrumb breadcrumb--update-design" itemscope
                                ...
                                <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item"
                                        href="/en/services.php"><span itemprop="name">&nbsp;Service</span></a>
                                    <meta itemprop="position" content="2" />
                                </li>
                                <li class="active" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a
                                        itemprop="item"><span itemprop="name">&nbsp;Dental Clinic Web</span></a>
            ...
            <div class="three-steps-away">
                ...
                <div class="step-one">
                    <div class="step-description">
                        ...
                        <small class="step-desription__small--anchor">Your web is listed on <a target="_blank" href="https://caridoktergigi.com/">CariDokterGigi.com</a> for free</small>
                    </div>
