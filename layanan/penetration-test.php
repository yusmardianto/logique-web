...
<body>
					...
					<div class="kasus">
						<div class="row">
							<div class="col-md-offset-1 col-md-10">
								...
								<div class="row">
									<div class="col-sm-4">
										<img alt="Sekitar 24.000 aplikasi seluler berbahaya diblokir setiap hari" src="assets/img/img-pentest/kasus1-1.png" class="img-responsive center-block"/>
									</div>
									<div class="col-sm-4">
										<img alt="Serangan IoT meningkat 600% pada 2017" src="assets/img/img-pentest/kasus1-2.png" class="img-responsive center-block"/>
									</div>
									<div class="col-sm-4">
										<img alt="serangan ransomware tumbuh lebih dari 350% setiap tahun" src="assets/img/img-pentest/kasus1-3.png" class="img-responsive center-block"/>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-sm-4 mt-2m">
										<img alt="Sekitar 24.000 aplikasi seluler berbahaya diblokir setiap hari" src="assets/img/img-pentest/dampak1.png" class="img-responsive center-block"/>
									</div>
									<div class="col-sm-4 mt-2m">
										<img alt="Serangan IoT meningkat 600% pada 2017" src="assets/img/img-pentest/dampak2.png" class="img-responsive center-block"/>
									</div>
									<div class="col-sm-4 mt-2m">
										<img alt="serangan ransomware tumbuh lebih dari 350% setiap tahun" src="assets/img/img-pentest/dampak3.png" class="img-responsive center-block"/>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-sm-4 mt-2m">
										<img alt="Sekitar 24.000 aplikasi seluler berbahaya diblokir setiap hari" src="assets/img/img-pentest/kerugian1.png" class="img-responsive center-block"/>
									</div>
									<div class="col-sm-4 mt-2m">
										<img alt="Serangan IoT meningkat 600% pada 2017" src="assets/img/img-pentest/kerugian2.png" class="img-responsive center-block"/>
									</div>
									<div class="col-sm-4 mt-2m">
										<img alt="serangan ransomware tumbuh lebih dari 350% setiap tahun" src="assets/img/img-pentest/kerugian3.png" class="img-responsive center-block"/>
									</div>
								</div>
								<div class="row mt-2m p-special-grid">
									...
									<div style="background-color:black;color:white;"><img alt="Serangan IoT meningkat 600% pada 2017" src="assets/img/img-pentest/image-risk-cmputer.png" class="img-responsive center-block"/></div>
								</div>
								...
								<div class="row text-center">
									<div class="col-sm-3 mt-2m img-centered img-up">
										<img alt="Sekitar 24.000 aplikasi seluler berbahaya diblokir setiap hari" src="assets/img/img-pentest/mengalami/mengalami1.png" class="img-responsive center-block"/>
									</div>
									<div class="col-sm-3 mt-2m img-centered img-up">
										<img alt="Serangan IoT meningkat 600% pada 2017" src="assets/img/img-pentest/mengalami/mengalami2.png" class="img-responsive center-block"/>
									</div>
									<div class="col-sm-3 mt-2m img-centered img-up">
										<img alt="serangan ransomware tumbuh lebih dari 350% setiap tahun" src="assets/img/img-pentest/mengalami/mengalami3.png" class="img-responsive center-block"/>
									</div>
	...
	<div class="target-umum-bg">
		<div class="container">
			<div class="row">
				<div class="col-md-7">
					<div class="title fw-300">Adapun <span class="yellow">target umum</span> untuk melakukan <span class="yellow">penetrasi testing</span>,  yaitu meliputi:</div>
					<br/>
					<ul>
						...
						<li><span class="yellow">Sistem internal atau servis yang terdapat di dalam jaringan (<i>Active Drectory</i>, <i>Exchange</i>, dan lain-lain)</span></li>
						<li><span class="yellow">Beberapa aplikasi tertentu (dibeli atau dikembangkan sendiri oleh perusahaan)</span></li>
	...
	<div class="harga">
		<div class="container">
			<div class="row">
				<div class="col-md-offset-2 col-md-8">
					<div class="title">Lalu berapakah harga layanan yang ditawarkan oleh Logique untuk melakukan Pentest tersebut?</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
			...
			<div class="row">
				<div class="col-md-offset-1 col-md-10">
					<div class="subtitle">Dalam melakukan kegiatan pentest mulai dari tahapan awal (preparation), tahapan pengujian (assessment) dan tahapan pelaporan (reporting). Logique Digital Indonesia menawarkan harga mulai dari Rp 10 juta tergantung dari jenis aplikasi atau sistem yang akan dilakukan pengujian.</div>
				</div>
			</div>
		</div>
	</div>
