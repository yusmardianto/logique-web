    ...
    <div class="container">
        <div class="row">
            <div class="col-md-offset-2 col-md-8">
                ...
                <!-- <p>
                    Masalah <b>keamanan cyber</b> selalu menjadi upaya yang terus dilakukan setiap harinya, terutama
                    <b>dalam hal bisnis</b>. Jika Anda tidak pernah peduli terhadap keamanan data Anda dan bagaimana
                    cara melindunginya, maka saat ini adalah waktu yang tepat untuk memulainya.<br /><br />
                    Tren mengenai masalah keamanan cyber semakin lama <b>semakin meningkat</b> setiap harinya, bahkan
                    masalah terbesar yang terjadi selama ini adalah banyaknya data yang diretas dan dilanggar dari
                    berbagai sumber, terutama saat berada di tempat kerja, seperti peretasan pada perangkat seluler dan
                    perangkat-perangkat yang terhubung ke Internet lainnya.<br /><br />
                    Bahkan, <b>penelitian terbaru</b> menunjukkan jika sebagian besar perusahaan mempunyai <b>data yang
                        tidak dilindungi</b> dengan baik dari praktik-praktik cybersecurity. Hal ini tentu membuat
                    mereka rentan untuk diretas dan <b>kehilangan data tanpa mereka ketahui</b>.
                </p> -->
            </div>
        </div>
    </div>
                        ...
                        <div class="row">
                            <div class="col-md-offset-1 col-md-10">
                                ...
                                <div class="div-kasus">
                                    ...
                                    <!-- Pernahkah Anda mengetahui, jika setiap hari terdapat 24.000 jenis aplikasi seluler
                                    yang diblokir karena berpotensi terjadi pelanggaran data di dalamnya. Selain itu,
                                    serangan terhadap seluruh perangkat yang terhubung ke Internet juga terus mengalami
                                    peningkatan. <br /><br />
                                    Bahkan di tahun 2017, angka ini naik sebanyak 600 persen. Bukan hanya itu saja,
                                    setiap tahunnya serangan ransomware juga terus mengalami pertumbuhan hingga lebih
                                    dari 350 persen setiap tahunnya.<br /><br />
                                    Berdasarkan data statistik tersebut dan dari berbagai kasus yang terjadi di seluruh
                                    dunia, peningkatan pelanggaran data terus terjadi dalam skala yang besar. Namun,
                                    bukannya membaik, pelanggaran data yang terjadi justru semakin lama semakin
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <img alt="Sekitar 24.000 aplikasi seluler berbahaya diblokir setiap hari"
                                            src="assets/img/img-pentest/kasus1-1.png"
                                            class="img-responsive center-block" />
                                    </div>
                                    <div class="col-sm-4">
                                        <img alt="Serangan IoT meningkat 600% pada 2017"
                                            src="assets/img/img-pentest/kasus1-2.png"
                                            class="img-responsive center-block" />
                                    </div>
                                    <div class="col-sm-4">
                                        <img alt="serangan ransomware tumbuh lebih dari 350% setiap tahun"
                                            src="assets/img/img-pentest/kasus1-3.png"
                                            class="img-responsive center-block" />
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-4 mt-2m">
                                        <img alt="Sekitar 24.000 aplikasi seluler berbahaya diblokir setiap hari"
                                            src="assets/img/img-pentest/dampak1.png"
                                            class="img-responsive center-block" />
                                    </div>
                                    <div class="col-sm-4 mt-2m">
                                        <img alt="Serangan IoT meningkat 600% pada 2017"
                                            src="assets/img/img-pentest/dampak2.png"
                                            class="img-responsive center-block" />
                                    </div>
                                    <div class="col-sm-4 mt-2m">
                                        <img alt="serangan ransomware tumbuh lebih dari 350% setiap tahun"
                                            src="assets/img/img-pentest/dampak3.png"
                                            class="img-responsive center-block" />
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <img class="img-responsive center-block"
                                            src="assets/img/img-pentest/rumah-dampak.png" alt="Rumah Dampak" />
                                    </div>
                                    <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-3">
                                        <img class="img-responsive center-block"
                                            src="assets/img/img-pentest/dampak-ratio.png" alt="Dampak Ratio" />
                                    </div>
                                </div>
                                <br /><br />
                                ...
                                <div class="row">
                                    <div class="col-sm-4 mt-2m">
                                        <img alt="Sekitar 24.000 aplikasi seluler berbahaya diblokir setiap hari"
                                            src="assets/img/img-pentest/kerugian1.png"
                                            class="img-responsive center-block" />
                                    </div>
                                    <div class="col-sm-4 mt-2m">
                                        <img alt="Serangan IoT meningkat 600% pada 2017"
                                            src="assets/img/img-pentest/kerugian2.png"
                                            class="img-responsive center-block" />
                                    </div>
                                    <div class="col-sm-4 mt-2m">
                                        <img alt="serangan ransomware tumbuh lebih dari 350% setiap tahun"
                                            src="assets/img/img-pentest/kerugian3.png"
                                            class="img-responsive center-block" />
                                    </div>
                                </div>
                    ...
                    <div class="what-is">
                        ...
                        <div class="row">
                            <div class="col-md-offset-1 col-md-11">
                                ...
                                <!-- <p><br />
                                    <b>Penetration testing</b> atau pentest merupakan istilah yang sering digunakan saat
                                    seseorang melakukan kegiatan pengujian sebuah sistem atau aplikasi. Kegiatan
                                    pengujian ini dilakukan untuk mengetahui apakah sistem keamanan yang terdapat pada
                                    sistem atau aplikasi mempunyai celah sehingga dapat segera diperbaiki dengan
                                    melakukan patch atau penambalan sehingga sistem keamanan yang terdapat pada suatu
                                    sistem atau aplikasi tersebut menjadi semakin kuat. Selain melakukan pengujian,
                                    kegiatan pentest juga melakukan dokumentasi sistem keamanan dari sistem atau
                                    aplikasi yang akan dilakukan pentest untuk selanjutnya dibuatkan laporan atau report
                                    kepada perusahaan/ pelanggan.<br /><br />

                                    Sebelum melakukan pentest, biasanya akan terjadi kontrak antara auditor/ pentester
                                    dengan perusahaan yang ingin aplikasi atau sistemnya dilakukan pentest. Hal ini
                                    dalam konteks hukum merupakan kegiatan legal karena sebelumnya telah terjadi kontrak
                                    antara keduanya.
                                </p> -->
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="text-center lh-30">
                        ...
                        sebuah aplikasi, komputer atau jaringan. Jika kelemahan ditemukan dan dapat dibuktikan dengan
                        beberapa analisa resikonya, maka Anda akan mempunyai waktu untuk dapat memperbaikinya sebelum
                        seseorang yang tidak bertanggung jawab mengambil kesempatan dari kelemahan yang ditemukan
                        tersebut. -->
                    </div>
                    <br /><br />
                    <div class="text-center lh-30">
                ...
                <div class="col-md-6">
                    ...
                    <div class="each-plus-minus">
                        <div class="title-each"><img src="assets/img/img-pentest/kelebihan.png"
                                alt="Kelebihan" />KELEBIHAN</div>
                        <ul>
                ...
                <div class="col-md-6">
                    <hr />
                    <div class="each-plus-minus">
                        <div class="title-each"><img src="assets/img/img-pentest/kekurangan.png"
                                alt="Kekurangan" />KEKURANGAN</div>
                        <ul>
            ...
            <div class="row">
                <div class="col-md-offset-1 col-md-10">
                    ...
                    <!-- <p>
                        ...
                        menemukan celah keamanan yang terdapat pada beberapa website rekanan bisnis mereka. Selain itu,
                        pentester yang terdapat di Logique Digital Indonesia juga menerapkan standar operasional yang
                        digunakan oleh semua pentester di seluruh dunia.
                    </p> -->
        ...
        <div class="container">
            ...
            <!-- <div class="row">
                <div class="col-md-6">
                    <div class="row">
                        <div class="col-sm-4">
                            <img alt="Step 5" src="assets/img/img-pentest/step5.png"
                                class="img-responsive center-block" /><br />
                        </div>
                        <div class="col-sm-8 text-justify">
                            <div class="title"><span>3</span> <b>Gaining Access</b></div>
                ...
                <div class="col-md-6">
                    <div class="row">
                        <div class="col-sm-4">
                            <img alt="Step 6" src="assets/img/img-pentest/step6.png"
                                class="img-responsive center-block" /><br />
                        </div>
                        <div class="col-sm-8 text-justify">
                            <div class="title"><span>4</span> <b>Maintaining Access</b></div>
            ...
            <div class="row">
                <div class="bg-yellow">
                    <div class="row">
                        <div class="col-sm-2">
                            <img alt="Step 6" src="assets/img/img-pentest/report.png"
                                class="img-responsive center-block" />
                        </div>
