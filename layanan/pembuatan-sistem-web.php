...
<head>
    ...
    <meta name="description" content="Jasa pembuatan aplikasi web / sistem web di Jakarta dengan harga terbaik. Dikerjakan secara profesional menggunakan teknologi terkini | LOGIQUE">
    <meta name="keywords" content="jasa pembuatan aplikasi web, jasa pembuatan web app, jasa pembuatan PWA">
    ...
    <meta property="og:description" content="Jasa pembuatan aplikasi web / sistem web di Jakarta dengan harga terbaik. Dikerjakan secara profesional menggunakan teknologi terkini | LOGIQUE">
...
<body class="systedev-page">
        ...
        <div class="container__" style="position:relative">
            <div class="row">
                <div class="col-md-offset-1 col-md-10 text-center bg-header-txt text-center">
                    <h1 class="m-new">
                        Jasa Pembuatan & Pengembangan Aplikasi Berbasis Web Profesional Jakarta
                    </h1>
                    <h3 class="  m-new">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <ol class="breadcrumb breadcrumb--update-design" itemscope itemtype="http://schema.org/BreadcrumbList">
                        ...
                        <li class="active" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item"><span itemprop="name">&nbsp;Web System</span></a>
    ...
    <section class="content-section first-part">
        <div class="container__">
            ...
            <div class="sec-content-part whyour-systemdev">
                <h2 class="sub-section-title text-center">
                    Pengembangan Aplikasi Berbasis Web di LOGIQUE
                </h2>
                ...
                <div class="page-content">
                    ...
                    <div class="tab-content">
                        ...
                        <div id="expert" class="tab-pane fade">
                            <div class="row">
                                <div class="col-sm-6">
                                    <p>Kami Memiliki Pilihan Layanan Pembuatan Aplikasi Berbasis Web yang Sesuai dengan Kebutuhan Anda</p>
                                </div>
                                <div class="col-sm-6 text-center">
                                    <picture>
                    ...
                    <div class="row rowflex">
                        <div class="col-lg-6">
                            <div class="unsupport1 unsupport-content">
                                <h3>
                                    <div>Implementasi Paket Software</div>
                                </h3>
    ...
    <section class="content-section sixth-part">
        <div class="sec-content-part contact-banner">
            <div class="page-content">
                <ul>
                    <li class="text-left">Hubungi kami sekarang untuk <br>pengembangan sistem berbasis web yang optimal!
                    <li>
                    <li>
                        <a href="/hubungi-kami.php" class="btn-yellow">Contact Us <span class="icon"> <img loading="lazy" src="assets/img/img-systemdev/newlayout/arrow-right.svg"></span></a>
                    </li>
    ...
    <section class="content-section fifth-part">
        <div class="container__">
            <div class="sec-content-part important-point">
                ...
                <p class="text-center">Selain menyediakan layanan pengembangan sistem website, LOGIQUE juga menyediakan <a href="/layanan/jasa-pembuatan-website.php">jasa pembuatan website</a> dan <a href="/layanan/digital-marketing.php">jasa digital marketing</a> seperti Search Engine Marketing (SEM), Content Marketing, Search Engine Optimization (SEO), atau optimasi Social Media. Jadi, kami tidak hanya akan membantu mengembangkan website profesional namun juga dapat mengembangkan website yang mampu menjangkau lebih banyak pelanggan potensial secara organik melalui <a href="/layanan/digital-marketing/jasa-seo.php">jasa SEO</a> yang kami miliki.</p><br>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $('.unsupport-content h3').matchHeight({
                byRow: false
            });
            $(' scitem-content h3').matchHeight({
                byRow: false
            });
