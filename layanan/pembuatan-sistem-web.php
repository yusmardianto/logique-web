...
<body>
	<header class="header">
			...
			<!-- <div class="row"> -->
				...
				<div class="breadcrumb-position">
					<ol class="breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList" style="background:transparent;">
						...
						<li class="active" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem" ><a itemprop="item" ><span itemprop="name">Pembuatan Sistem Web</span></a><meta itemprop="position" content="3" /></li>
					</ol>
				</div>
				<!-- end of breadcrumb -->
				...
				<div class="row">
					...
					<div class="col-lg-offset-7  col-lg-6 col-sm-offset-6 col-sm-6 bg-header-txt">
						<h2 class="text-left m-new">
							Apakah anda membutuhkan layanan profesional dalam Pengembangan Sistem & Aplikasi? Jangan khawatir: Logique siap melayani!   
						</h2>
						<h2 class="text-left m-new" style="color: #555;">
							Kami mengembangkan sistem IT dengan standar internasional, kualitas Jepang, serta kecepatan dan harga Indonesia.
						</h2>
					</div>
				</div>
			</div>
		...
		<section class="style-2">
			<div class="container">
				<div class="row">
					<div class="col-lg-offset-3 col-lg-10 col-md-offset-2 col-md-10 col-sm-offset-2 col-sm-10 col-xs-offset-2 col-xs-10 text-right">
						<div class="new5">
			...
			<div class="container">
				<div class="row">
					<div class="col-md-3 justify-content-center">
						...
						<p class="new4">
							Kecepatan merupakan kunci utama pada era digital ini. Dengan menggunakan metode Agile, kami dapat mengembangkan sistem IT dengan cepat dan flexibel, tanpa mengurangi kualitas. 
					...
					<div class="col-md-3 justify-content-center">
						...
						<img class="img img-responsive yellow-stripes" src="assets/img/img-systemdev/yellow-stripes.png" alt="">
						<p class="new4">
							Kami mengembangkan sistem untuk beragam klien Indonesia di sektor Otomotif, Keuangan & Pemerintah. Dengan pengalaman di bidang 
				...
				<div class="row">
					<div class="container">
						<div class="row" style="display: flex; flex-wrap: wrap;">
							<div class="col-md-4">
								<h1 class="new7" style="font-weight: 500!important;">Mendukung Perusahaan Anda Melalui Pengembangan Sistem dan Aplikasi  Berdasarkan Permintaan.</h1>
								<br>
								...
								<div class="col-md-12">
									<ol class="ol-position">
										<li  class="new3 h4 mb-1">
											<h4 class="mt-2">
												Sebagai kepala Departemen IT, saya telah mengelola banyak project pengembangan sistem. Sejauh ini, tidak ada perusahaan lain sefleksibel dan semampu LOGIQUE. Meskipun sering terjadi permintaan perubahaan dari user yang tidak bisa dihindari, saya sangat puas dengan kemampuan cepat tanggap LOGIQUE untuk menghasilkan produk digital berkualitas tinggi. Saya juga pernah menggunakan jasa sistem desain dan layanan maintenance, dan saya berterima kasih atas respon akurat dan tepat waktu dari LOGIQUE.
											</h4>
										</li>
										<li  class="new3 h4 mb-1">
											<h4 class="mt-2">
												Sejak pemutusan kontrak dengan perusahaan pengembang sistem sebelumnya, LOGIQUE telah mengambil alih pertumbuhan dan pemeliharaan infrastruktur IT kami. Saya berterima kasih atas fleksibilitas dan efektivitas kerja yang dilakukan LOGIQUE dengan mengambil inisiatif untuk meningkatkan sistem digital kami; termasuk menunjukkan berbagai masalah yang tidak kami sadari sebelumnya.
											</h4>
										</li>
										<li  class="new3 h4 mb-1">
											<h4 class="mt-2">
												Sepanjang kesepakatan tarif tetap bulanan yang sedang berjalan saat ini, LOGIQUE telah melakukan pekerjaan dengan sangat cepat dan efisien. Kami teramat senang dengan usaha LOGIQUE yang telah menghasilkan produk berkualitas tinggi yang hemat biaya. Selama pengembangan project besar kami, saya ingin menerapkan metode development Tipe Lab yang ditawarkan. 
											</h4>
										</li>
									</ol>
								</div>
