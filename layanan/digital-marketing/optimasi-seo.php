		...
		<div class="content-area">
			...
			<div class="div-top">
				...
				<div class="breadcrumb-section">
					<ol class="breadcrumb">
						...
						<li><a href="/layanan/digital-marketing.php">Digital Marketing</a></li>
						<li class="active"><a href="/layanan/digital-marketing/optimasi-seo.php">Optimasi SEO</a></li>
					</ol>
				</div>
			...
			<div class="first-page">
				...
				<!-- <div class="branch">
					<div class="row">
						<div class="col-md-12">
							<img class="center-block" src="img/img-seo-optimization/arrow-branch.png" />
						</div>
					</div>
				...
				<div class="row">
					<!-- <div class="col-sm-3 col-sm-offset-1">
						<img class="center-block img-responsive" src="img/img-seo-optimization/web-dev.png" />
						<p class="text-center">Web Developer</p>
					</div>
					<div class="col-sm-3">
						<img class="center-block img-responsive" src="img/img-seo-optimization/seo-content.png" />
						<p class="text-center">Seo Content Creator</p>
					</div>
					<div class="col-sm-3">
						<img class="center-block img-responsive" src="img/img-seo-optimization/web-design.png" />
				...
				<div class="three-languages">
					<div class="row">
						<div class="col-md-4 col-xs-10 col-md-offset-2 col-xs-offset-1">
							<p>LOGIQUE, Provides Best SEO Optimization<br> Services in 3 Languages</p>
						</div>
						<div class="col-md-6">
