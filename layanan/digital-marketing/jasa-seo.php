...
<head>
	...
	<title>Logique Digital Marketing - Halaman Service SEO</title>
			...
			<div class="div-top">
				...
				<div class="top-tabs">
					<ul class="nav nav-tabs nav-justified" role="tablist">
						...
						<li role="presentation">
							<a href="#top-multilanguage" aria-controls="top-multilanguage" role="tab" data-toggle="tab">Multilanguages Services</a>
						</li>
						<li role="presentation">
							<a href="#top-seo-portfolio" aria-controls="top-seo-portfolio" role="tab" data-toggle="tab">SEO Portfolio</a>
						</li>
					</ul>
				</div>
						...
						<div class="row equal-height cloud-bg">
							...
							<div class="col-xs-12 col-md-5 col-lg-5 banner-mobile-content-style">
								<div class="banner-mobile-content-style2">
									...
									<a class="btn-boost" href="/hubungi-kami.php">Boost My Traffic</a>
								</div>
							</div>
						</div>
					</div>
					<div class="seo-service-description">
						<div class="row">
							<div class="col-xs-8 col-xs-offset-2">
								<p class="description-title">We give you full SEO optimization services you need, including audit technical SEO
									from Web Development perspective, to fully maximize your business revenue.</p>
							</div>
						</div>
						<div class="container">
							<div class="stack-tab">
								<ul role="tablist">
									...
									<li><a href="#seo-white-hat" aria-controls="seo-white-hat" role="tab" data-toggle="tab">Implementasi SEO White Hat</a></li>
									<li><a href="#optimize-seo" aria-controls="optimize-seo" role="tab" data-toggle="tab">Optimasi SEO dalam 3 Bahasa: Indonesia, Inggris, dan Jepang</a></li>
								</ul>
								</ul>
							</div>
								...
								<div role="tabpanel" class="tab-pane stack-tab-content fade in active " id="seo-maintenance">
									<div class="row">
										<div class="col-md-8 col-md-offset-2 col-xs-10 col-xs-offset-1">
											...
											<a href="#" class="btn-see-more">Selengkapnya Tentang SEO Maintenance LOGIQUE</a>
										</div>
									</div>
								</div>
								<div role="tabpanel" class="tab-pane fade stack-tab-content" id="audit-seo">
									<div class="row">
										<div class="col-md-8 col-md-offset-2 col-xs-10 col-xs-offset-1">
											...
											<a href="#" class="btn-see-more">See More About LOGIQUE's SEO Web Development</a>
										</div>
									</div>
								</div>
								<div role="tabpanel" class="tab-pane fade stack-tab-content" id="seo-white-hat">
									<div class="row">
										<div class="col-md-8 col-md-offset-2 col-xs-10 col-xs-offset-1">
											...
											<a href="#" class="btn-see-more">Selengkapnya Tentang SEO White Hat LOGIQUE</a>
										</div>
									</div>
								</div>
