			...
			<section class="seo__services">
				<div class="container__">
					...
					<section class="services__contribution">
						...
						<div class="services__pills">
							<ul class="nav nav-pills">
								<li class="active"><a href="#contribution_1" data-toggle="pill" aria-controls="home" aria-selected="true">Industri Properti</a></li>
								<li><a href="#contribution_2" data-toggle="pill" aria-controls="home" aria-selected="false">Industri Pariwisata</a></li>
								<li><a href="#contribution_3" data-toggle="pill" aria-controls="home" aria-selected="false">Industri Otomotif</a></li>
								<li><a href="#contribution_4" data-toggle="pill" aria-controls="home" aria-selected="false">Industri Perbankan</a></li>
							</ul>
							<div class="row">
