...
<head>
    ...
    <meta name="description" itemprop="description"
        content="Logique menyediakan layanan IT specialist dan digital marketing profesional dengan tarif tetap untuk perkembangan bisnis dan usaha Anda di dunia digital. Info lebih lanjut hubungi kami!">
    <meta name="keywords"
    ...
    <div class="wrapper wrapper--update-design wrapper--update-design-font">
        ...
        <div class="all-you">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <ol class="breadcrumb breadcrumb--update-design" itemscope itemtype="http://schema.org/BreadcrumbList">
                                    ...
                                    <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                                        <a href="/layanan.php" itemprop="item"><span itemprop="name">&nbsp;Layanan</span></a>
                                        <meta itemprop="position" content="2" />
                                    </li>
                                    <li class="active" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                                        <a itemprop="item"><span itemprop="name">&nbsp;Layanan Penggunaan Tanpa Batas Spesialis Tarif Tetap</span></a>
            ...
            <section class="all-you__problems">
                <div class="content-wrapper__">
                    <div class="container__">
                        <h2 class="text-center m-b-30px">Apakah Anda memiliki masalah atau kekhawatiran seperti ini?</h2>
                        <div class="row flex__row problems__item">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4 m-b-30px">
                                <div class="d-flex flex-nowrap item">
                                    ...
                                    <p>Saya memiliki programmer, namun ada keterbatasan dalam menggunakan bahasa pemrograman yang diperlukan untuk sistem yang saat ini sedang dikembangkan.</p>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-4 m-b-30px">
                                <div class="d-flex flex-nowrap item">
                                    ...
                                    <p>Saya butuh penguji perangkat lunak yang bekerja di lokasi selama periode UAT.</p>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-4 m-b-30px">
                                <div class="d-flex flex-nowrap item">
                ...
                <div class="content-wrapper__">
                    <div class="container__">
                        ...
                        <div class="m-b-30px row flex__row settled__article">
                            ...
                            <div class="col-xs-12 col-md-8">
                                <h4>Tarif paket ini tetap, tanpa biaya awal, dan tanpa batas waktu</h4>
                                <p>Kami menyediakan total 1 Man-Month = 20 Man-Days = 160 Man-Hours pekerjaan dengan paket standar Rp 45.000.000 per bulan. Anda dapat memulai kapan saja dan meningkatkan, menurunkan, atau membatalkan paket bulanan. *Pembatalan tidak dapat dilakukan di pertengahan bulan</p>
                                <p>Kami menyediakan berbagai jenis layanan profesional IT / DX / DM yang dilakukan oleh spesialis kami berdasarkan kebutuhan Anda dengan sangat fleksibel. Misalnya, Anda bisa mendapatkan seorang desainer untuk 5 hari kerja, seorang spesialis pemasaran media sosial untuk 5 hari kerja, dan 10 hari kerja untuk tugas lain seperti mengembangkan fungsi baru oleh seorang programmer.</p>
                                <p>Riwayat pekerjaan dan jam kerja aktual akan dilaporkan setiap akhir bulan. Jika ada jam kerja yang belum terpakai, jam kerja dapat dipindahkan ke bulan berikutnya.</p>
                            </div>
                        </div>
                        ...
                        <div class="p-y-20px p-x-30px rounded-lg settled__contact">
                            <div class="row flex__row justify-content-center align-items-center">
                                ...
                                <div class="col-xs-8 col-sm-6 col-md-2">
                                    <a href="/en/contact.php" class="form-control btn btn--yellow">Hubungi Kami</a>
                                </div>
                            </div>
                        </div>
            ...
            <section class="bg--l-gray">
                <div class="content-wrapper__">
                    <div class="container__">
                        <h2 class="text-center m-b-50px">Cara Kerja "Layanan Spesialis DX / DM Tarif Tetap"</h2>
                        ...
                        <div class="m-b-50px">
                                ...
                                <div class="collapse in" id="collapse_settled_1">
                                    <div class="m-t-20px p-30px rounded-xl bg--yellow opa--2">
                                        <ul class="list-unstyled list--with-icon">
                                            <li>Pengelolaan daftar tugas, menentukan prioritas tugas, dan jam kerja yang diperlukan.</li>
                                            <li>Menyampaikan dan membahas tugas yang akan dimulai, menentukan tenaga spesialis, jadwal pengerjaan, dan jam kerja yang akan terserap selama pekerjaan berlangsung</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="p-30px m-b-30px rounded-xl bg--white">
                                <a class="color--black d-flex flex-nowrap justify-content-betwwen align-items-center" data-toggle="collapse" href="#collapse_settled_3" role="button" aria-expanded="true" aria-controls="collapse_settled_3">
                                    <p class="fs--20px m-r-20px">3.	<span class="logo-font">LOGIQUE</span> juga akan menyediakan Manajer Proyek yang akan mengelola tugas dan jam kerja dari setiap tim spesialis yang terlibat.</p>
                                    <picture>
                                        <source srcset="/img/icon/icon-chevron-up.svg">
                                        <img src="/img/icon/icon-chevron-up.png" alt="" class="img-responsive" width="20px">
                                    </picture>
                        ...
                        <div>
                            ...
                            <div class="p-30px m-b-30px rounded-xl bg--white">
                                <a class="color--black d-flex flex-nowrap justify-content-betwwen align-items-baseline" data-toggle="collapse" href="#collapse_example_2" role="button" aria-expanded="true" aria-controls="collapse_example_2">
                                    <div class="fs--20px m-r-20px">
                                        <p>Contoh 2</p>
                                        <p>Perusahaan yang dalam masalah karena diberi tahu bahwa pengembangan fitur yang diperlukan berada di luar cakupan oleh Vendor yang dikontrak saat ini.</p>
                                    </div>
                                    <picture>
                                        <source srcset="/img/icon/icon-chevron-up.svg">
                                        <img src="/img/icon/icon-chevron-up.png" alt="" class="img-responsive" width="20px">
                            ...
                            <div class="p-30px m-b-30px rounded-xl bg--white">
                                <a class="color--black d-flex flex-nowrap justify-content-betwwen align-items-baseline" data-toggle="collapse" href="#collapse_example_3" role="button" aria-expanded="true" aria-controls="collapse_example_3">
                                    <div class="fs--20px m-r-20px">
                                        <p>Contoh 3</p>
                                        <p>Memiliki tim spesialis yang terbatas sedangkan ada terlalu banyak produk yang perlu dioperasikan.</p>
                                    </div>
                                    <picture>
                                        <source srcset="/img/icon/icon-chevron-up.svg">
                                        <img src="/img/icon/icon-chevron-up.png" alt="" class="img-responsive" width="20px">
                                ...
                                <div class="collapse in" id="collapse_example_3">
                                    <div class="m-t-20px">
                                        ...
                                        <div class="time-flow">
                                            ...
                                            <div class="time-flow__item">
                                                <h4>Saran</h4>
                                                <h4>Atur pekerjaan mendesak dan rapikan dengan paket 2 Bulan (2 bulan)</h4>
                                                <ul class="list-unstyled m-t-10px list--with-icon">
                            ...
                            <div class="p-30px m-b-30px rounded-xl bg--white">
                                <a class="color--black d-flex flex-nowrap justify-content-betwwen align-items-baseline" data-toggle="collapse" href="#collapse_example_4" role="button" aria-expanded="true" aria-controls="collapse_example_4">
                                    <div class="fs--20px m-r-20px">
                                        <p>Contoh 4</p>
                                        <p>Biaya perusahaan pemeliharaan sistem saat ini terlalu tinggi</p>
                                    </div>
                                    <picture>
                                        <source srcset="/img/icon/icon-chevron-up.svg">
                                        <img src="/img/icon/icon-chevron-up.png" alt="" class="img-responsive" width="20px">
            ...
            <section class="all-you__price">
                <div class="content-wrapper__">
                    <div class="container__">
                        <h2 class="text-center">Harga / Kondisi</h2>
                        ...
                        <div class="row flex__row">
                            <div class="col-xs-12 col-sm-6">
                                <ol class="list-unstyled price__list" data-list-start="1">
                                    <li>Diperlukan kontrak minimal 1 bulan atau lebih. Pembatalan kontrak tidak bisa dilakukan di tengah bulan.</li>
                                    <li>Kontrak yang dapat diambil pada dasarnya adalah paket 1 Man-month atau lebih, tetapi kami juga terbuka untuk diskusi apabila Anda memerlukan paket yang lebih kecil seperti 0,5 Man-month dalam satu bulan.</li>
                                    <li>Kontrak besar seperti paket 5 Man-months ke atas juga dimungkinkan dan harganya bisa dinegosiasikan.</li>
                                    <li>Untuk paket 1 Man-month, jumlah total pekerjaan yang sebenarnya adalah 150 jam kerja.</li>
                                    <li>20% dari total volume pekerjaan diperlukan untuk manajemen proyek. Untuk 1 Man-Month, 30 jam dialokasikan untuk manajemen proyek.</li>
                                </ol>
                            </div>
                            <div class="col-xs-12 col-sm-6">
                                <ol class="list-unstyled price__list" data-list-start="6">
                                    <li>Jika ada jam kerja yang tidak terpakai, Anda dapat memindahkannya ke satu bulan berikutnya.</li>
                                    <li>Jika penggunaan jam kerja tidak berkurang karena alasan seperti tidak ada pekerjaan yang benar-benar dapat dilakukan, maka kami sisa waktu dapat dipindahkan tanpa batas waktu (hanya selama masa kontrak).</li>
                                    <li>Harga diatas belum termasuk pajak.</li>
                                    <li>Jika pekerjaan di lokasi diperlukan, biaya transportasi dan tunjangan lainnya mungkin diperlukan secara terpisah.</li>
                                </ol>
                            </div>
                        </div>
                    </div>
            ...
            <section class="all-you__security">
                <div class="content-wrapper__">
                    <?php include($_SERVER['DOCUMENT_ROOT'].'/layanan/assets/components/other-services.php'); ?>
                </div>
            </section>
