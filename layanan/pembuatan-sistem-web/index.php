 ...
 <body>
 		...
 		<div class="container" style="position:relative">
 			...
 			<div class="row">
 				...
 				<div class="col-md-offset-7 col-md-5 m-t-10em">
 					<h3 class="text-left m-new">Cari Perusahaan Pengembangan Sistem Web? LOGIQUE AJA!</h3>
 				</div>
 			</div>
 		</div>
 	</header>
 		...
 		<div class="container">
 			<div class="row">
 				<div class="col-md-offset-1 col-md-10 text-center">
 					<h3>“Pemanfaatan teknologi terkini untuk meningkatkan profit bisnis Anda.”</h3>
 				</div>
 			</div>
 		</div>
 	</section>
 		...
 		<div class="container">
 			<div class="row">
 				<div class="col-md-offset-7 col-md-5">
 					<h3 class="new5">Komponen Pengembangan Sistem Web di <span class="underline">LOGIQUE</span></h3>
 				</div>
 			</div>
 		</div>
 	</section>
 	...
 	<section class="style-6">
 		<div class="container">
 			<div class="row">
 				<div class="col-md-6">
 					<h2 class="new6"><span class="underline2">Testimoni</span><br>Klien</h2>
 				</div>
 				<div class="col-md-6">
 					<div class="row">
 						<div class="col-md-12">
 		...
 		<div class="container">
 			<div class="row">
 				<div class="col-md-offset-4 col-md-7">
 					<div class="row">
 						<div class="col-md-9">
 							<h3 class="new2">Tingkatkan Bisnis Anda Bersama LOGIQUE</h3>
