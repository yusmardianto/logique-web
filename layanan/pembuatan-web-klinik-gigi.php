...
<head>
	...
	<link rel="canonical" href="https://www.logique.co.id/layanan/pembuatan-web-klinik-gigi-2.php" />
	<script>
...
<body class="dentalpage">
	...
	<div class="wrapper wrapper--update-design">
		...
		<div class="container-fluid">
			<div class="row lang-logo--update-design" style="z-index: 20">
				<div class="container">
					<div class="row">
						<div class="col-sm-offset-1 col-sm-11">
							<div class="container">
								<ul class="list-inline">
									<li><a href="/layanan/pembuatan-web-klinik-gigi-2.php">EN</a></li>
									<li class="active"><a href="#">ID</a></li>
									<li><a href="/layanan/pembuatan-web-klinik-gigi-2.php">JP</a></li>
								</ul>
		...
		<div class="content-wrapper__">
			...
			<header class="head-banner " style="margin: auto; max-width: 1600px">
							...
							<div class="col-sm-12">
								<ol class="breadcrumb breadcrumb--update-design" itemscope
									...
									<li class="active" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a
											itemprop="item"><span itemprop="name">&nbsp;Web Klinik Gigi</span></a>
						   ...
						   <div class="row">
							   ...
							   <div class="col-md-4 col-sm-4">
								   <div class="d-layanan l1">
									   ...
									   <p>Website klinik gigi Anda akan terdaftar pada <a target="_blank" href="https://caridoktergigi.com/">CariDokterGigi.com</a> secara gratis</p>
								   </div>
							   </div>
							   <div class="col-md-4 col-sm-4">
								   <div class="d-layanan l1">
									   ...
									   <div class="l-title">
										   <h4>Mempermudah Pencarian Klinik</h4>
									   </div>
						   ...
						   <div class="row">
							   <div class="col-md-4 col-sm-4">
								   <div class="d-layanan">
									   ...
									   <div class="l-title">
										   <h4>Terhubung dengan Social Media</h4>
									   </div>
							   ...
							   <div class="col-md-4 col-sm-4">
								   <div class="d-layanan">
									   ...
									   <div class="l-title">
										   <h4>Non-stop Effortless Marketing</h4>
									   </div>
		   ...
		   <section id="contactbtn" class="contactbtn-section hidden">
			   <div class="container text-center">
				   <div class="btn-container__"><a class="btn contactbtn" href="/hubungi-kami.php" target="_blank"> Hubungi Kami </a></div>
			   </div>
		   </section>
