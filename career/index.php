            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <p>LOGIQUE membuka lowongan Web Developer, PHP Programmer, Web Designer, Technical Consultant, Digital
                  Marketing Strategist, dan Content Writer, untuk turut mengambil bagian dalam perkembangan digital dan
                  IT.</p>
          ...
          <div class="container">
            <div class="row">
              <div class="col-md-offset-2 col-md-8 text-center">
                ...
                <p data-aos="fade-up" data-aos-duration="1500">LOGIQUE merupakan perusahaan start-up di bidang IT yang
                  dibangun oleh tim yang cerdas, inovatif, dinamis. Di sini, kami memiliki misi untuk bersama-sama
            ...
            <div class="carousel-inner">
              <div class="item active">
                ...
                <div class="row">
                  ...
                  <div class="col-md-7 text-center">
                    ...
                    <p class="sliderx_">“Terima kasih telah mengunjungi halaman karir LOGIQUE. LOGIQUE adalah perusahaan
                      yang menyenangkan, digerakkan oleh orang-orang hebat yang profesional, bekerja keras, dan senang
                      bekerja dalam tim yang bersahabat. Tujuan saya adalah mengembangkan potensi penuh yang dimiliki
                      orang-orang hebat ini sehingga LOGIQUE juga ikut menjadi perusahaan hebat. Saya suka orang yang
                      rajin dan mau berjuang. Saya terus berusaha memberi mereka peluang terbaik untuk bisa sukses
                      besar. Jika Anda mau bergabung bersama kami, tim kami adalah fondasi dari kesuksesan masa depan
                      perusahaan. Perjalanan kita di sini akan menantang sekaligus memberikan manfaat. Mari berkembang
                      dan meraih kesuksesan besar bersama-sama.”</p>
                    <p class="sliderx__">-- Yoshi, CEO / Founder</p>
                    <a class="btn btn-yellow pull-right" href="detail/yoshi.php" id="interview-ceo">Interview with
                      CEO</a>
                  </div>
                </div>
              </div>
              <div class="item">
                ...
                <div class="row">
                  ...
                  <div class="col-md-7 text-center">
                    <div class="text-message hidden-xs">Message for Candidates</div>
                    <p class="sliderx_">“Sangat penting bagi Anda untuk mengetahui di mana dan bagaimana Anda bekerja.
                      Jika Anda bekerja keras, merasakan bahwa bekerja penting untuk kehidupan Anda, dan ingin
                      berkontribusi kepada perusahaan, kami berjanji akan menyediakan lingkungan kerja yang baik untuk
                      Anda. Di LOGIQUE, kami menyambut individu yang kreatif dan dinamis serta berusaha untuk
                      pengembangan pribadi dan profesional. Sebagai gantinya, maka kami berkomitmen untuk menghasilkan
                      yang terbaik dari diri Anda dengan menawarkan kesempatan untuk kemajuan dan pertumbuhan, dan
                      memberikan karir yang mengubah hidup tidak seperti yang lain. Mari berkembang bersama LOGIQUE!”
                    </p>
                    <p class="sliderx__">-- Ghitta, HRD</p>
                    <a class="btn btn-yellow pull-right" href="detail/ghitta.php" id="interview-hr">Interview with
                      HRD</a>
                  </div>
                </div>
              </div>
              <div class="item">
                ...
                <div class="row">
                  ...
                  <div class="col-md-7 text-center">
                    <div class="text-message hidden-xs">Message for Candidates</div>
                    <p class="sliderx_">“LOGIQUE tidak hanya melihat technical skill seseorang tetapi juga soft skill
                      dan attitude. Selain itu, selama Anda merasa dapat memberikan kontribusi di bidang Anda, LOGIQUE
                      akan mempertimbangkan hal itu baik-baik. Namun, jika Anda mempunyai target untuk menjadi yang
                      Back-End Developer terbaik, saya menyarankan Anda untuk terbiasa dalam menggunakan berbagai bahasa
                      pemrograman, framework, cloud server topology AWS, dan semacamnya.”</p>
                    <p class="sliderx__">-- Muklis, Senior Back End Developer</p>
                    <a class="btn btn-yellow pull-right" href="detail/muklis.php" id="interview-back-end">Interview with
              ...
              <div class="item">
                ...
                <div class="row">
                  ...
                  <div class="col-md-7 text-center">
                    <div class="text-message hidden-xs">Message for Candidates</div>
                    <p class="sliderx_">“Show your best. Pastikan kalau kamu memiliki pengalaman dan menguasai bidang
                      yang kamu lamar. Ibaratnya mau jadi atlet renang, kamu tentu harus bisa berenang (haha). Selain
                      itu, tunjukkan juga kalau kamu profesional dan punya minat belajar yang tinggi. Untuk kamu yang
                      senang bekerja cepat, kamu bakal suka bekerja di LOGIQUE.”</p>
                    <p class="sliderx__">-- Taufik, Senior Front End Developer</p>
                    <a class="btn btn-yellow pull-right" href="detail/taufik.php" id="interview-front-end">Interview
            ...
            <div class="row">
              ...
              <div class="col-md-4 text-center">
                ...
                <p class="keuntungan_m" style=" line-height: 1.5; ">Para anggota tim dibebaskan untuk menggali dan
                  mengeksplor potensi mereka, bahkan hingga di luar lingkup kerjanya, untuk memaksimalkan keahlian yang
                  dimiliki masing-masing individu.</p>
              </div>
              <div class="col-md-4 text-center">
                <img src="/img/career/menu2.jpg" />
                <h3>Pertumbuhan Karir</h3>
                <p class="keuntungan_m" style=" line-height: 1.5; ">Jika Anda memiliki kemampuan yang terus-menerus
                  meningkat, termasuk dalam memimpin suatu tim, Anda bisa dipromosikan langsung tanpa syarat.</p>
              </div>
              <div class="col-md-4 text-center">
                <img src="/img/career/menu3.jpg" />
                <h3>Fleksibel</h3>
                <p class="keuntungan_m" style=" line-height: 1.5; ">Kami bekerja tanpa keterikatan waktu. Anda tidak
          ...
          <div class="container">
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <p class="style2">Sesuai dengan filosofinya, LOGIQUE memberikan gaji dan tunjangan secara adil kepada
                  karyawan sesuai dengan keahlian dan performa masing-masing individu, tanpa keterikatan lama bekerja
                  atau usia. Jika kinerja Anda berhasil melampaui ekspektasi, Anda juga akan mendapatkan bonus tambahan.
                </p>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-md-4 text-center" style="z-index:2;">
                ...
                <div class="col-md-4 text-center boximg-fe hidden-sm hidden-md hidden-lg">
                  <h3>Oktober 2018</h3>
                  <p style="font-size:13px;">A meningkatkan keahlian untuk juga menguasai: teknik slicing dari design ke
            ...
            <div class="row">
              ...
              <div class="col-md-4 text-center boximg-fe hidden-xs">
                <h3>Oktober 2018</h3>
                <p>A meningkatkan keahlian untuk juga menguasai: teknik slicing dari design ke web, React JS (beginner)
                </p>
                <div class="box-FE">
                  Jabatan A<br>
                  <b style="font-size:16px;">Middle FE Developer</b>
          ...
          <div class="container">
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="box-visi margin_" data-aos="fade-up" data-aos-duration="500">
                  ...
                  <p>Sesuai dengan filosofi nama LOGIQUE, landasan kami adalah keadilan berasas logika. Sebab, berpikir
                    secara logis dalam setiap kesempatan membuat kami mampu memberikan nilai yang tidak hanya tepat
              ...
              <div class="col-md-4">
                <div class="box-visi kuning_" data-aos="fade-up" data-aos-duration="1000">
                  ...
                  <p>Kami sadar, setiap karyawan tidak bisa diperlakukan sama dengan karyawan lainnya. LOGIQUE
                    memperlakukan karyawan secara adil berdasarkan situasi masing-masing individu. Misalnya, jika
                    karyawan tidak bisa bekerja di kantor karena harus merawat ibunya, karyawan diberikan hak istimewa
              ...
              <div class="col-md-4">
                <div class="box-visi margin_" data-aos="fade-up" data-aos-duration="1500">
                  ...
                  <p>Perkembangan teknologi yang terus berkembang menuntut kita semua untuk ikut semakin terampil.
                    LOGIQUE selalu membebaskan karyawannya untuk saling belajar dan terus memperdalam keterampilan
                    masing-masing. Ini agar seluruh karyawan dapat berkembang bersama-sama di dalam perusahaan.</p>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <p class="text-center jika-ada-class">Jika Anda tertarik bekerja di LOGIQUE, kami tidak akan membebani
          ...
          <div class="container">
            ...
            <div class="bg-lowongan" id="internvacancy">
              <div class="row">
                ...
                <div class="col-md-4 text-center">
                  <a class="btn btn-lihat-keseharian" href="/career/intern" id="intern-activities">Lihat Keseharian
                    Magang di LOGIQUE</a>
                </div>
              </div>
            </div>
