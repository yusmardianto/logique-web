...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="career-update content-wrapper__">
            ...
            <section class="csection1 bg--white --top" style="padding: 3em 0" data-aos="zoom-in" data-aos-duration="500">
                <div class="container__">
                    <div class="row">
                        <div class="col-md-6">
                            <!-- <img src="/img/career/Logique.png" /> -->
                            <h1>Let’s work hard, enjoy hard<br>and grow up together!</h1>
                            <p>LOGIQUE membuka lowongan Web Developer, PHP Programmer, Web Designer, Technical Consultant, Digital
                                Marketing Strategist, dan Content Writer, untuk turut mengambil bagian dalam perkembangan digital
                                dan
                                IT.</p>
                            <a class="btn btn-yellow smooth" href="#jobvacancy" id="latest-vacancies">Check Our Latest
                                Vacancies</a>
                        </div>
                        <div class="col-md-6">
            ...
            <section class="csection2 bg--black">
                <div class="container">
                    <div class="row">
                        <div class="col-md-offset-2 col-md-8 text-center">
                            <h1 data-aos="fade-up" data-aos-duration="500">Gabung Bersama LOGIQUE</h1>
                            <p data-aos="fade-up" data-aos-duration="1500">LOGIQUE merupakan perusahaan start-up di bidang IT
                                yang
                                dibangun oleh tim yang cerdas, inovatif, dinamis. Di sini, kami memiliki misi untuk
                                bersama-sama
            ...
            <section class="bg--white">
                <div class="container__">
                    <div class="form-container">
                        <br />
                        <div class="title-alur">Jika Anda orangnya, silakan mengikuti panduan alur perekrutan Logique di bawah ini
                        </div>
                        <br />
                        <div class="row">
                            <div class="div-alur">
            ...
            <section class="csection6" id="jobvacancy">
                <div class="container__">
                    <div class="row">
                        ...
                        <div class="col-md-3 card" data-name="10">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-footer">
                                    ...
                                    <div class="text-center">
                                        <a class="btn btn-detail" href="detail/business-analyst.php"
                                            id="business-analyst">Detail</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 card" data-name="10">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-footer">
                                    ...
                                    <div class="text-center">
                                        <a class="btn btn-detail" href="detail/product-developer.php"
                                            id="product-developer">Detail</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 card" data-name="10">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-footer">
                                    ...
                                    <div class="text-center">
                                        <a class="btn btn-detail" href="detail/devops-engineer.php"
                                            id="devops-engineer">Detail</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                  ...
                  <div class="panel-footer">
                    ...
                    <div class="text-center">
                      <a class="btn btn-detail" href="detail/fullstack-product-developer.php"
                        id="fullstack-product-developer">Detail</a>
                    </div>
                  </div>
                </div>
              </div> -->
                      ...
                      <img src="/img/career/urgent.png">
                                    ...
                                    <p></p>
                                    <div class="text-center">
                                        <a class="btn btn-detail" href="detail/quality-assurance.php"
                                            id="quality-assurance">Detail</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 card" data-name="10">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-footer">
                                    <p></p>
                                    <div class="text-center">
                                        <a class="btn btn-detail" href="detail/mobile-developer.php"
                                            id="mobile-developer">Detail</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="bg-lowongan" id="internvacancy">
                        <div class="row">
                            ...
                            <div class="col-md-4 text-center">
                                <a class="btn btn-lihat-keseharian" href="/career/intern" id="intern-activities">Lihat
                                    Keseharian
                                    Magang di LOGIQUE</a>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-3 card" data-name="10">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <div class="map"><i class="fa fa-map-marker"></i> Jakarta </div>
                                    <img src="/img/career/pm.png" />
                                    <h3 style="font-size:20px;">HR/GA <br></h3>
                        ...
                        <!-- <div class="col-md-3 card hidden" data-name="10">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <div class="map"><i class="fa fa-map-marker"></i> Jakarta</div>
                                    <img src="/img/career/consultant.png" />
                                ...
                                <div class="panel-footer">
                                    ...
                                    <div class="text-center">
                                        <a class="btn btn-detail" href="detail/intern-sales-admin.php"
                                            id="intern-sales-admin">Detail</a>
                                    </div>
                                </div>
                            </div>
                        </div> -->
                        <div class="col-md-3 card" data-name="10">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-footer">
                                    ...
                                    <div class="text-center">
                                        <a class="btn btn-detail" href="detail/intern-sales-it.php"
                                            id="intern-sales-it">Detail</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 card">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-footer">
                                    <p></p>
                                    <div class="text-center">
                                        <a class="btn btn-detail" href="detail/intern-designer.php"
                                            id="intern-designer">Detail</a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <section class="csection5">
                <div class="container__">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="style1">Career Simulation</h1>
                            <p class="style2">Sesuai dengan filosofinya, LOGIQUE memberikan gaji dan tunjangan secara adil
                                kepada
                                karyawan sesuai dengan keahlian dan performa masing-masing individu, tanpa keterikatan lama
                                bekerja
                                atau usia. Jika kinerja Anda berhasil melampaui ekspektasi, Anda juga akan mendapatkan bonus
                                tambahan.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 text-center" style="z-index:2;">
                            ...
                            <div class="col-md-4 text-center boximg-fe hidden-sm hidden-md hidden-lg">
                                <h3>Oktober 2018</h3>
                                <p style="font-size:13px;">A meningkatkan keahlian untuk juga menguasai: teknik slicing dari
                                    design ke
                                    web, React JS (beginner)</p>
                                <div class="box-FE">
                                    Jabatan A<br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 text-center boximg-fe hidden-xs">
                            <h3>Oktober 2018</h3>
                            <p>A meningkatkan keahlian untuk juga menguasai: teknik slicing dari design ke web, React JS
                                (beginner)
                            </p>
                            <div class="box-FE">
                                Jabatan A<br>
                    ...
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2 text-center">
                            <div class="img-grafik_">
                                ...
                                <img src="/img/career/grafik1.png" class="grafik2" data-aos="fade-right"
                ...
                <div class="container__">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 text-center">
                            ...
                            <p class="keuntungan_m" style=" line-height: 1.5; ">Para anggota tim dibebaskan untuk menggali dan
                                mengeksplor potensi mereka, bahkan hingga di luar lingkup kerjanya, untuk memaksimalkan
                                keahlian yang
                                dimiliki masing-masing individu.</p>
                        </div>
                        <div class="col-lg-4 col-md-6 text-center">
                            <img src="/img/career/menu2.jpg" />
                            <h3>Pertumbuhan Karir</h3>
                            <p class="keuntungan_m" style=" line-height: 1.5; ">Jika Anda memiliki kemampuan yang
                                terus-menerus
                                meningkat, termasuk dalam memimpin suatu tim, Anda bisa dipromosikan langsung tanpa syarat.
                            </p>
                        </div>
                        <div class="col-lg-4 col-md-12 text-center">
                            <img src="/img/career/menu3.jpg" />
                            <h3>Fleksibel</h3>
                            <p class="keuntungan_m" style=" line-height: 1.5; ">Kami bekerja tanpa keterikatan waktu. Anda
                                tidak
                                harus bekerja 8 jam per hari, asalkan dalam seminggu Anda bisa bekerja 40 jam.</p>
                        </div>
                    </div>
                    <br>
                    <div class="row">
                    ...
                    <div class="row pull-rows">
                        ...
                        <div class="clearfix hidden-lg show-md hidden-xs"></div>
                        <div class="col-lg-4 col-md-6 col-xs-12">
                        ...
                        <div class="col-lg-4 col-md-6 col-xs-12 hidden-lg show-md hidden-sm hidden-xs">
                    ...
                    <div class="row pull-rows">
                        <div class="col-lg-4 col-md-6 col-xs-12 show-lg hidden-md show-xs">
                            <span class="icon"><img src="/img/career/menu4.png" /></span>
                            <div class="content">
                                <p>Casual Dresscode</p>
                            </div>
            ...
            <section class="csection3 carousel slide" id="myCarousel" data-ride="carousel">
                <div class="container__">
                    <div class="carousel-inner">
                        <div class="item active">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-7 text-center">
                                    ...
                                    <p class="sliderx_">“Terima kasih telah mengunjungi halaman karir LOGIQUE. LOGIQUE adalah
                                        perusahaan
                                        yang menyenangkan, digerakkan oleh orang-orang hebat yang profesional, bekerja keras,
                                        dan senang
                                        bekerja dalam tim yang bersahabat. Tujuan saya adalah mengembangkan potensi penuh yang
                                        dimiliki
                                        orang-orang hebat ini sehingga LOGIQUE juga ikut menjadi perusahaan hebat. Saya suka
                                        orang yang
                                        rajin dan mau berjuang. Saya terus berusaha memberi mereka peluang terbaik untuk bisa
                                        sukses
                                        besar. Jika Anda mau bergabung bersama kami, tim kami adalah fondasi dari kesuksesan
                                        masa depan
                                        perusahaan. Perjalanan kita di sini akan menantang sekaligus memberikan manfaat. Mari
                                        berkembang
                                        dan meraih kesuksesan besar bersama-sama.”</p>
                                    <p class="sliderx__">-- Yoshi, CEO / Founder</p>
                                    <a class="btn btn-yellow pull-right" href="detail/yoshi.php" id="interview-ceo">Interview
                                        with
                                        CEO</a>
                                </div>
                            </div>
                        ...
                        <div class="item">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-7 text-center">
                                    <div class="text-message hidden-xs">Message for Candidates</div>
                                    <p class="sliderx_">“Sangat penting bagi Anda untuk mengetahui di mana dan bagaimana Anda
                                        bekerja.
                                        Jika Anda bekerja keras, merasakan bahwa bekerja penting untuk kehidupan Anda, dan
                                        ingin
                                        berkontribusi kepada perusahaan, kami berjanji akan menyediakan lingkungan kerja yang
                                        baik untuk
                                        Anda. Di LOGIQUE, kami menyambut individu yang kreatif dan dinamis serta berusaha
                                        untuk
                                        pengembangan pribadi dan profesional. Sebagai gantinya, maka kami berkomitmen untuk
                                        menghasilkan
                                        yang terbaik dari diri Anda dengan menawarkan kesempatan untuk kemajuan dan
                                        pertumbuhan, dan
                                        memberikan karir yang mengubah hidup tidak seperti yang lain. Mari berkembang bersama
                                        LOGIQUE!”
                                    </p>
                                    <p class="sliderx__">-- Ghitta, HRD</p>
                                    <a class="btn btn-yellow pull-right" href="detail/ghitta.php" id="interview-hr">Interview
                                        with
                                        HRD</a>
                                </div>
                            </div>
                        ...
                        <div class="item">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-7 text-center">
                                    <div class="text-message hidden-xs">Message for Candidates</div>
                                    <p class="sliderx_">“LOGIQUE tidak hanya melihat technical skill seseorang tetapi juga
                                        soft skill
                                        dan attitude. Selain itu, selama Anda merasa dapat memberikan kontribusi di bidang
                                        Anda, LOGIQUE
                                        akan mempertimbangkan hal itu baik-baik. Namun, jika Anda mempunyai target untuk
                                        menjadi yang
                                        Back-End Developer terbaik, saya menyarankan Anda untuk terbiasa dalam menggunakan
                                        berbagai bahasa
                                        pemrograman, framework, cloud server topology AWS, dan semacamnya.”</p>
                                    <p class="sliderx__">-- Muklis, Senior Back End Developer</p>
                                    <a class="btn btn-yellow pull-right" href="detail/muklis.php"
                                        id="interview-back-end">Interview with
                        ...
                        <div class="item">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-7 text-center">
                                    <div class="text-message hidden-xs">Message for Candidates</div>
                                    <p class="sliderx_">“Show your best. Pastikan kalau kamu memiliki pengalaman dan menguasai
                                        bidang
                                        yang kamu lamar. Ibaratnya mau jadi atlet renang, kamu tentu harus bisa berenang
                                        (haha). Selain
                                        itu, tunjukkan juga kalau kamu profesional dan punya minat belajar yang tinggi. Untuk
                                        kamu yang
                                        senang bekerja cepat, kamu bakal suka bekerja di LOGIQUE.”</p>
                                    <p class="sliderx__">-- Taufik, Senior Front End Developer</p>
                                    <a class="btn btn-yellow pull-right" href="detail/taufik.php"
                                        id="interview-front-end">Interview
                                        with Senior Front End Developer</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section class="csection5 bg-abu-abu">
                <div class="container__">
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="box-visi margin_" data-aos="fade-up" data-aos-duration="500">
                                ...
                                <p>Sesuai dengan filosofi nama LOGIQUE, landasan kami adalah keadilan berasas logika. Sebab,
                                    berpikir
                                    secara logis dalam setiap kesempatan membuat kami mampu memberikan nilai yang tidak hanya
                                    tepat
                                    namun juga dapat diterima baik dari sisi perusahaan, karyawan, maupun klien.</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="box-visi kuning_" data-aos="fade-up" data-aos-duration="1000">
                                ...
                                <p>Kami sadar, setiap karyawan tidak bisa diperlakukan sama dengan karyawan lainnya. LOGIQUE
                                    memperlakukan karyawan secara adil berdasarkan situasi masing-masing individu. Misalnya,
                                    jika
                                    karyawan tidak bisa bekerja di kantor karena harus merawat ibunya, karyawan diberikan hak
                                    istimewa
                                    untuk kerja remote.</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="box-visi margin_" data-aos="fade-up" data-aos-duration="1500">
                                ...
                                <p>Perkembangan teknologi yang terus berkembang menuntut kita semua untuk ikut semakin
                                    terampil.
                                    LOGIQUE selalu membebaskan karyawannya untuk saling belajar dan terus memperdalam
                                    keterampilan
                                    masing-masing. Ini agar seluruh karyawan dapat berkembang bersama-sama di dalam
                                    perusahaan.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p class="text-center jika-ada-class">Jika Anda tertarik bekerja di LOGIQUE, kami tidak akan
                                membebani
                                Anda proses rekrutmen yang terlalu panjang dan melelahkan.</p>
                        </div>
                    </div>
                    <div class="row">
