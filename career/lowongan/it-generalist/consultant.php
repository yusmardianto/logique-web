...
<head>
  ...
  <meta name="description" itemprop="description"
    content="LOGIQUE, konsultasi IT, pengembang sistem Web dan agensi Pemasaran Digital sedang mencari Consultant. Mari bekerja bersama kami di lingkungan yang fleksibel dan menguntungkan dan tumbuh bersama.">
  <meta name="keywords"
    content="keuntungan bekerja di logique, join us, consultant, lowongan kerja, digital marketing, seo, desain">
  <meta name="author" content="PT. Logique Digital Indonesia">
  <meta property="og:title" content="Consultant | Lowongan Kerja | IT Generalist | LOGIQUE Digital Indonesia">
  ...
  <title>Consultant | Lowongan Kerja | IT Generalist | LOGIQUE Digital Indonesia</title>
...
<body>
  <div class="wrapper">
    ...
    <div class="career-update content-wrapper__">
      ...
      <section class="container-fluid --top bg--main-consultant">
            ...
            <div class="col-sm-offset-1 col-sm-10">
              <ol class="breadcrumb breadcrumb--update-design" itemscope itemtype="http://schema.org/BreadcrumbList">
                ...
                <li class="active" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a
                    itemprop="item"><span itemprop="name">&nbsp; Consultant</span></a>
        ...
        <div class="container--max-width header-banner">
          <div class="row">
            <div class="col-sm-offset-1 col-lg-6 col-md-9 col-sm-10">
              <h1 class="header__title">Consultant</h1>
        ...
        <div class="container--max-width">
          <div class="row">
            ...
            <div class="col-sm-offset-1 col-md-offset-0 col-md-5 col-sm-10">
              ...
              <!-- <div class="career-requirement">
                <h3 class="section-title">Cara Bekerja Consultant Sehari - hari di <strong class="logofont">LOGIQUE</strong></h3>
                <h4 class="section-subtitle">Consultant Assistant</h4>
                ...
                <div class="col-md-4 col-sm-12">
                  <div class="salary-range">
                    <div class="salary-range__head">
                      ...
                      <h5 class="section-title">Consultant</h5>
                    </div>
