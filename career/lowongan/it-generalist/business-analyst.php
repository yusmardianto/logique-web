...
<body>
  <div class="wrapper">
    ...
    <div class="career-update content-wrapper__">
      ...
      <section class="container-fluid --top bg--main-business-analyst">
            ...
            <div class="col-sm-offset-1 col-sm-10">
              <ol class="breadcrumb breadcrumb--update-design" itemscope itemtype="http://schema.org/BreadcrumbList">
                ...
                <li class="active" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a
                    itemprop="item"><span itemprop="name">&nbsp; Business Analyst</span></a>
        ...
        <div class="container--max-width">
          <div class="row">
            ...
            <div class="col-sm-offset-1 col-md-offset-0 col-md-5 col-sm-10">
              ...
              <div class="career-requirement">
                <h3 class="section-title">Cara Bekerja Business Analyst Sehari - hari di <strong class="logofont">LOGIQUE</strong></h3>
