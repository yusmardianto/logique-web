...
<head>
  ...
  <meta property="og:title" content="Lead Quality Assurance Engineer (Software) | Lowongan Kerja | IT Specialist | LOGIQUE Digital Indonesia">
  ...
  <title>Lead Quality Assurance Engineer (Software) | Lowongan Kerja | IT Specialist | LOGIQUE Digital Indonesia</title>
        ...
        <div class="container--max-width header-banner">
          <div class="row">
            <div class="col-sm-offset-1 col-lg-6 col-md-9 col-sm-10">
              <h1 class="header__title">Lead Quality Assurance Engineer (Software)</h1>
        ...
        <div class="container--max-width">
          <div class="row">
            <div class="col-sm-offset-1 col-md-5 col-sm-10">
              <div class="career-requirement">
                ...
                <ul class="career-list">
                  <li>
                    Mengembangkan dan memelihara pengujian skenario dan end user script untuk verifikasi fungsi yang diinginkan klien.</li>
            ...
            <div class="col-sm-offset-1 col-md-offset-0 col-md-5 col-sm-10">
                 <div class="career-requirement">
                  <h3 class="section-title">Skill Experience</h3>
                  <ul class="career-list">
                ...
                <div class="career-requirement">
                  ...
                  <ul class="career-list">
                    <li>Dengan jumlah project yang banyak, anda akan menemukan berbagai macam jenis masalah dalam konteks pengujian QA yang akan menambah pengetahuan anda.</li>
