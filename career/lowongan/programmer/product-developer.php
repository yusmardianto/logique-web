...
<body>
  <div class="wrapper">
    ...
    <div class="career-update content-wrapper__">
      ...
      <section class="container-fluid --top bg--main-product-dev">
        ...
        <div class="container--max-width">
          <div class="row">
            ...
            <div class="col-sm-offset-1 col-md-offset-0 col-md-5 col-sm-10">
              ...
              <div class="career-requirement">
                <h3 class="section-title">Cara Bekerja Product Developer Sehari - hari di <strong class="logofont">LOGIQUE</strong></h3>
