...
<head>
  ...
  <meta property="og:title" content="Lowongan Kerja Programmer | IT Specialist | LOGIQUE Digital Indonesia">
...
<body>
  ...
  <div class="wrapper">
    ...
    <div class="career-update content-wrapper__">
      <section class="container-fluid --top bg--main-programmer">
            ...
            <div class="col-sm-offset-1 col-sm-10">
              <ol class="breadcrumb breadcrumb--update-design" itemscope itemtype="http://schema.org/BreadcrumbList">
                ...
                <li class="active" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a
                    itemprop="item"><span itemprop="name">&nbsp; Programmer</span></a>
        ...
        <div class="container--max-width header-banner">
          <div class="row">
            <div class="col-sm-offset-1 col-sm-5">
              <h1 class="header__title">Programmer</h1>
              <p>
