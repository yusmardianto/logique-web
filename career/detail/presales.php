...
<html lang="id">
  <head>
    ...
    <meta name="description" itemprop="description" content="Dibutuhkan Pre-sales Consultant yang dapat memberi saran strategi dalam teknologi, memahami kebutuhan IT dan tujuan bisnis klien, terlibat dalam perencanaan, konsultasi, negosiasi, dan penawaran proyek. Must skill: Berpengetahuan yang baik dalam pembuatan website, web system, atau aplikasi mobile">
	<meta name="keywords" content="lowongan, kerja, jakarta, remote job jakarta, kerja remote jakarta,  networking, marketing, sales consultant, pre-sales consultant, indonesia, problem solving, strategis, bisnis, analisa, IT, customer oriented, target penjualan">
							...
							<div class="row">
								<div class="col-md-12">
									...
									<ol class="breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">
										...
										<li class="active" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem" >Pre-Sales Consultant<meta itemprop="position" content="2" /></li>
									</ol>
								</div>
							</div>
						</div>
						...
						<div class="container">
							<div class="row">
								<div class="col-md-6 text-center">
									<h1><img src="/img/career/sales.png" style="filter: contrast(0%) brightness(150%);"> Pre-Sales Consultant</h1>
								</div>
								<!-- <div class="col-md-6 text-center">
								...
								<div class="col-md-offset-1 col-md-10">
									<div class="content-vacancy">
										...
										<br>
											<div class="text-center">
											<br>
												<a class="btn btn-yellow smooth" id="apply-presales" href="https://logique.sugoisaiyo.com/" onclick="ga('send', 'event', 'Pre-Sales-Apply-Button', 'Action-Click', 'Pre-Sales-Apply-Button-Label');" target="_blank" rel="noreferrer">Apply</a>
											</div>
										</div>
									</div>
								</div>
