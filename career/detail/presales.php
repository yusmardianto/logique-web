...
<head>
    ...
    <meta name="description" itemprop="description"
        content="Dibutuhkan Pre-sales Consultant yang dapat memberi saran strategi dalam teknologi, memahami kebutuhan IT dan tujuan bisnis klien, terlibat dalam perencanaan, konsultasi, negosiasi, dan penawaran proyek. Must skill: Berpengetahuan yang baik dalam pembuatan website, web system, atau aplikasi mobile">
    <meta name="keywords"
        content="lowongan, kerja, jakarta, remote job jakarta, kerja remote jakarta,  networking, marketing, sales consultant, pre-sales consultant, indonesia, problem solving, strategis, bisnis, analisa, IT, customer oriented, target penjualan">
    ...
    <title>Lowongan - Pre-Sales Consultant</title>
    ...
    <script type="application/ld+json">
    {
        ...
        "url": "https://www.logique.co.id/career/detail/presales.php",
        "hiringOrganization": {
            "@type": "Corporation",
        ...
        "experienceRequirements": "Memiliki pengalaman sebagai IT Consultant minimal selama 2 tahun.",
        ...
        "qualifications": "Memiliki pengalaman sebagai IT Consultant minimal selama 2 tahun.",
        "responsibilities": "Terlibat dan memberikan dukungan dalam proses penawaran, khususnya dalam mengestimasi usaha yang diperlukan untuk mengimplementasikan kebutuhan pelanggan ke dalam sistem.",
                            ...
                            <div class="col-md-12">
                                ...
                                <ol class="breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">
                                    ...
                                    <li class="active" itemprop="itemListElement" itemscope
                                        itemtype="http://schema.org/ListItem">Pre-Sales Consultant
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6 text-center">
                                <h1><img src="/img/career/sales.png" style="filter: contrast(0%) brightness(150%);">
                                    Pre-Sales Consultant</h1>
                            </div>
                            <!-- <div class="col-md-6 text-center">
                                ...
                                <div class="content-vacancy">
                                    <div class="div-job desc-job">
                                        ...
                                        <ul class="joinus-ul">
                                            ...
                                            <li>Memberikan saran strategis mengenai penggunaan teknologi untuk mencapai
                                                tujuan.</li>
                                            <li>Terlibat dan memberikan dukungan dalam proses penawaran, khususnya dalam
                                                mengestimasi usaha yang diperlukan untuk mengimplementasikan kebutuhan
                                                pelanggan ke dalam sistem.</li>
                                            <li>Membuat rencana penerapan proyek dan dokumen pendukung atau laporan yang
                                                diperlukan.</li>
                                            <li>Melakukan analisa terhadap teknologi atau sistem untuk kebutuhan
                                                konsultasi atau penawaran.</li>
                                            <li>Berkoordinasi dan mengelola tim terkait pengembangan proyek yang
                                                direncanakan jika diperlukan.</li>
                                            <li>Membuat laporan mingguan untuk mengetahui kemajuan target penjualan
                                                serta mendokumentasikan kinerja penjualan.</li>
                                        ...
                                        <ul class="joinus-ul">
                                            ...
                                            <li>Memiliki pengetahuan yang baik dalam bidang pembuatan website, web
                                                system, atau aplikasi mobile.</li>
                                        ...
                                        <ul class="joinus-ul">
                                            <li>Kesempatan bertemu banyak klien dari berbagai macam bidang dan industri.
                                            </li>
                                            <li>Dapat beradaptasi dalam hal komunikasi kepada banyak klien yang
                                                multikultural.</li>
                                        </ul>
                                        <br>
                                        ...
                                        <div class="text-center">
                                            <br>
                                            <a class="btn btn-yellow smooth" id="apply-presales"
                                                href="https://logique.sugoisaiyo.com/"
                                                onclick="ga('send', 'event', 'Pre-Sales-Apply-Button', 'Action-Click', 'Pre-Sales-Apply-Button-Label');"
