							...
							<div class="row">
								<div class="col-md-12">
									...
									<ol class="breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">
										...
										<li class="active" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem" >React Native Developer<meta itemprop="position" content="2" /></li>
									</ol>
								</div>
							</div>
						</div>
						...
						<div class="container">
							<div class="row">
								<div class="col-md-6 text-center">
									<h1><img src="/img/career/fe.png" style="filter: contrast(0%) brightness(150%);"> React Native Developer</h1>
								</div>
								<!-- <div class="col-md-6 text-center">
								...
								<div class="col-md-offset-1 col-md-10">
									<div class="content-vacancy">
										...
										<br>
											<div class="text-center">
											<br>
												<a class="btn btn-yellow smooth" id="apply-react-native" href="https://logique.sugoisaiyo.com/" onclick="ga('send', 'event', 'React-Native-Apply-Button', 'Action-Click', 'React-Native-Apply-Button-Label');" target="_blank" rel="noreferrer">Apply</a>
											</div>
										</div>
									</div>
								</div>
