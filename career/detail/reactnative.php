...
<head>
    ...
    <meta name="description" itemprop="description"
        content="Dicari React native developer yang terbiasa menggunakan native build tools, pernah merilis aplikasi android/iOS, serta memiliki pengetahuan mendalam tentang JavaScript dan TypeScript, HTML, CSS, dan RESTful APIs. Diutamakan berpengalaman dengan Native Android dan iOs SDKs. Salary negotiable">
    <meta name="keywords"
    ...
    <script type="application/ld+json">
    {
        ...
        "url": "https://www.logique.co.id/career/detail/reactnative.php",
        "hiringOrganization": {
            "@type": "Corporation",
        ...
        "experienceRequirements": "Pengalaman pada bidang software development minimal 2 tahun",
        ...
        "qualifications": "Memiliki pengalaman dengan Native Android dan iOS SDKs",
        "responsibilities": "Menggunakan Native API agar dapat diintegrasikan secara mendalam untuk mobile platform Android/iOS",
        "skills": "Memiliki pengalaman yang luas dengan React Native dan RESTful APIs",
                            ...
                            <div class="col-md-12">
                                ...
                                <ol class="breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">
                                    ...
                                    <li class="active" itemprop="itemListElement" itemscope
                                        itemtype="http://schema.org/ListItem">React Native Developer
                                ...
                                <div class="content-vacancy">
                                    <div class="div-job desc-job">
                                        ...
                                        <ul class="joinus-ul">
                                            ...
                                            <li>Menggunakan Native API agar dapat diintegrasikan secara mendalam untuk
                                                mobile platform Android/iOS</li>
                                            <li>Bekerja sama dengan tim design agar dapat direalisasikan dalam bentuk
                                                desain UI/UX</li>
                                            <li>Mendiagnosa dan memperbaiki masalah aplikasi </li>
                                            <li>Kontribusi dalam komunitas React Native untuk melakukan pelaporan,
                                                permintaan, dan membantu dalam mengimplementasikan sebuah perbaikan.
                                            </li>
                                        ...
                                        <ul class="joinus-ul">
                                            ...
                                            <li>Memiliki ijazah S1 atau S2 / pengalaman dalam bidang Ilmu Teknologi atau
                                                relevant</li>
                                            <li>Memiliki pemahaman yang mendalam terhadap JavaScript dan Type Script
                                            </li>
                                            <li>Memiliki pengalaman yang luas dengan React Native dan RESTful APIs</li>
                                            <li>Mahir dalam menggunakan HTML dan CSS</li>
                                            <li>Memiliki kebiasaan menggunakan native build tools,(Xcode, Android
                                                Studio/IntelliJ, danGradle)</li>
                                        </ul>
                                        <br>
                                        ...
                                        <div class="text-center">
                                            <br>
                                            <a class="btn btn-yellow smooth" id="apply-react-native"
                                                href="https://logique.sugoisaiyo.com/"
                                                onclick="ga('send', 'event', 'React-Native-Apply-Button', 'Action-Click', 'React-Native-Apply-Button-Label');"
