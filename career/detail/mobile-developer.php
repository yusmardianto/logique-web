...
<html lang="id">
  <head>
	...
	<meta property="og:description" content="Lowongan pekerjaan Mobile App Developer bagi yang berpengalaman sebagai pengembang Mobile app (iOS dan Android), memiliki pengetahuan tentang Swift / Java / bahasa pemrograman lainnya. Segera daftarkan diri di website LOGIQUE.">
							...
							<div class="row">
								<div class="col-md-12">
									...
									<ol class="breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">
										...
										<li class="active" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem" >Mobile App Developer<meta itemprop="position" content="2" /></li>
									</ol>
								</div>
							</div>
						</div>
								...
								<div class="col-md-offset-1 col-md-10">
									<div class="content-vacancy">
										...
										<br>
											<div class="text-center">
											<br>
												<a class="btn btn-yellow smooth" id="apply-mobile-dev" href="https://logique.sugoisaiyo.com/" onclick="ga('send', 'event', 'Mobile-Dev-Apply-Button', 'Action-Click', 'Mobile-Dev-Apply-Button-Label');" target="_blank" rel="noreferrer">Apply</a>
											</div>
										</div>
									</div>
								</div>
