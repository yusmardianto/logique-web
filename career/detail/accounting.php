...
<head>
    ...
    <meta name="keywords"
        content="lowongan, kerja, jakarta, remote job jakarta, kerja remote jakarta, indonesia, accounting and tax officer, accounting, tax officer, tax, taxtation, taxation law, hukum pajak, akunting, faktur pajak, e-faktur, tax consultant, konsultasi pajak, audit, pelaporan, rekap pajak">
    ...
    <title>Lowongan - Accounting and Tax Officer</title>

    <script type="application/ld+json">
    {
        "@context": "http://schema.org",
        "@type": "JobPosting",
        "title": "Accounting and Tax Officer",
        "url": "https://www.logique.co.id/career/detail/accounting.php",
        "hiringOrganization": {
            "@type": "Corporation",
        ...
        "experienceRequirements": "Berpengalaman minimal 2 tahun di bidang yang sama",
        ...
        "qualifications": "Berpengalaman minimal 2 tahun di bidang yang sama",
        "responsibilities": "Membuat Faktur Pajak dan e-faktur.",
        "skills": "Up to date, teliti, dan memiliki pemahaman yang kuat mengenai hukum perpajakan",
                            ...
                            <div class="col-md-12">
                                ...
                                <ol class="breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">
                                    ...
                                    <li class="active" itemprop="itemListElement" itemscope
                                        itemtype="http://schema.org/ListItem">Accounting & Tax Officer
                        ...
                        <div class="row">
                            <div class="col-md-6 text-center">
                                <h1><img src="/img/career/accounting.png"
                                        style="filter: contrast(0%) brightness(150%);"> Accounting & Tax Officer</h1>
                            </div>
                            <div class="col-md-6 text-center">
                        ...
                        <div class="row">
                            <div class="col-md-offset-1 col-md-10">
                                <div class="content-vacancy">
                                    <h3 class="text-center"> Accounting & Tax Officer (di Jakarta) dengan 2 tahun
                                        pengalaman</h3>
                                    <hr>
                                    <div class="div-job desc-job">
                                        ...
                                        <ol class="joinus-ul">
                                            ...
                                            <li>Up to date, teliti, dan memiliki pemahaman yang kuat mengenai hukum
                                                perpajakan</li>
                                        ...
                                        <div class="text-center">
                                            <br>
                                            <a class="btn btn-yellow smooth" id="apply-accounting"
                                                href="https://logique.sugoisaiyo.com/"
                                                onclick="ga('send', 'event', 'Accounting-Apply-Button', 'Action-Click', 'Accounting-Apply-Button-Label');"
