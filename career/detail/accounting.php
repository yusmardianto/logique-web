...
<html lang="id">
  <head>
    ...
    <meta name="description" itemprop="description" content="Bila Anda ahli dalam bidang accounting dan perpajakan, menyukai hitung-berhitung mengenai perpajakan dan accounting, up-to-date mengenai hukum perpajakan, LOGIQUE membuka peluang untuk Anda bergabung bersama kami.">
	<meta name="keywords" content="lowongan, kerja, jakarta, remote job jakarta, kerja remote jakarta, indonesia, accounting and tax officer, accounting, tax officer, tax, taxtation, taxation law, hukum pajak, akunting, faktur pajak, e-faktur, tax consultant, konsultasi pajak, audit, pelaporan, rekap pajak">
	...
	<meta property="og:description" content="Bila Anda ahli dalam bidang accounting dan perpajakan, menyukai hitung-berhitung mengenai perpajakan dan accounting, up-to-date mengenai hukum perpajakan, LOGIQUE membuka peluang untuk Anda bergabung bersama kami.">
							...
							<div class="row">
								<div class="col-md-12">
									...
									<ol class="breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">
										...
										<li class="active" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem" >Accounting & Tax Officer <meta itemprop="position" content="2" /></li>
									</ol>
								</div>
							</div>
						</div>
						...
						<div class="container">
							<div class="row">
								<div class="col-md-6 text-center">
									<h1><img src="/img/career/accounting.png" style="filter: contrast(0%) brightness(150%);"> Accounting & Tax Officer</h1>
								</div>
								<div class="col-md-6 text-center">
