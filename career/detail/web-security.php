								...
								<div class="col-md-offset-1 col-md-10">
									...
									<li>Jakarta</li>
										...
										<div class="div-job desc-job">
											<div class="text-center">
											<br>
												<a class="btn btn-yellow smooth" id="apply-web-security" href="https://logique.sugoisaiyo.com/" onclick="ga('send', 'event', 'Web-Security-Apply-Button', 'Action-Click', 'Web-Security-Apply-Button-Label');" target="_blank" rel="noreferrer">Apply</a>
											</div>
										</div>
									</div>
								</div>
