...
<head>
    ...
    <meta name="description" itemprop="description"
        content="Lowongan Digital Marketing Strategist untuk yang telah tebiasa dengan SEO dan optimasi web dari sisi teknis / konten, menganalisis dan mengoptimalkan web menggunakan analytical tools. Kemampuan programming dan copywriting merupakan nilai plus.">
    <meta name="keywords"
    ...
    <title>Lowongan - Digital Marketing Strategist</title>
    ...
    <script type="application/ld+json">
    {
        ...
        "url": "https://www.logique.co.id/career/detail/digital-marketing.php",
        "hiringOrganization": {
            "@type": "Corporation",
        ...
        "description": "Lowongan Digital Marketing Strategist untuk yang telah tebiasa dengan SEO dan optimasi web dari sisi teknis / konten, menganalisis dan mengoptimalkan web menggunakan analytical tools. Kemampuan programming dan copywriting merupakan nilai plus.<br><br>Requirement:<ul><li>Memiliki minimal 2 tahun pengalaman dalam web development / agensi digital marketing.</li><li>Mampu berpikir logis & strategis.</li><li>Terbiasa dengan SEO dan optimasi web dalam hal teknis dan konten.</li><li>Terbiasa dalam menganalisis dan mengoptimalkan tool yang terkait dengan digital marketing, seperti:</li><li>Google Analytics</li><li>Google Ads (Search Ads, GDN Ads, Youtube Ads)</li><li>Facebook / Instagram Ads</li><li>Twitter Ads</li><li>Linked In Ads</li><li>Berpengalaman dalam hal memberikan konsultasi/saran/diskusi dengan client/customer</li><li>Mampu menyajikan laporan yang analitis dan terstruktur sesuai kebutuhan client/customer</li></ul><br><br>Job Description:<ul><li>Menganalisis dan memantau kinerja situs web, digital ads, dan media sosial dengan di berbagai platform.</li><li>Menyarankan strategi untuk meningkatkan kinerja berdasarkan analisis.</li><li>Terus menyesuaikan performa setiap platform dan situs web untuk mendapatkan hasil yang lebih baik dengan berkolaborasi dengan web developer, content writer, dan design.</li><li>Mengoptimalkan performa dengan orientasi terhadap target hasil atau conversion yang dibutuhkan client/customer</li></ul>",
        "educationRequirements": "Memiliki minimal 2 tahun pengalaman dalam web development / agensi digital marketing..",
        "employmentType": "FULL_TIME",
        "experienceRequirements": "Memiliki minimal 2 tahun pengalaman dalam web development / agensi digital marketing.",
        ...
        "qualifications": "Memiliki minimal 2 tahun pengalaman dalam web development / agensi digital marketing.",
        "responsibilities": "Menganalisis dan memantau kinerja situs web, digital ads, dan media sosial dengan di berbagai platform.",
        "skills": "Google Ads (Search Ads, GDN Ads, Youtube Ads)",
                            ...
                            <div class="col-md-12">
                                ...
                                <ol class="breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">
                                    ...
                                    <li class="active" itemprop="itemListElement" itemscope
                                        itemtype="http://schema.org/ListItem">Digital Marketing Strategist
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6 text-center">
                                <h1><img src="/img/career/marketing.png" style="filter: contrast(0%) brightness(150%);">
                            ...
                            <div class="col-md-offset-1 col-md-10">
                                <div class="content-vacancy">
                                    ...
                                    <div class="div-job desc-job">
                                        ...
                                        <ul class="joinus-ul">
                                            <li>Memiliki minimal 2 tahun pengalaman dalam web development / agensi
                                            ...
                                            <li>Terbiasa dalam menganalisis dan mengoptimalkan tool yang terkait dengan
                                                digital marketing, seperti:</li>
                                        ...
                                        <div class="text-center">
                                            <br>
                                            <a class="btn btn-yellow smooth" id="apply-digital-marketing"
                                                href="https://logique.sugoisaiyo.com/"
                                                onclick="ga('send', 'event', 'DM-Apply-Button', 'Action-Click', 'DM-Apply-Button-Label');"
