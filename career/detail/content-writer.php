...
<html lang="id">
  <head>
    ...
    <meta name="description" itemprop="description" content="LOGIQUE membuka lowongan pekerjaan bagi Anda yang terampil dalam penulisan konten web dengan Bahasa Indonesia dan Inggris untuk membuat konten pemasaran yang jelas guna mempromosikan produk/layanan kami.">
	...
	<meta property="og:description" content="LOGIQUE membuka lowongan pekerjaan bagi Anda yang terampil dalam penulisan konten web dengan Bahasa Indonesia dan Inggris untuk membuat konten pemasaran yang jelas guna mempromosikan produk/layanan kami.">
							...
							<div class="row">
								<div class="col-md-12">
									...
									<ol class="breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">
										...
										<li class="active" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem" >IT Content Writer<meta itemprop="position" content="2" /></li>
									</ol>
								</div>
							</div>
						</div>
						...
						<div class="container">
							<div class="row">
								<div class="col-md-6 text-center">
									<h1><img src="/img/career/contentwriter.png" style="filter: contrast(0%) brightness(150%);"> IT Content Writer</h1>
								</div>
								<div class="col-md-6 text-center">
								...
								<div class="col-md-offset-1 col-md-10">
									<div class="content-vacancy">
										...
										<div class="div-job desc-job">
											...
											<div class="text-center">
											<br>
												<a class="btn btn-yellow smooth" id="apply-content-writer" href="https://logique.sugoisaiyo.com/" onclick="ga('send', 'event', 'Content-Writer-Apply-Button', 'Action-Click', 'Content-Writer-Apply-Button-Label');" target="_blank" rel="noreferrer" disabled>Apply</a>
											</div>
										</div>
									</div>
								</div>
