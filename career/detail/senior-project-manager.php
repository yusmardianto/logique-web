...
<head>
    ...
    <meta name="keywords"
        content="lowongan, kerja, jakarta, remote job jakarta, kerja remote jakarta, indonesia, Project Manager, IT project manager, web development manager, project management, planning, proposal, report">
    ...
    <title>Lowongan - Senior Project Manager</title>
    ...
    <script type="application/ld+json">
    {
        ...
        "url": "https://www.logique.co.id/career/detail/senior-project-manager.php",
        "hiringOrganization": {
            "@type": "Corporation",
        ...
        "experienceRequirements": "Memiliki pengalaman sebelumnya minimal 5 tahun pada bidang Web dan System Development",
        ...
        "skills": "Memiliki pengalaman sebelumnya minimal 5 tahun pada bidang Web dan System Development.",
                            ...
                            <div class="col-md-12">
                                ...
                                <ol class="breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">
                                    ...
                                    <li class="active" itemprop="itemListElement" itemscope
                                        itemtype="http://schema.org/ListItem">Senior Project Manager
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6 text-center">
                                <h1><img src="/img/career/pm.png" style="filter: contrast(0%) brightness(150%);"> Senior
                                    Project Manager</h1>
                            </div>
                            <div class="col-md-6 text-center">
                            ...
                            <div class="col-md-offset-1 col-md-10">
                                <div class="content-vacancy">
                                    <div class="div-job desc-job">
                                        ...
                                        <ul class="joinus-ul">
                                            <li>Memiliki pengalaman sebelumnya minimal 5 tahun pada bidang Web dan
                                        ...
                                        <div class="text-center">
                                            <br>
                                            <a class="btn btn-yellow smooth" id="apply-senior-pm"
                                                href="https://logique.sugoisaiyo.com/"
                                                onclick="ga('send', 'event', 'Senior-PM-Apply-Button', 'Action-Click', 'Senior-PM-Apply-Button-Label');"
