...
<head>
    ...
    <meta property="og:title" content="Lowongan - IT Account Executive">
    ...
    <script type="application/ld+json">
    {
        ...
        "@type": "JobPosting",
        "title": "IT Account Executive",
        "url": "https://www.logique.co.id/career/detail/it-account-executive.php",
        "hiringOrganization": {
            "@type": "Corporation",
        ...
        "experienceRequirements": "Memiliki minimal 2 tahun pengalaman di bidang yang sejenis",
        ...
        "qualifications": "Memiliki minimal 2 tahun pengalaman di bidang yang sejenis",
                            ...
                            <div class="col-md-12">
                                ...
                                <ol class="breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">
                                    ...
                                    <li class="active" itemprop="itemListElement" itemscope
                                        itemtype="http://schema.org/ListItem">IT Account Executive
                        ...
                        <div class="row">
                            <div class="col-md-6 text-center">
                                <h1><img src="/img/career/accounting.png"
                                        style="filter: contrast(0%) brightness(150%);"> IT Account Executive</h1>
                            </div>
                            <div class="col-md-6 text-center">
                            ...
                            <div class="col-md-offset-1 col-md-10">
                                <div class="content-vacancy">
                                    <div class="div-job desc-job">
                                        ...
                                        <div class="text-center">
                                            <br>
                                            <a class="btn btn-yellow smooth" id="apply-it-account-executive"
                                                href="https://logique.sugoisaiyo.com/"
                                                onclick="ga('send', 'event', 'IT-Account-Executive-Apply-Button', 'Action-Click', 'IT-Account-Executive-Apply-Button-Label');"
