...
<head>
    ...
    <script type="application/ld+json">
    {
        ...
        "url": "https://www.logique.co.id/career/detail/intern-designer.php",
        "hiringOrganization": {
            "@type": "Corporation",
        ...
        "qualifications": "Segala jurusan, diutamakan related dengan Design",
        "responsibilities": "Mendesain tampilan/UI untuk website dan aplikasi mobile maupun untuk produksicetak / printing (misal : brosur, flyer, name card).",
        "skills": "Memiliki kemampuan untuk menggunakan software desain (Photoshop, Illustrator, Sketch, Balsamiq, dll).",
                            ...
                            <div class="col-md-12">
                                ...
                                <ol class="breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">
                                    ...
                                    <li class="active" itemprop="itemListElement" itemscope
                                        itemtype="http://schema.org/ListItem">Intern UI/UX designer
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6 text-center">
                                <h1><img src="/img/career/designer.png" style="filter: contrast(0%) brightness(150%);">
                                    Intern UI/UX designer</h1>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-md-offset-1 col-md-10">
                                <div class="content-vacancy">
                                    <div class="div-job desc-job">
                                        ...
                                        <ul class="joinus-ul">
                                            <li>Mendesain tampilan/UI untuk website dan aplikasi mobile maupun untuk
                                                produksicetak / printing (misal : brosur, flyer, name card).</li>
                                            <li>Memahami konsep video animasi (2D)</li>
                                            <li>Merancang, memberi arahan terkait desain, dan dukungan terkait pekerjaan
                                                desain di atas.</li>
                                            <li>Berkolaborasi dengan department yang lain terkait dengan pekerjaan
                                                design</li>
                                        </ul>
                                        <br>
                                        <b class="getN">Must Skill/Experience </b><br>
                                        <ul class="joinus-ul">
                                            <li>Segala jurusan, diutamakan related dengan Design</li>
                                            <li>Mudah di arahkan, beradaptasi dan dalam berkomunikasi dengan orang lain.
                                            </li>
                                            ...
                                            <li>Memiliki kemampuan untuk menggunakan software desain (Photoshop,
                                                Illustrator, Sketch, Balsamiq, dll).</li>
                                            <li>Mampu menerjemahkan wireframe ke bentuk desain sesuai dengan yang
                                                dibutuhkan.</li>
                                        </ul>
                                        <br>
                                        ...
                                        <ul class="joinus-ul">
                                            ...
                                            <li>Memiliki selera yang baik dalam design </li>
                                            <li>Mengikuti trend design saat ini</li>
                                        </ul>
                                        <br>
                                        ...
                                        <div class="text-center">
                                            <br>
                                            <a class="btn btn-yellow smooth" id="apply-intern-desginer"
                                                href="https://logique.sugoisaiyo.com/"
                                                onclick="ga('send', 'event', 'Intern-Designer-Apply-Button', 'Action-Click', 'Intern-Designer-Apply-Button-Label');"
