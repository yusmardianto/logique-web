						...
						<div class="container">
							<div class="row">
								<div class="col-md-6 text-center">
									<h1><img src="/img/career/accounting.png" style="filter: contrast(0%) brightness(150%);"> Intern Designer</h1>
								</div>
							</div>
						</div>
					</div>
							...
							<div class="row">
								<div class="col-md-offset-1 col-md-10">
									<div class="content-vacancy">
										...
										<ul class="joinus-ul">
											<li>Mendesain tampilan/UI untuk website dan aplikasi mobile maupun untuk produksicetak / printing (misal : brosur, flyer, name card).</li>
											...
											<li>Berkolaborasi dengan department yang lain terkait dengan pekerjaan design</li>
										</ul>
										<br>
										...
										<ul class="joinus-ul">
											...
											<li>Memiliki kemampuan untuk menggunakan software desain (Photoshop, Illustrator, Sketch, Balsamiq, dll).</li>
