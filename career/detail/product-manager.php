                            ...
                            <div class="col-md-12">
                                ...
                                <ol class="breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">
                                    ...
                                    <li class="active" itemprop="itemListElement" itemscope
                                        itemtype="http://schema.org/ListItem">Product
                                        Manager
                                ...
                                <div class="content-vacancy">
                                    <div class="div-job desc-job">
                                        ...
                                        <ul class="joinus-ul">
                                            ...
                                            <li>Berkomunikasi dengan prospek atau klien untuk keperluan penjualan atau
                                                pengelolaan produk.
                                            </li>
                                            <li>Memberikan saran terhadap peningkatan produk sesuai kebutuhan dan
                                                bekerjasama dengan tim
                                                terkait dalam membantu proses implementasi.</li>
                                            <li>Menyusun laporan terkait penjualan dan peningkatan produk kepada
                                                supervisor atau atasan.</li>
                                        ...
                                        <ul class="joinus-ul">
                                            <li>Memiliki pengalaman sebagai Product Consultant atau setara minimal
                                                selama 3 tahun.</li>
