								...
								<div class="col-md-offset-1 col-md-10">
									<div class="content-vacancy">
										...
										<br>
											<div class="text-center">
											<br>
												<a class="btn btn-yellow smooth" id="apply-intern-sales-it" href="https://logique.sugoisaiyo.com/" onclick="ga('send', 'event', 'Intern-Sales-IT-Apply-Button', 'Action-Click', 'Intern-Sales-IT-Apply-Button-Label');" target="_blank" rel="noreferrer">Apply</a>
											</div>
										</div>
									</div>
								</div>
