...
<head>
    ...
    <meta property="og:title" content="Lowongan - Intern IT Sales Asisstant">
    ...
    <title>Lowongan - IT Sales Asisstant</title>

    <script type="application/ld+json">
    {
        "@context": "http://schema.org",
        "@type": "JobPosting",
        "title": "IT Sales Asisstant",
        "url": "https://www.logique.co.id/career/detail/intern-sales-it.php",
        "hiringOrganization": {
            "@type": "Corporation",
        ...
        "experienceRequirements": "Segala jurusan, diutamakan Bisnis/ Pemasaran.",
        ...
        "qualifications": "Segala jurusan, diutamakan Bisnis/ Pemasaran.",
        "responsibilities": "Merencanakan perkembangan dalam proses penjualan produk.",
                            ...
                            <div class="col-md-12">
                                ...
                                <ol class="breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">
                                    ...
                                    <li class="active" itemprop="itemListElement" itemscope
                                        itemtype="http://schema.org/ListItem">IT Sales Asisstant
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6 text-center">
                                <h1><img src="/img/career/pm.png" style="filter: contrast(0%) brightness(150%);"> IT Sales Asisstant</h1>
                            </div>
                                ...
                                <div class="content-vacancy">
                                    <div class="div-job desc-job">
                                        ...
                                        <ul class="joinus-ul">
                                            ...
                                            <li>Berkomunikasi dengan potensial klien dan klien dengan tujuan
                                                meningkatkan penjualan produk.</li>
                                            <li>Memberikan masukan terhadap perkembangan produk sesuai kebutuhan dan
                                                memberikan bantuan dalam proses penerapan.</li>
                                        ...
                                        <div class="text-center">
                                            <br>
                                            <a class="btn btn-yellow smooth" id="apply-intern-sales-it"
                                                href="https://logique.sugoisaiyo.com/"
                                                onclick="ga('send', 'event', 'Intern-Sales-IT-Apply-Button', 'Action-Click', 'Intern-Sales-IT-Apply-Button-Label');"
