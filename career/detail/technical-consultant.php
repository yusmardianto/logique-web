...
<html lang="id">
  <head>
	...
	<meta property="og:description" content="Dicari Technical Consultant yang mampu menganalisa dan merekomendasikan solusi sistem web dan website terbaik untuk memecahkan masalah dalam proses bisnis. Seorang Technical Consultant harus memiliki pengetahuan yang luas baik dari sisi bisnis maupun teknikal.">
							...
							<div class="row">
								<div class="col-md-12">
									...
									<ol class="breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">
										...
										<li class="active" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem" >Technical Consultant<meta itemprop="position" content="2" /></li>
									</ol>
								</div>
							</div>
						</div>
						...
						<div class="container">
							<div class="row">
								<div class="col-md-6 text-center">
									<h1><img src="/img/career/tc.png" style="filter: contrast(0%) brightness(150%);"> Technical Consultant</h1>
								</div>
								<!-- <div class="col-md-6 text-center">
								...
								<div class="col-md-offset-1 col-md-10">
									<div class="content-vacancy">
										...
										<li>Jakarta</li>
											...
											<div class="text-center">
											<br>
												<a class="btn btn-yellow smooth" id="apply-tc" href="https://logique.sugoisaiyo.com/" onclick="ga('send', 'event', 'TC-Apply-Button', 'Action-Click', 'TC-Apply-Button-Label');" target="_blank" rel="noreferrer">Apply</a>
											</div>
										</div>
									</div>
								</div>
