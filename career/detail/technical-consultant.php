...
<head>
    ...
    <meta name="description" itemprop="description"
        content="Dicari Technical Consultant yang mampu memberi saran strategis seputar teknologi, mendesain sistem dan IT network, merevisi sistem dan membantu masalah teknis. Must skill: sarjana, pengalaman IT consultant, sistem operasi dan database. Salary negotiable.">
    <meta name="keywords"
        content="lowongan, kerja, jakarta, remote job jakarta, kerja remote jakarta,  networking, Technical Consultant, indonesia, web development, digital marketing, software consultation, salary, negotiable, sistem IT, komputer, IT, sistem operasi, database, analisa, skill, pengalaman, sarjana">
    ...
    <meta property="og:description"
        content="Dicari Technical Consultant yang mampu menganalisa dan merekomendasikan solusi sistem web dan website terbaik untuk memecahkan masalah dalam proses bisnis. Seorang Technical Consultant harus memiliki pengetahuan yang luas baik dari sisi bisnis maupun teknikal.">
    <link rel="shortcut icon" type="image/x-icon" href="/favicon.ico">
    <title>Lowongan - Technical Consultant</title>
    ...
    <script type="application/ld+json">
    {
        ...
        "url": "https://www.logique.co.id/career/detail/technical-consultant.php",
        "hiringOrganization": {
            "@type": "Corporation",
                            ...
                            <div class="col-md-12">
                                ...
                                <ol class="breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">
                                    ...
                                    <li class="active" itemprop="itemListElement" itemscope
                                        itemtype="http://schema.org/ListItem">Technical Consultant
                                ...
                                <div class="content-vacancy">
                                    <div class="div-job desc-job">
                                        ...
                                        <ul class="joinus-ul">
                                            ...
                                            <li>Mendesain sistem dan IT network, serta memastikan arsitektur dan
                                                fungsionalitas yang tepat.</li>
                                            <li>Mendukung implementasi teknologi baru.</li>
                                            <li>Melatih user dalam sistem IT baru dan yang sudah ada.</li>
                                        ...
                                        <ul class="joinus-ul">
                                            ...
                                            <li>Berpendidikan minimal S1 di bidang Ilmu Komputer, IT atau bidang yang
                                                relevan.</li>
                                            <li>Memiliki kemampuan untuk memecahkan masalah pada hardware, software, dan
                                                network.</li>
                                        ...
                                        <div class="text-center">
                                            <br>
                                            <a class="btn btn-yellow smooth" id="apply-tc"
                                                href="https://logique.sugoisaiyo.com/"
                                                onclick="ga('send', 'event', 'TC-Apply-Button', 'Action-Click', 'TC-Apply-Button-Label');"
