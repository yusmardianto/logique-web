...
<head>
    ...
    <meta name="description" itemprop="description"
        content="Dicari developer React JS yang berpengalaman menggunakan workflow seperti Redux/Flux, development tool seperti Babel, Webpack, NPM/Yarn, GIT, EcmaScript, dan integrasi RESTful API.  Berpengalaman isomorphic react, HTML, CSS, ExpressJS, mongoDB lebih disukai. Salary negotiable.">
    <meta name="keywords"
    ...
    <script type="application/ld+json">
    {
        ...
        "url": "https://www.logique.co.id/career/detail/reactjs.php",
        "hiringOrganization": {
            "@type": "Corporation",
        ...
        "description": "Dicari developer React JS yang berpengalaman menggunakan workflow seperti Redux/Flux, development tool seperti Babel, Webpack, NPM/Yarn, EcmaScript, dan integrasi RESTful API. Diharapkan dapat menganalisa, memperbaiki performance, dan kolaborasi tim. Berpengalaman ExpressJS, mongoDB lebih disukai.<br><br>Job Description:<ul><li>Mengembangkan dan mengkonversi kode HTML ke React.js.</li><li>Mengintegrasikan React.js dengan API.</li><li>Sewaktu-waktu dapat melakukan coding HTML-CSS (responsive design and cross browser).</li><li>Bekerja sama dan berkolaborasi dengan tim backend-developer dan designer dalam menghasilkan team-results yang optimal.</li><li>Melakukan perbaikan performance dengan optimasi code pada sisi aplikasi.</li><li>Melakukan analisa dan riset dalam menerapkan teknologi relevan yang update sesuai kebutuhan client/customer.</li></ul><br><br>Must Skill/Experience<ul><li>Pengalaman dalam bidang software development minimal 2 tahun.</li><li>Berpendidikan minimal S1 di bidang Ilmu Komputer, IT atau bidang yang relevan.</li><li>Berpengalaman menggunakan React.js setahun terakhir.</li><li>Terbiasa menggunakan EcmaScript dengan versi terbaru.</li><li>Terbiasa melakukan integrasi RESTful API.</li><li>Berpengalaman menggunakan Front End Development Tools seperti Babel, Webpack, NPM / Yarn atau sejenisnya.</li><li>Familiar dengan version control system (VCS) seperti Git.</li></ul>",
        ...
        "qualifications": "Berpengalaman menggunakan React.js workflow seperti Redux / Flux",
        "responsibilities": "Mengembangkan dan mengkonversi kode HTML ke React.js.",
        "skills": "Berpengalaman menggunakan React.js setahun terakhir",
                            ...
                            <div class="col-md-12">
                                ...
                                <ol class="breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">
                                    ...
                                    <li class="active" itemprop="itemListElement" itemscope
                                        itemtype="http://schema.org/ListItem">React JS Developer
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6 text-center">
                                <h1><img src="/img/career/fe.png" style="filter: contrast(0%) brightness(150%);"> React
                                    JS Developer</h1>
                            </div>
                            <!-- <div class="col-md-6 text-center">
                                ...
                                <div class="content-vacancy">
                                    <div class="div-job desc-job">
                                        ...
                                        <ul class="joinus-ul">
                                            ...
                                            <li>Sewaktu-waktu dapat melakukan coding HTML-CSS (responsive design and
                                                cross browser).</li>
                                            <li>Bekerja sama dan berkolaborasi dengan tim backend-developer dan designer
                                                dalam menghasilkan team-results yang optimal.</li>
                                            <li>Melakukan perbaikan performance dengan optimasi code pada sisi aplikasi.
                                            </li>
                                            <li>Melakukan analisa dan riset dalam menerapkan teknologi relevan yang
                                                update sesuai kebutuhan client/customer</li>
                                        </ul>
                                        <br>
                                        <b class="getN">Must Skill/Experience </b><br>
                                        <ul class="joinus-ul">
                                            <li>Pengalaman dalam bidang software development minimal 2 tahun.</li>
                                            <li>Berpendidikan minimal S1 di bidang Ilmu Komputer, IT atau bidang yang
                                                relevan.</li>
                                            ...
                                            <li>Berpengalaman menggunakan Front End Development Tools seperti Babel,
                                                Webpack, NPM / Yarn atau sejenisnya</li>
                                        ...
                                        <ul class="joinus-ul">
                                            ...
                                            <li>Pengalaman menggunakan CSS framework seperti bootstrap dan foundation
                                            </li>
                                        ...
                                        <div class="text-center">
                                            <br>
                                            <a class="btn btn-yellow smooth" id="apply-react"
                                                href="https://logique.sugoisaiyo.com/"
                                                onclick="ga('send', 'event', 'React-JS-Apply-Button', 'Action-Click', 'React-JS-Apply-Button-Label');"
