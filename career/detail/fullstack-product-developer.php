                            ...
                            <div class="col-md-12">
                                ...
                                <ol class="breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">
                                    ...
                                    <li class="active" itemprop="itemListElement" itemscope
                                        itemtype="http://schema.org/ListItem">Full Stack Product Developer
                        ...
                        <div class="row">
                            <div class="col-md-6 text-center">
                                <h1><img src="/img/career/consultant.png"
                                        style="filter: contrast(0%) brightness(150%);"> Full Stack Product Developer
                                </h1>
                            </div>
                            ...
                            <div class="col-md-offset-1 col-md-10">
                                <div class="content-vacancy">
                                    ...
                                    <div class="div-job desc-job">
                                        <div class="text-center">
                                            <br>
                                            <a class="btn btn-yellow smooth" id="apply-full-stack"
