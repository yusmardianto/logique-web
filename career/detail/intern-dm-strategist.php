							...
							<div class="row">
								<div class="col-md-12">
									...
									<ol class="breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">
										...
										<li class="active" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem" >Intern Digital Marketing Strategist<meta itemprop="position" content="2" /></li>
									</ol>
								</div>
							</div>
						</div>
						...
						<div class="container">
							<div class="row">
								<div class="col-md-6 text-center">
									<h1><img src="/img/career/pm.png" style="filter: contrast(0%) brightness(150%);"> Intern Digital Marketing Strategist</h1>
								</div>
							...
							<div class="row">
								<div class="col-md-offset-1 col-md-10">
									<div class="content-vacancy">
										...
										<b class="getN">Terbiasa dalam menganalisis dan mengoptimalkan tool yang terkait dengan digital marketing, seperti: </b><br>
										<ul class="joinus-ul">
										...
										<br>
											<div class="text-center">
											<br>
												<a class="btn btn-yellow smooth" id="apply-intern-dm-strategist" href="https://logique.sugoisaiyo.com/" onclick="ga('send', 'event', ' Intern-DM-Strategist-Apply-Button', 'Action-Click', ' Intern-DM-Strategist-Apply-Button-Label');" target="_blank" rel="noreferrer">Apply</a>
											</div>
										</div>
									</div>
								</div>
