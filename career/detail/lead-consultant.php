...
<head>
    ...
    <meta name="keywords"
        content="lowongan, kerja, jakarta, remote job jakarta, kerja remote jakarta, networking, marketing, sales consultant, pre-sales consultant, indonesia, problem solving">
    ...
    <title>Lowongan - Lead Consultant</title>
    ...
    <script type="application/ld+json">
    {
        ...
        "url": "https://www.logique.co.id/career/detail/lead-consultant.php",
        "hiringOrganization": {
            "@type": "Corporation",
        ...
        "experienceRequirements": "Memiliki pengalaman sebagai IT Consultant minimal selama 3 tahun.",
        ...
        "qualifications": "Memiliki pengalaman sebagai IT Consultant minimal selama 3 tahun.",
        "responsibilities": "Terlibat dalam proyek berskala menengah ke atas, mulai dari konsultasi, perencanaan, serta pengelolaan tim untuk memastikan proyek yang dijalankan sesuai dengan rencana.",
        "skills": "Memiliki pengetahuan yang sangat baik dalam bidang pembuatan website, web system, atau aplikasi mobile.",
                            ...
                            <div class="col-md-12">
                                ...
                                <ol class="breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">
                                    ...
                                    <li class="active" itemprop="itemListElement" itemscope
                                        itemtype="http://schema.org/ListItem">Lead Consultant
                        ...
                        <div class="row">
                            <div class="col-md-6 text-center">
                                <h1><img src="/img/career/consultant.png"
                                        style="filter: contrast(0%) brightness(150%);"> Lead Consultant</h1>
                            </div>
                            <div class="col-md-6 text-center">
                        ...
                        <div class="row">
                            <div class="col-md-offset-1 col-md-10">
                                <div class="content-vacancy">
                                    <h3 class="text-center"> Lead Consultant (di Jakarta) dengan minimal 3 tahun
                                        pengalaman</h3>
                                    <hr>
                                    <div class="div-job desc-job">
                                        ...
                                        <ul class="joinus-ul">
                                            ...
                                            <li>Sering terlibat dalam konsultasi dan perencanaan sistem berskala besar.
                                            </li>
                                            <li>Memiliki kemampuan analisa dan pemecahan masalah yang sangat baik.</li>
                                            <li>Memiliki pengetahuan yang sangat baik dalam bidang pembuatan website,
                                                web system, atau aplikasi mobile.</li>
                                        ...
                                        <ul class="joinus-ul">
                                            <li>Terlibat dalam proyek berskala menengah ke atas, mulai dari konsultasi,
                                                perencanaan, serta pengelolaan tim untuk memastikan proyek yang
                                                dijalankan sesuai dengan rencana.</li>
                                            <li>Memberikan inisiatif dan saran strategis mengenai penggunaan teknologi
                                                untuk mencapai tujuan.</li>
                                            <li>Berkolaborasi dengan bagian RnD untuk mendapatkan pengetahuan terhadap
                                                teknologi baru, dan membagikan informasi tersebut kepada tim konsultan
                                                untuk meningkatkan kemampuan konsultasi atau perencanaan.</li>
                                            ...
                                            <li>Melakukan koordinasi dan mengarahkan tim konsultan agar dapat bekerja
                                                dengan efektif.</li>
                                        </ul>
                                        <div class="text-center">
                                            <br>
                                            <a class="btn btn-yellow smooth" id="apply-lead-consultant"
                                                href="https://logique.sugoisaiyo.com/"
                                                onclick="ga('send', 'event', 'Lead-Consultant-Apply-Button', 'Action-Click', 'Lead-Consultant-Apply-Button-Label');"
