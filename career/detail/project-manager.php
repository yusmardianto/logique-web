...
<html lang="id">
  <head>
    ...
    <meta name="description" itemprop="description" content="Dicari Project Manager yang berpengalaman di bidang Web dan development system minimal 2 tahun, terampil dalam management dan komunikasi antar tim development dan klien, menangani  keseluruhan proyek mulai dari perencanaan, proposal, hingga pengembangan. Memiliki PMP certification lebih disukai">
	<meta name="keywords" content="lowongan, kerja, jakarta, remote job jakarta, kerja remote jakarta, indonesia, Project Manager, IT project manager, web development manager, project management, planning, proposal, report, cloud server, PMP certification">
	...
	<meta property="og:description" content="Dicari Project Manager yang telah berpengalaman di bidang IT dan Web selama lebih dari 3 tahun, terampil dalam management dan komunikasi antar tim development dan klien, serta menangani proyek secara keseluruhan mulai dari perencanaan, proposal, hingga pengembangan.">
							...
							<div class="row">
								<div class="col-md-12">
									...
									<ol class="breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">
										...
										<li class="active" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem" >Project Manager<meta itemprop="position" content="2" /></li>
									</ol>
								</div>
							</div>
						</div>
						...
						<div class="container">
							<div class="row">
								<div class="col-md-6 text-center">
									<h1><img src="/img/career/pm.png" style="filter: contrast(0%) brightness(150%);"> Project Manager</h1>
								</div>
								...
								<div class="col-md-offset-1 col-md-10">
									<div class="content-vacancy">
										...
										<br>
											<div class="text-center">
											<br>
												<a class="btn btn-yellow smooth" id="apply-pm" href="https://logique.sugoisaiyo.com/" onclick="ga('send', 'event', 'PM-Apply-Button', 'Action-Click', 'PM-Apply-Button-Label');" target="_blank" rel="noreferrer">Apply</a>
											</div>
										</div>
									</div>
								</div>
