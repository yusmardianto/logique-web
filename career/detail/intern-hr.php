...
<head>
    ...
    <script type="application/ld+json">
    {
        ...
        "@type": "JobPosting",
        "title": "Intern HR/GA",
        "url": "https://www.logique.co.id/career/detail/intern-hr.php",
        "hiringOrganization": {
            "@type": "Corporation",
        ...
        "experienceRequirements": "Memiliki kemampuan interpersonal yang baik.",
        ...
        "qualifications": "Memiliki kemampuan interpersonal yang baik.",
        "responsibilities": "Melakukan kegiatan administrasi terkait dengan HR dan GA",
        "skills": "Memiliki kemampuan interpersonal yang baik.",
                            ...
                            <div class="col-md-12">
                                ...
                                <ol class="breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">
                                    ...
                                    <li class="active" itemprop="itemListElement" itemscope
                                        itemtype="http://schema.org/ListItem">Intern HR/GA
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6 text-center">
                                <h1><img src="/img/career/pm.png" style="filter: contrast(0%) brightness(150%);"> Intern
                                    HR/GA</h1>
                            </div>
                                ...
                                <div class="content-vacancy">
                                    <div class="div-job desc-job">
                                        ...
                                        <ul class="joinus-ul">
                                            ...
                                            <li>Terlibat dalam pengelolaan dan pembaharuan dokumen dalam lingkup HR
                                                (peraturan perusahaan, kontrak karyawan, dan penawaran kerja)</li>
                                        ...
                                        <ul class="joinus-ul">
                                            <li>Memiliki ijazah atau sedang menempuh pendidikan D3/S1 Psikologi,
                                                Manajemen, Administrasi.</li>
                                        ...
                                        <ul class="joinus-ul">
                                            ...
                                            <li>Memiliki jiwa disiplin, kerja keras, dan bekerja sama dengan tim maupun
                                                individu.</li>
                                        ...
                                        <div class="text-center">
                                            <br>
                                            <a class="btn btn-yellow smooth" id="apply-intern-hr"
                                                href="https://logique.sugoisaiyo.com/"
                                                onclick="ga('send', 'event', ' Intern-HR-Apply-Button', 'Action-Click', ' Intern-HR-Apply-Button-Label');"
