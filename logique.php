                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="principle">
                                <div class="principle__content">
                                    <div class="bg--dark">
                                        <p>Menyediakan layanan IT dan Digital Marketing</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="bg--orange col-md-6">
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <p>Optimize Your Website on Every Search Engine</p>
                                </div>
                            </div>
                        </div>
                        <div class="bg--orange col-md-6">
                        ...
                        <div class="bg--orange col-md-6">
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <p>IT Security Vulnerability Assessment Service</p>
                                    <p>Optimize Your Website on Every Search Engine</p>
                                </div>
                            </div>
                        </div>
                        <div class="bg--orange col-md-6">
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <p>IT Professional Staffing Service (by KAZOKKU)</p>
                                    <p>Outsource IT professional Resource</p>
                                </div>
                            </div>
                        </div>
                    </div>
