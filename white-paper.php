    ...
    <div class="wrapper wrapper--update-design wrapper--update-design-font">
        ...
        <div class="whitepaper">
            ...
            <section class="whitepaper__article">
                <div class="content-wrapper__">
                    <div class="container__">
                        <h3 class="mb--40px section-title">Jenis dan Kategori Dokumen</h3>
            ...
            <section class="mb--40px whitepaper__link">
                <div class="content-wrapper__">
                    <div class="container__">
                        <h3 class="mb--40px section-title">Layanan <strong>LOGIQUE</strong> Digital Indonesia</h3>
                        <p><strong>LOGIQUE</strong> siap membantu Anda yang ingin berkonsultasi mengenai pengembangan, pengelolaan, dan pembuatan Website, Aplikasi Web & Mobile (Android | iOS | Hybrid), Web Security, Digital Marketing dan lainnya. Konsultasikan kebutuhan Anda dan dapatkan solusi terbaik bersama <strong>LOGIQUE</strong>.</p>
