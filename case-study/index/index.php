    ...
    <div class="content-wrapper__">
            ...
            <div class="container__">
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <p>Selama lebih dari 7 tahun, <span class="novocentoNormal">Logique</span> telah membantu berbagai klien ternama, dari startup lokal sampai dengan perusahaan internasional untuk mengembangkan Website, Sistem, Web App dan Aplikasi Mobile.</p> 
                </div>
              </div>
            </div>
          </div>
      ...
      <section class="case-study bg--white">
        <div class="container__">
          ...
          <div class="row card-container">
            <div class="col-sm-4 col-xs-12 filter website">
                <a href="../caroline-bidding-system" class="links__item">
                    <div class="img-container">
                      ...
                      <img src="./img/top/right-arrow.svg" class="icon" alt="">
                    </div>
                </a>
            </div>
            <div class="col-sm-4 col-xs-12 filter website">
              <a href="../jba-auction-system" class="links__item">
                    <div class="img-container">
                      <picture>
            ...
            <div class="col-sm-4 col-xs-12 filter website">
              <a href="../opuspark" class="links__item">
                    <div class="img-container">
                      <picture>
            ...
            <div class="col-sm-4 col-xs-12 filter websystem">
                <a href="../zuttoride-customer-management-system" class="links__item">
                    <div class="img-container">
                      <picture>
            ...
            <div class="col-sm-4 col-xs-12 filter webapp">
              <a href="../vip-plaza-progressive-web-app" class="links__item">
                    <div class="img-container">
                      <picture>
                        <source srcset="./img/card/5.webp" type="image/webp">
            ...
            <div class="col-sm-4 col-xs-12 filter webapp">
              <a href="../klikhoreca" class="links__item">
                    <div class="img-container">
                      <picture>
                        <source srcset="./img/card/6.webp" type="image/webp">
            ...
            <div class="col-sm-4 col-xs-12 filter website">
              <a href="../indonesea" class="links__item">
                    <div class="img-container">
                      <picture>
                        <source srcset="./img/card/7.webp" type="image/webp">
            ...
            <div class="col-sm-4 col-xs-12 filter websystem">
              <a href="../pan-pacific" class="links__item">
                    <div class="img-container">
                      <picture>
                        <source srcset="./img/card/8.webp" type="image/webp">
        ...
        <div class="row contact-container">
          <div class="col-md-12">
            <picture>
              <source srcset="./img/bg-content.webp" type="image/webp">
              <img src="./img/bg-content.png" alt="">
            </picture>
            <p class="contact-title">Let’s Learn Together!</p>
            ...
            <div class="col-sm-offset-1 col-sm-10">
                <div class="row">
                    <div class="col-sm-4 hidden-xs">
                        <div itemscope itemtype="https://schema.org/Organization">
                            <div class="footer-title"><span itemprop="name"><span class="novocentoNormal">Logique</span> DIGITAL INDONESIA</span></div>
                    ...
                    <div class="col-sm-4 link-footer-nav">
                        <ul>
                            ...
                            <li><a href="/career/">Join <span class="novocentoNormal">LOGIQUE</span> (Karir)</a></li>
                ...
                <div class="row">
                    <div class="col-sm-12 link-footer">
                        <h3>Tentang Kami</h3>
                        <p>Sebagai tim yang profesional dalam bidang jasa pembuatan website, <span class="novocentoNormal">LOGIQUE</span> menyediakan solusi terbaik
                            yang teroptimasi untuk bisnis Anda. Selain <a href="/layanan/web-dev.php" target="_blank"><b>jasa
                                    pembuatan website</b></a>, <span class="novocentoNormal">LOGIQUE</span> juga menyediakan jasa lainnya seperti jasa konsultasi
...
<section class="tahap-pemesanan-2 text-center hidden-sm hidden-md hidden-lg" style="padding: 2em">&copy; <span
        class="copyrightYear"></span> <span class="novocentoNormal">Logique</span> Digital Indonesia. All Rights Reserved.</section>
...
if ($(".filter-button").removeClass("activated")) {
