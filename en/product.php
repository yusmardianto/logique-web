      ...
      <div id="contentsArea">
        <div id="contents">
          ...
          <div class="form-container dokodemo-part">
            ...
            <div class="row">
              <div class="col-sm-12">
                <a href="/en/product/dokodemo-kerja.php" target="_blank" class="btn btn-contact-us-black custom-btn-contact"> See more about Dokodemo-Kerja </a>
              </div>
            </div>
          </div>
          ...
          <div class="form-container nice-bg-grey  nippo-part">
            ...
            <div class="row">
             <div class="col-sm-12">
               <a href="/en/product/nippo.php" target="_blank" class="btn btn-contact-us-black custom-btn-contact">See more about Nippo</a>
             </div>
           </div>
          </div>
          ...
          <div class="form-container">
            ...
            <div class="row">
              <div class="col-sm-12">
                 <a href="/en/product/sugoi-saiyo.php" target="_blank" class="btn btn-contact-us-black custom-btn-contact">See more about Sugoi Saiyo</a>
              </div>
            </div>
          </div>
