                    ...
                    <div class="col-sm-offset-1 col-sm-11">
                        ...
                        <section id="portfolioNavigation">
                            <div class="page-nav text-center">
                                ...
                                <a class="page-nav__btn" href="#others">Others</a>
                            </div>
                        </section>
                        <!-- END PAGE NAVIGATION -->
                                    ...
                                    <div class="col-md-4 col-xs-6">
                                        <a href="https://timscorp.co.id/en" target="_blank" rel="noreferrer">
                                            <img src="/img/portfolio/timscorp.png" alt="Timscorp"
                                                class="img-responsive center-block">
                                            <p class="text-center">PT. TOYOTA ENTERPRISE INDONESIA MANAGEMENT SERVICE
                                            </p>
                                        </a>
                                        <div class="addition-desc text-left">
                        ...
                        <section id="sysDev">
                            ...
                            <div class="portfolio-sec-system">
                        ...
                        <section id="caseStudy">
                            <div class="portfolio-sec__head">
                                <h3 class="portfolio-sec__title">Case Study</h3>
                                <a href="#portfolioNavigation" class="portfolio-sec__back">
                                    <small>[Back to Top]</small>
                                </a>
                            </div>
                            ...
                            <div class="portfolio-sec-cs">
                                <div class="portfolio-sec-cs__item">
                                    <div class="portfolio-sec-cs__img">
                                        <a href="/en/case-study/jba-auction-system/" target="_blank">
                                            <img src="../img/top/i-jba.png" alt="JBA Auction System">
                                        </a>
                                    </div>
                                    <p class="portfolio-sec__title text-center">JBA Auction System</p>
                                </div>
                                ...
                                <div class="portfolio-sec-cs__item">
                                    ...
                                    <p class="portfolio-sec__title text-center">CAROLINE Bidding System</p>
                                </div>
                                ...
                                <div class="portfolio-sec-cs__item">
                                    ...
                                    <p class="portfolio-sec__title text-center">OPUS PARK</p>
                                </div>
                                ...
                                <div class="portfolio-sec-cs__item">
                                    ...
                                    <p class="portfolio-sec__title text-center">VIP PLAZA</p>
                                </div>
                                ...
                                <div class="portfolio-sec-cs__item">
                                    ...
                                    <p class="portfolio-sec__title text-center">Zutto Ride Indonesia</p>
                                </div>
                        ...
                        <hr>
                        <!-- END MOBILE PWA SECTION -->

                        <!-- OTHERS SECTION -->
                        <section id="others">
                            <div class="portfolio-sec__head">
                                <h3 class="portfolio-sec__title">Others</h3>
                                <a href="#portfolioNavigation" class="portfolio-sec__back">
                                    <small>[Back to Top]</small>
                                </a>
                            </div>
                                    ...
                                    <div class="other-client-item">
                                        <div class="img-thumb">
                                            <img src="/img/portfolio/video-mysunlife.jpg"
                                                alt="2D Video Production(SunLife)" class="img-responsive center-block">
                                        </div>
                                    ...
                                    <div class="other-client-item">
                                        <div class="img-thumb">
                                            <img src="/img/portfolio/video-otomart.jpg"
                                                alt="2D Video Production (OTOmart)" class="img-responsive center-block">
                                        </div>
                                    ...
                                    <div class="other-client-item">
                                        <div class="img-thumb">
                                            <img src="/img/portfolio/insta-vid.png"
                                                alt="Instagram Video Submission Contest"
                                    ...
                                    <div class="other-client-item">
                                        <div class="img-thumb">
                                            <img src="/img/portfolio/bumbu-warasa-1.jpg"
                                                alt="Product Design (Ikeda Toka)" class="img-responsive center-block">
                                        </div>
                                    ...
                                    <div class="other-client-item">
                                        <div class="img-thumb">
                                            <img src="/img/portfolio/60jpid_catalog.png"
                                                alt="60th JPID Anniversary catalog" class="img-responsive center-block"
                                                style="height: 224px">
                                        </div>
                        ...
                        <div class="text-center our-portfolio">
                            <p class="title__description" style="margin-bottom: 15px; margin-top: 25px;">Contact us and we will present to
