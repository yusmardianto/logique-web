...
<html lang="en">
  <head>
    ...
    <meta name="description" itemprop="description" content="LOGIQUE Digital Indonesia has numerous experiences in website creation / system development, designing printing materials in Indonesia.">
			...
			<div id="contentsArea">
				<div id="contents">
					...
					<div class="form-container our-portfolio">
						...
						<br/><br/>
						<div class="">See Case Study:</div><br/>
						<div class="row text-center studi-kasus">
							<div class="col-sm-4">
								<a target="_blank" href="/en/case-study/jba-auction-system/" class="btn">
									JBA Auction System
								</a>
							</div>
							<div class="col-sm-4">
								<a target="_blank" href="/en/case-study/caroline-bidding-system/" class="btn">
									Caroline Bidding System
								</a>
							</div>
							<div class="col-sm-4">
								<a target="_blank" href="/en/case-study/opuspark/" class="btn">
									Opus Park
								</a>
							</div>
							<div class="clearfix"></div>
							<div class="col-sm-4">
								<a target="_blank" href="/en/case-study/vip-plaza-progressive-web-app/" class="btn">
									VIP Plaza
								</a>
							</div>
							<div class="col-sm-4">
								<a target="_blank" href="/en/case-study/zuttoride-customer-management-system/" class="btn">
									ZuttoRide
								</a>
							</div>
						</div>
