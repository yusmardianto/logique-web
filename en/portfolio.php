		...
		<div class="wrapper">
                ...
                <div class="row text-center">
                  ...
                  <div class="col-sm-4">
    								...
    								<div class="addition-desc text-left">
    									...
    									<div class="grey-clr">Multi-language, Mobile, Corporate WEB, AWS, Real Estate</div>
    								</div>
    							</div>
    							<div class="col-sm-4">
                  ...
                  <div class="col-sm-4">
    								...
    								<div class="addition-desc text-left">
    									...
    									<div class="grey-clr">CMS, Market Place, DB, Mobile, secure WEB, WEB service</div>
    								</div>
    							</div>
    							<div class="clearfix"></div>
                  <div class="col-sm-4">
    							...
    							<div class="col-sm-4">
    								...
    								<div class="addition-desc text-left">
    									...
    									<div class="grey-clr">Multi-language, Mobile, Campaign page, CMS, Financial, Bank</div>
    								</div>
    							</div>
    							<div class="col-sm-4">
                  ...
                  <div class="col-sm-4">
    								<a href="https://4dentist.jp/" target="_blank" rel="noreferrer">
    									<img src="/img/portfolio/4dentist.png" alt="4Dentist.jp" class="img-responsive center-block">
    							...
    							<div class="col-sm-4">
    								...
    								<div class="addition-desc text-left">
    									...
    									<div class="grey-clr">Multi-language, Mobile, Consulting, Accounting &amp; Tax</div>
    								</div>
    							</div>
    							<div class="col-sm-4">
							  ...
							  <!--<div class="col-sm-4">
								...
								<div class="col-sm-4">
									...
									<div class="addition-desc text-left">
										...
										<div class="grey-clr">Customized CMS, Mobile Optimized, Corporate Web, Real Estate Info Web</div>
									</div>
								</div>
								<div class="col-sm-4">
								...
								<div class="col-sm-4">
									...
									<div class="addition-desc text-left">
										...
										<div class="grey-clr">Customized CMS, Mobile Optimized, Corporate Web, Medical Service Web </div>
									</div>
								</div>
							</div>
						  </div>
            ...
            <div class="system-development-client-container  page-part-container">
              ...
              <div class="row text-center">
                ...
                <div class="col-sm-4">
                  <div class="mobile-app-container">
										<div class="m-app-item"><img src="/img/portfolio/apps-oto-1.jpg" alt="Otomart - Used Car on Sale Finder App" class="img-responsive center-block"></div>
										<div class="m-app-item"><img src="/img/portfolio/apps-oto-2.jpg" alt="Otomart - Used Car on Sale Finder App" class="img-responsive center-block"></div>
									</div>
              ...
              <div class="row text-center">
                ...
                <div class="col-sm-4">
                  ...
                  <div class="addition-desc text-center">
							...
							<div class="clearfix"></div>
							<div class="col-sm-4">
								<img src="/img/portfolio/60jpid-DM.png" alt="60th Anniversary of Diplomatic Relations between Japan and Indonesia" class="img-responsive center-block">
							...
							<div class="col-sm-4">
								<div class="mobile-app-container">
									<div class="m-app-item"><img src="/img/portfolio/japan-embassy-DM-ins.png" alt="Embassy of Japan in Indonesia" class="img-responsive center-block"></div>
									<div class="m-app-item"><img src="/img/portfolio/japan-embassy-DM.png" alt="Embassy of Japan in Indonesia" class="img-responsive center-block"></div>
								</div>
            ...
            <div class="other-portfolio-container  page-part-container">
              ...
              <div class="slider-other-client-container">
                <div class="other-client-item">
                  <div class="img-thumb">
                    <img src="/img/portfolio/video-mysunlife.jpg" alt="2D Video Production(SunLife)" class="img-responsive center-block">
                  </div>
                  2D Video Production(SunLife)
                </div>
                <div class="other-client-item">
                  <div class="img-thumb">
                    <img src="/img/portfolio/video-mysunlife2.jpg" alt="2D Video Production(SunLife)" class="img-responsive center-block">
                  </div>
                  2D Video Production(SunLife)
                </div>
                <div class="other-client-item">
                  <div class="img-thumb">
                    <img src="/img/portfolio/video-otomart.jpg" alt="2D Video Production (OTOmart)" class="img-responsive center-block">
                  </div>
                  2D Video Production (OTOmart)
                </div>
                <div class="other-client-item">
                  <div class="img-thumb">
                    <img src="/img/portfolio/video-otomart2.jpg" alt="2D Video Production (OTOmart)" class="img-responsive center-block">
                  </div>
                  2D Video Production (OTOmart)
                </div>
                <div class="other-client-item">
                ...
                <div class="other-client-item">
                  <div class="img-thumb">
                    <img src="/img/portfolio/onitsuka-mockup.jpg" alt="Printing" class="img-responsive center-block">
                  </div>
                  Printing
                </div>
                <div class="other-client-item">
                  <div class="img-thumb">
                    <img src="/img/portfolio/maison-news.png" alt="Content Creation" class="img-responsive center-block">
                  </div>
                  Content Creation
                </div>
                <div class="other-client-item">
                  <div class="img-thumb">
                    <img src="/img/portfolio/insta-vid.png" alt="Instagram Video Submission Contest" class="img-responsive center-block insta-vid">
                  </div>
                  Instagram Video Submission Contest
                </div>
                <div class="other-client-item">
                  <div class="img-thumb">
                    <img src="/img/portfolio/frangipani-photoshot.png" alt="Frangipani Photo Shooting" class="img-responsive center-block insta-vid">
                  </div>
                  Frangipani Photo Shooting
                </div>
                <div class="other-client-item">
                  <div class="img-thumb">
                    <img src="/img/portfolio/drone1.png" alt="Drone Foto / Video (Partner)" class="img-responsive center-block">
                  </div>
                  Drone Foto / Video (Partner)
                </div>
                <div class="other-client-item">
                  <div class="img-thumb">
                    <img src="/img/portfolio/drone2.png" alt="Drone Foto / Video (Partner)" class="img-responsive center-block">
                  </div>
                  Drone Foto / Video (Partner)
                </div>
                <div class="other-client-item">
                  <div class="img-thumb">
                    <img src="/img/portfolio/sunlife-flyer.jpg" alt="Sunlife Flyer" class="img-responsive center-block">
                  </div>
                  Flyer
                </div>
                <div class="other-client-item">
                  <div class="img-thumb">
                    <img src="/img/portfolio/sunlife-banner.jpg" alt="Sunlife Roll Up Banner" class="img-responsive center-block">
                  </div>
                  Roll Up Banner
                </div>
                <div class="other-client-item">
                  <div class="img-thumb">
                    <img src="/img/portfolio/sunlife-polo-shirt.jpg" alt="Sunlife Polo Shirt" class="img-responsive center-block">
                  </div>
                  Polo Shirt
                </div>
                <div class="other-client-item">
                ...
                <div class="other-client-item">
                  <div class="img-thumb">
                    <img src="/img/portfolio/bumbu-warasa-1.jpg" alt="Product Design (Ikeda Toka)" class="img-responsive center-block">
                  </div>
                  Product Design (Ikeda Toka)
                </div>
                <div class="other-client-item">
                  <div class="img-thumb">
                    <img src="/img/portfolio/minum-warasa-1.jpg" alt="Product Design (Ikeda Toka)" class="same-height img-responsive center-block">
                  </div>
                  Product Design (Ikeda Toka)
                </div>
                <div class="other-client-item">
                ...
                <div class="other-client-item">
                  <div class="img-thumb">
                    <img src="/img/portfolio/caroline-1.jpg" alt="Caroline Flyer" class="img-responsive center-block" style="height: 224px">
                  </div>
                  Caroline Flyer
                </div>
                <div class="other-client-item">
                  <div class="img-thumb">
                    <img src="/img/portfolio/sunlife-book.jpg" alt="SunLife Notebook" class="img-responsive center-block" style="height: 224px">
                  </div>
                  SunLife Notebook
                </div>
                <div class="other-client-item">
                  <div class="img-thumb">
                    <img src="/img/portfolio/sunlife-book2.jpg" alt="SunLife Notebook" class="img-responsive center-block" style="height: 224px">
                  </div>
                  SunLife Notebook
                </div>
                <div class="other-client-item">
                  <div class="img-thumb">
                    <img src="/img/portfolio/60jpid_catalog.png" alt="60th JPID Anniversary catalog" class="img-responsive center-block" style="height: 224px">
                  </div>
              ...
              <div class=" text-center">
								<a href="contact.php" class="btn btn-contact-us-black">
									<span style="font-size: 18px;">Would you like to know more details about our portfolio?</span></a>
							</div>
            </div>
					</div>
				</div>
