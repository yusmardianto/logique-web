        ...
        <div class="row">
          <div class="col-md-6">
            <div class="text-center">
              <a class="btn-banner-pattern mb--60" style="max-width: 350px;" href="/en/portfolio.php">
          ...
          <div class="col-md-6">
            <div class="text-center">
              <a class="btn-banner-pattern mb--60" style="max-width: 350px;" href="/en/contact.php"
