...
<head>
    ...
    <meta name="description" itemprop="description"
        content="LOGIQUE is a mobile application development company for various operating systems from Android, iOS, to Hybrid. ">
    ...
    <meta property="og:title" content="Portfolio | Mobile App Development Works | LOGIQUE Digital Indonesia">
    ...
    <title>Portfolio | Mobile App Development Works | LOGIQUE Digital Indonesia</title>

    <link rel="canonical" href="https://www.logique.co.id/en/portfolio/mobile-app.php" />
...
<body style="overflow-x: hidden">
    <div class="wrapper wrapper--update-design wrapper--update-design-font">
        ...
        <?php 
            ...
            $jp_link = '/jp/portfolio/mobile-app.php';
                ...
                <div class="container__ banner-detail__content">
                    <div class="row">
                        <div class="col-md-offset-1 col-md-7">
                            ...
                            <p class="title__description" style="margin-left: 0;"><strong>LOGIQUE</strong> is a mobile application development company for various operating systems from Android, iOS, to Hybrid. With PWA (Progressive Web Technology) solutions and <strong>LOGIQUE</strong> have succeeded in proving real work results and providing satisfying services for many clients with national to international business scales.</p>
