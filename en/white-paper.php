...
<head>
  ...
  ga('send', 'pageview');
    ...
    <link rel="stylesheet" href="/css/style-whitepaper.css">

    <?php if ($_SERVER['HTTP_HOST'] === 'www.logique.co.id') { ?>
    <!-- Google Tag Manager -->
    <script>(function(w, d, s, l, i){ w[l]=w[l] || []; w[l].push({ 'gtm.start':new Date().getTime(), event:'gtm.js'}); var f=d.getElementsByTagName(s)[0], j=d.createElement(s), dl=l !='dataLayer' ? '&l=' + l :''; j.async=true; j.src='https://www.googletagmanager.com/gtm.js?id=' + i + dl; f.parentNode.insertBefore(j, f);})(window, document, 'script', 'dataLayer', 'GTM-KQJRS4V'); </script>
...
<body>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KQJRS4V" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
    ...
    <div class="wrapper wrapper--update-design wrapper--update-design-font">
        ...
        <div class="whitepaper">
                    ...
                    <div class="container__">
                        <ol class="breadcrumb breadcrumb--update-design" itemscope itemtype="http://schema.org/BreadcrumbList">
                            ...
                            <li class="active" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a
                                    itemprop="item"><span itemprop="name">&nbsp; White Paper Download</span></a>
                    ...
                    <div class="py--40px container__">
                        <div class="row flex__row">
                            <div class="col-xs-12 col-md-8">
                                <h1 class="title-index fs--28px">White Paper on Website Development & Web Security Systems</h1>
                                <p class="my--20px"><strong>LOGIQUE</strong> Digital Indonesia is an IT consulting company providing website creation & development services, web applications, web security systems (Web Security Service), and other digital services, always provides the best for all clients and users.</p> 
                                <p>We provide a comprehensive range of information and guidance on how to create & develop effective business websites and applications regarding e-commerce as well as others. We also provide assistance in protecting against potential security attacks, as well as providing key documents related to IT in general in the format of a White Paper document that can be downloaded for free.</p>
                            </div>
            ...
            <section class="whitepaper__contact">
                <div class="content-wrapper__">
                    <div class="container__">
                        <div class="py--20px px--30px contact">
                            <div class="row flex__row">
                                <div class="col-xs-12 col-md-8">
                                    <div class="contact__content">
                                        ...
                                        <p>A Consultancy Working for Your Needs <br class="hidden-xs"><b class="text-uppercase">GET THE BEST SOLUTION WITH LOGIQUE</b></p>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-md-3">
                                    <a href="/hubungi-kami.php" class="form-control btn btn--yellow contact__btn"><b>Contact Us</b></a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section class="whitepaper__article">
                <div class="content-wrapper__">
                    <div class="container__">
                        <h3 class="mb--40px section-title">Document Categories</h3>

                        <div class="article">
                            <div class="mb--40px article__item">
                                <div class="row flex__row">
            ...
            <section class="mb--40px whitepaper__link">
                <div class="content-wrapper__">
                    <div class="container__">
                        <h3 class="mb--40px section-title">Services provided by <strong>LOGIQUE</strong> Digital Indonesia</h3>
                        <p>
                            <strong>LOGIQUE</strong>  is ready to assist those of you who seek advice and services regarding the professional development, management, and creation of Websites, Web & Mobile Applications (Android | iOS | Hybrid), Web Security Systems, Digital Marketing Strategies and much more. <strong>LOGIQUE</strong> aims to cater to your specific needs and provide you with only the best solutions.
                            
                        </p>
                        <?php include($_SERVER['DOCUMENT_ROOT'].'/layanan/assets/components/dm-links-en.php') ?>
                    </div>
                </div>
            </section>
