  ...
  <div class="wrapper wrapper--update-design wrapper--update-design-font o-wrapper top-only ">
    ...
    <div class="cs-wrap">
        ...
        <div class="row">
          <div class="col-md-offset-1 col-md-10">
            <div class="mt-sm-30px cs-section__quote">
              ...
              <p class="text-center">Logique Digital Indonesia has succeeded in developing an efficient Auction Vehicle Handover application for JBA Bidwin Auction. The eBASTK application comes with a range of useful features, such as effectively handling and recording data during the handover process between sellers, brokers and dealers. In this regard, its functionality is highly useful, as important data which is sent to the JBA auctioning site will be highly accurate.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section class='cs-section client-info'>
        ...
        <p class="mb-30px">A universal problem experienced within the auction industry is the issue of valid data recording during the process of sending the vehicles to the auction location. This is because when goods are delivered, the items must be transferred through certain phases, each of which can be difficult to monitor, especially in regards to noting down the changes incurred by each of the vehicles as they pass through. Parts ending up lost are a common occurrence in this line of work, and making note of such events is difficult when it is done manually by pen and paper.</p>
        <p>The solution was fairly straightforward, through far from simple. JBA Indonesia, in collaboration with LOGIQUE, sought to digitize the process by developing an efficient recording and tracking application also capable of visualizing the circumstance taking place within each phase of the delivery process. This way, data about a vehicle’s overall condition is able to be taken into account systematically and in real time by each party involved.</p>
      </section>

      <section class='cs-section client-info'>
        <div class="row">
          <div class="col-md-7 text-container">
            <h2 class="section-title">eBASTK JBA application</h2>
            <p class="mb-30px">In partnering with LOGIQUE, JBA Indonesia was able to develop an application that systematically tracks and records vehicle conditions during the handover process. The eBASTK application does this in a thorough and user friendly manner, taking only 5 – 10 minutes to access the data in real time with a high degree of accuracy.</p>
            <p class="mb-30px">Also, the application take into account that most of these transactions are conducted in multiple locations, in areas such as vehicle pool locations, parking lots, reception areas, etc. Therefore, the eBASTK application functions to a high degree particularly as a mobile app.</p>
          </div>
          <div class="col-md-5">
            <div>
              <picture>
      ...
      <section class="cs-section">
        <div class="mb-50px">
          <h2 class="section-title">Development & Technology Process</h2>
          <p>Development started with the planning and budgeting phases. After which, the business process was then analyzed. Then, various other processes, such as design, testing and maintenance were conducted.</p>
        </div>
        ...
        <div class="row">
          <div class="col-sm-6">
            ...
            <h3 class="section-title section-title--sub">Agile Development Methods</h3>
            <p class="mb-sm-30px">In developing the eBASTK application, the Agile development methods was used. Through this approach, iterative project management and software development methods (known as Sprint) are used through small and incremental stages whereby results are constantly evaluated and improved upon, allowing the developer to respond to changes quickly and efficiently.</p>
          </div>
          <div class="col-sm-6">
            <picture>
            ...
            <h3 class="section-title section-title--sub">Technology</h3>
            <p class="mb-sm-30px">Regarding the technology used to make the eBASTK system, the PHP platform was the top choice for the open source lineup, although MySQL, MariaDB or PostgreSQL databases are also compatible. Flutter was utilized in offering multi-platform options (Particularly iOS and Android).</p>
          </div>
        </div>
      </section>

      <section class="cs-section">
        <h2 class="section-title">The advantages of eBASTK</h2>
        <p class="mb-30px">The main advantage of this app is its checklist feature, which records the specific vehicle conditions during each phase of the mobilization process. Additionally, the notification feature lets the user know whenever there actually is an alteration in the status or condition of the vehicle throughout the transition process.</p>
