...
">  
  ...
  <meta property="og:title"
    content="Case Study | JBA, Caroline & Lainnya.">
  ...
  <title>Case Study | JBA, Caroline & Lainnya.</title>
              ...
              <div class="col-xs-12 col-md-8">
                <div class="d-flex align-items-center banner-whitepaper__content">
                  ...
                  <div class="content__text">
                    <b class="text-uppercase">GET WHITE PAPER</b>
                    <p>Please download and read the following white paper referencing Website Development & Security Systems.</p>
                  </div>
                </div>
              </div>
      ...
      <section class="case-study bg--white">
        <div class="container__">
          <div class="pill-container">
            <button class="btn btn--yellow filter-button activated" data-filter="all">All case studies</button>
            <button class="btn btn--yellow filter-button" data-filter="website">Web Creation</button>
            <button class="btn btn--yellow filter-button" data-filter="websystem">Web System Development</button>
            <button class="btn btn--yellow filter-button" data-filter="webapp">Web App</button>
            <button class="btn btn--yellow filter-button" data-filter="mobileapp">Mobile App</button>
          </div>
          ...
          <div class="row flex__row card-container">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12 filter website websystem mobileapp">
              <a href="/en/case-study/pentest-infrastruktur-GASI" class="links__item">
                    <div class="img-container" style=" border: solid 1px #f1f1f1; ">
                      <picture>
                        <!-- <source srcset="./assets/img/card/12.webp" type="image/webp"> -->
                        <img src="./assets/img/card/15.jpg" class="img-responsive" alt="PT Gunatronikatama Cipta">
                      </picture>
                    </div>
                    <div class="text-container">
                      <p>Website</p>
            ...
            <div class="row flex__row align-items-center banner-management">
              <div class="col-xs-12 col-md-8">
                <div class="d-flex align-items-center banner-management__content">
                  ...
                  <div class="content__text">
                    <p>Logique is ready to assist you in achieving success through</p>
                    <b class="text-uppercase">PROFESSIONAL PROJECT MANAGEMENT</b>
                  </div>
                </div>
              </div>
              <div class="col-xs-8 col-sm-6 col-md-3">
                <a href="/layanan/project-management.php" class="form-control btn btn--yellow">Read More</a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="p-y-10px p-x-30px">
            <div class="row flex__row align-items-center justify-content-end banner-case-contact">
              <div class="col-xs-12 col-md-8">
                ...
                <p>Please feel free to get in contact with us regarding your company and how to proceed with a project within Indonesia. You will be able to contact us in Japanese as well; our experienced consultants will happily assist you.</p>
              </div>
              <div class="col-xs-8 col-sm-6 col-md-2">
                <a href="/hubungi-kami.php" class="form-control btn btn--yellow">Contact Us</a>
              </div>
            </div>
          </div>
        </div>
