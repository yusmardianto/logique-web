...
<html lang="en">
  <head>
    ...
    <meta name="description" itemprop="description" content="Logique’s development of a heavy equipment inspection system for PT Bukit Makmur Mandiri Utama (BUMA). Check it out here!">
    ...
    <meta property="og:title" content="Heavy Mining Equipment Inspection System | BUMA Digiman | LOGIQUE">
    <meta property="og:type" content="website">
    <meta property="og:site_name" content="Logique">
    <meta property="og:url" content="https://www.logique.co.id/en/case-study/sistem-inspeksi-alat-berat-buma/">
    <meta property="og:image" content="https://www.logique.co.id/img/ogimg/case-study.png">
    <meta property="og:description" content="Logique’s development of a heavy equipment inspection system for PT Bukit Makmur Mandiri Utama (BUMA). Check it out here!">
    <link rel="shortcut icon" type="image/x-icon" href="../../favicon.ico">
    <link rel="canonical" href="https://www.logique.co.id/en/case-study/sistem-inspeksi-alat-berat-buma/">
    <script>
    ...
    <title>Heavy Mining Equipment Inspection System | BUMA Digiman | LOGIQUE</title>
    ...
    ?>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-xs-6 text-right">
              <ul>
                <li class="active"><a href="/en/case-study/sistem-inspeksi-alat-berat-buma/">EN</a></li>
                <li><a href="/case-study/sistem-inspeksi-alat-berat-buma/">ID</a></li>
                <li><a href="/jp/case-study/sistem-inspeksi-alat-berat-buma/">JP</a></li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div class="cs-wrap">
        <section class="cs-top">
          ...
          <h1 class="cs-title">BUMA</h1>
          <h2 class="cs-title-2 hidden-xs">Digital Maintenance<br>Heavy Equipment Inspection System</h2>
        </section>
                ...
                <div class="col-sm-12">
                    <ol class="breadcrumb breadcrumb--update-design" itemscope="" itemtype="http://schema.org/BreadcrumbList">
                        ...
                        <li class="active" itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem">
                            <a itemprop="item"><span itemprop="name">&nbsp; BUMA</span></a>
        ...
        <section class="cs-section">
          ...
          <div class="row">
            ...
            <div class="col-sm-5 col-md-pull-6">
              <p class="cs-subtitle-top">BUMA</p>
              <p class="cs-desc">
        ...
        <section class="cs-section">
          ...
          <div class="row">
            <div class="col-sm-6 col-md-push-6 relative">
              <img src="img/4.png" alt="case study logique" class="cs-img custom2" style="width:100%;">
            </div>
            <div class="col-sm-6 col-md-pull-6">
              <p class="cs-subtitle-top">Management of Heavy Equipment</p>
        ...
        <section class="cs-section">
          ...
          <div class="row">
            ...
            <div class="col-sm-7">
              <p class="cs-subtitle-top">Digital Inspection Systems: A Solution</p>
              <p class="cs-desc">
        ...
        <section class="cs-section result-section" style="margin-bottom: -2px;">
          ...
          <div class="row">
            <div class="col-md-12">
              <br>
              <p class="text-center cs-subtitle-top">BUMA Digital Maintenance (DigiMan) Performance</p>
