 ...
 <head>
     ...
     <meta name="description" content="LOGIQUE is a Jakarta based Web application development company using PHP frameworks through Agile Development to create & maintain your web applications">
     <meta name="keywords" content="System development, Web based systems, Web system, System maintenance">
     ...
     <meta property="og:description" content="LOGIQUE is a Jakarta based Web application development company using PHP frameworks through Agile Development to create & maintain your web applications">
     <link rel="shortcut icon" type="image/x-icon" href="/favicon.ico">
     <link rel="canonical" href="https://www.logique.co.id/en/services/system-dev.php">
     <title>Jakarta’s Best Web App Developer | Web Application Development Company in Indonesia</title>
 ...
 <body class="systedev-page">
         ...
         <div class="container__" style="position:relative">
             <div class="row">
                 <div class="col-md-offset-1 col-md-10 text-center bg-header-txt text-center">
                     <h1 class="m-new">
                         Professional Web Application Developer in Indonesia
                     </h1>
                     <h3 class="  m-new">
                         <span class="logofont">LOGIQUE</span> is the right partner for you; providing the best web-based application development services of an international standard of quality & security. We aim to help you develop a quality web based app with competitive prices.
             ...
             <div class="row">
                 <div class="col-sm-12">
                     <ol class="breadcrumb breadcrumb--update-design" itemscope itemtype="http://schema.org/BreadcrumbList">
                         ...
                         <li class="active" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item"><span itemprop="name">&nbsp;Web
                                     System</span></a>
     ...
     <section class="content-section first-part">
         <div class="container">
             ...
             <div class="sec-content-part whyour-systemdev">
                 <h2 class="sub-section-title text-center">Web Based Application Development with LOGIQUE</h2>
             ...
             <div class="sec-content-part  service-opt">
                 <h2 class="sub-section-title text-center" style="width: 100%; margin: 0 auto; max-width: 770px;">
                     We provide a choice of web-based application development services
                     to best suit your needs </h2>

                 <div class="page-content skema-list" style="margin-top: 50px;">
                         ...
                         <div class="panel panel-default">
                             ...
                             <div id="suggestion" class="panel-collapse collapse">
                                 <div class="panel-body">
                                     <p>The purpose of utilizing and developing web-based systems is to support and improve existing businesses. Sometimes, companies have difficulty understanding problems in their business so they don't find the right solution. With the experience we have, we can help solve it. </p>
                     ...
                     <div class="row rowflex">
                         <div class="col-sm-6">
                             <div class="unsupport1 unsupport-content">
                                 <h3>
                                     <div>Implementation of Software Packages</div>
                                 </h3>
     ...
     <section class="content-section sixth-part">
         <div class="sec-content-part contact-banner">
             <div class="page-content">
                 <ul>
                     <li class="text-left">Contact us now for optimal web based system development!
                     <li>
                     <li>
                         <a href="/en/contact.php" class="btn-yellow">Contact Us <span class="icon"> <img src="assets/img/img-systemdev/newlayout/arrow-right.svg"></span></a>
                     </li>
