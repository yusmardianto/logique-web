					...
					<div style="background: #000; font-weight: bold;">
						...
						<div class="breadcrumb-position">
							<ol class="breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList" style="background:transparent;">
								...
								<li class="active" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem" ><a itemprop="item" ><span itemprop="name">System Development</span></a><meta itemprop="position" content="3" /></li>
							</ol>
						</div>
						<!-- end of breadcrumb -->
					...
					<div class="col-lg-offset-3 col-lg-10 col-md-offset-2 col-md-10 col-sm-offset-2 col-sm-10 col-xs-offset-2 col-xs-10 text-right">
						<div class="new5">
							...
							<h2 class="sect-3-txt mt-2">
								...
								from enterprise system development for automotive, financial & government organizations, to Agile development for startup companies. 
							</h2>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-3 justify-content-center">
						...
						<p class="new4">
							...
							we develop IT systems in a fast and flexible manner, without diminishing its overall quality. We organize our development team based on your required preferences. Lab-type development is also available.
						</p>
					</div>
					<div class="col-md-3 justify-content-center">
						...
						<img class="img img-responsive yellow-stripes" src="assets/img/img-systemdev/yellow-stripes.png" alt="">
						<p class="new4">
							We develop high quality systems. It is recommended to conduct security vulnerability testing prior to delivery. 
					...
					<div class="col-md-3 justify-content-center">
						...
						<p class="new4">
							...
							Financial & Government sectors. With our experience in E-commerce, we understand Indonesia’s digital business.
							As such, we can easily grasp specific requirements you may have, and provide consulting with such matters. 
						</p>
					</div>
					<div class="col-md-3 justify-content-center">
				...
				<div class="row">
					<div class="container">
						<div class="row" style="display: flex; flex-wrap: wrap;">
							<div class="col-md-4">
								<h1 class="new7" style="font-weight: 500!important;">Supporting Your Company through System and App Development upon Request.</h1>
								<br>
