...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Website security assessment service | WEB vulnerability assessment by PT LOGIQUE Digital Indonesia. We check and report on 12 crucial items of the assessment. It is a website vulnerability assessment service that can quickly scan the security level of your website.">
	...
	<meta property="og:description" content="Website security assessment service | WEB vulnerability assessment by PT LOGIQUE Digital Indonesia. We check and report on 12 crucial items of the assessment. It is a website vulnerability assessment service that can quickly scan the security level of your website.">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-7">
					...
					<br/>
					<ul>
						<li>We check and report on 12 crucial items of the assessment. It is a website vulnerability assessment service that can quickly scan the security level of your website.</li>
						<li>The scope of assessment may be limited by the scale of the website security (number of pages, search function, presence/absence, and number of forms) that will be tested.</li>
						<li>We conduct an assessment by using a security assessment tool that enable us to implement a comprehensive testing.</li>
						<li>We also perform a manual test to identify the critical and potential risk by analysing source code.</li>
						<li>We will provide some advises to solve the risks and show you the priorities of those risks to be solved.</li>
					</ul>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-offset-2 col-md-8">
					<div class="title">We are offering a special price for trial of our vulnerability assessment service.</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
					<img alt="10 juta" src="img/10-juta.png" class="img-responsive center-block"/>
				</div>
			</div><br/>
			<div class="row">
				<div class="col-md-offset-1 col-md-10">
