	...
	<body class="mobileapp-page">
		<header>
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<a href="/en"><img alt="logo" class="img-responsive" src="img/logo_logique.png"/></a>
					</div>
				</div>
				<div class="row">
					<div class="col-md-7">
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-4">
						...
						<a href="/en/contact.php" target="_blank"><img alt="Logo" src="img/logo_logique_footer.png" class="img-responsive"/></a>
