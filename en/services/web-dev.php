         ...
         <div class="container__">
             <div class="row">
                 <div id="heading-service-web-dev" class="col-md-offset-1 col-md-11 m-t-2em">
                     <h1 class="text-left">
                         <p>
                             <span class="c-logique">LOGIQUE Web</span> <span class="hidden-xs"> / Website Creation
                                 Service</span>
                         </p>
                         <p>
                     ...
                     <div class="subtitle-header">
                         ...
                         <p class="p-padding-v-15">
                             LOGIQUE was founded by a Japanese entrepreneur and is ranked among the top web development
                             companies
                             in Jakarta, with a variety of achievements.
                         </p>
                     </div>
                 </div>
             </div>
             ...
             <div class="row">
                 <div class="col-md-offset-1 col-md-10">
                     <div class="panel text-center custom-1">
                         <h1><b>If you seek to develop a high quality website, contact LOGIQUE for our professional web design and
                                 development services.</b></h1>
                         <br>
                         <p class="p-b-20">
                     ...
                     <div class="row">
                         <div class="col-md-4">
                             <div class="new-box min-h">
                                 ...
                                 <p>
                                     ...
                                     form, and even with post publication maintenance, in addition to any digital marketing
                                     matters
                                     you may have.
                                 </p>
                             </div>
                         ...
                         <div class="col-md-4">
                             <div class="new-box min-h">
                                 ...
                                 <p>
                                     We utilize reliable security systems of the highest quality through the latest digital
                                     technology
                         ...
                         <div class="col-md-4">
                             <div class="new-box min-h">
                                 ...
                                 <p>
                                     ...
                                     aware of the time constraints you might possibly have. Therefore, our timeframe is flexible
                                     and
     ...
     <section class="section-layout web-service-flow">
         <div class="container">
             ...
             <div class="link-page-price-and-portfolio">
                 <a class="link-yellow-white" href="/en/services/webdev-price-range.php">See the price of Website production and
                     operation</a>
         ...
         <div class="container">
             <div class="row">
                 ...
                 <div class="col-md-3 text-center hidden-xs hidden-sm">
                     <a href="/en/" target="_blank"><img src="assets/img/img-webdev/logo.png" alt="Fitur Perusahaan"
                             class="custom-2"></a>
                 </div>
             </div>
         </div>
                         ...
                         <div class="row">
                             <div class="col-md-offset-2 col-md-10 m-t-10">
                                 <p>
                                     ...
                                     You can immediately place an order and explain to us the initial description of the website
                                     as you want, from website creation, operation, CMS configuration, web system development,
                                     etc.
                                     Contact us via email <a style="color:#333"
                                         href="mailto:info@logique.co.id"><u>info@logique.co.id</u></a> or please fill in the
                                     available Order Form <a style="color:#333" target="_blank"
                                         href="/en/contact.php"><u>here</u></a>. You can also ask us anything regarding the web
                                     development, website design, or even the price.
                 ...
                 <div class="col-md-4">
                     <div class="card2">
                         ...
                         <div class="row">
                             <div class="col-md-offset-2 col-md-10 m-t-10">
                                 <p>
                                     You may have a specific vision and target, whether to increase the profit of your business
                                     through the website, improve your image and branding, IR activities, recruitments, etc.
                                     We would like to hear everything from you. We don’t have to meet up.
                                     If you want, we can reach you through Skype or other communication apps so we can talk
                                     further about your business.
                                     Then, we will give you some suggestions about the website that might suit your interest, also
                                     the most effective approach based on your needs.
                                 </p>
                             </div>
                         </div>
                     </div>
                 ...
                 <div class="col-md-4">
                     <div class="card2">
                         ...
                         <div class="row">
                             <div class="col-md-offset-2 col-md-10 m-t-10">
                                 <p>
                                     After understanding everything, we will propose the website creation and utilization to solve
                                     the problem.
                                     If necessary, we will also conduct research, including about competitors and heuristic task
                                     analysis of the current website.
                                     Even until the submission of the proposal, we are cherishing the sense of speed and keeping
                                     in mind the prompt proposal.
                                     In the proposal, we will also provide optional services, such as photography, videography,
                                     and content creation as necessary.
                                     You can freely consult us if you have something in mind.
                                     The proposal will also include the price service as well as how long the time needed in the
                                     website creation.
                                     It’s all based on our transparency method, the difficulty level, and the number of team
                                     members needed to complete it.
                                 </p>
                             </div>
                         </div>
                     </div>
                 ...
                 <div class="col-md-4">
                     <div class="card2">
                         ...
                         <div class="row">
                             <div class="col-md-offset-2 col-md-10 m-t-10">
                                 <p>
                                     If you’re down to what we offer, the next process is the contract signing and the payment of
                                     50% in advance.
                         ...
                         <div class="row">
                             <div class="col-md-offset-2 col-md-10 m-t-10">
                                 ...
                                 <p>
                                     ...
                                     In addition, we will also show the website framework (wireframe) that we have made for you as
                     ...
                     <div class="card3">
                         ...
                         <div class="row">
                             <div class="col-md-offset-2 col-md-10 m-t-10">
                                 <div class="border-right-custom"></div>
                                 <p>
                                     At this stage, the homepage concept will be created and designed according to the references
                                     you provide.
                                     Our website design team will also provide several alternatives for which you can then approve
                                     or revise.
                                     After your approval, we will then create the rest of the pages based on the main website
                                     design.
                                 </p>
                             </div>
                         </div>
                         ...
                         <div class="row">
                             <div class="col-md-offset-2 col-md-10 m-t-10">
                                 <p>
                                     ...
                                     including the CMS.
                                     This stage also includes implementing SEO that follows the UI/UX design, and eliminating the
                                     security vulnerability of the web.
                                     We will ensure that the entire data architecture and features in the website are running and
                                     functioning properly.
                                     This concept is to ensure that the website is well structured for your targeted audience
                                     experience.
                                 </p>
                             </div>
                         </div>
                 ...
                 <div class="col-md-4">
                     <div class="card2">
                         ...
                         <div class="row">
                             <div class="col-md-offset-2 col-md-10 m-t-10">
                                 <p>
                                     After we create the website, we will perform appropriate tests according to the contents and
                                     website design.
                                     We make sure that there is no HTML syntax error, the website is fully mobile friendly, each
                                     page is loading quickly, and SEO countermeasure is done effectively.
                                     For security needs, we also conduct tests and security checks based on many test scenarios.
                                     Then, we will periodically demonstrate the features to you, where you will be able to
                                     directly provide us feedbacks for each feature.
                                     When the project has entered the finalization stage, you can perform test too as a proof that
                                     all functions have been confirmed and are running well.
                                 </p>
                             </div>
                         </div>
                     </div>
                         ...
                         <div class="row">
                             <div class="col-md-offset-2 col-md-10 m-t-10">
                                 <p>
                                     ...
                                     After publication, we will do index registration on Google and setting up Google Analytics
                                     for further maintenance.
                                     You can also immediately pay off the remaining payments and your website can be used
                                     immediately.
                                 </p>
                             </div>
                         </div>
                         ...
                         <div class="row">
                             <div class="col-md-offset-2 col-md-10 m-t-10">
                                 <p>
                                     ...
                                     LOGIQUE provides variety of management services, starting from observing the system, carrying
                                     out daily operations, even regular content creation, Social Media operation, up to digital
             ...
             <div class="row">
                 <div class="col-md-4">
                     ...
                     <p class="min-h">
                         ...
                         We have extensive experience with mobile related solutions such as PWA and AMP Production, so we can
                         support a wide range.
                         With API development and infrastructure construction such as AWS, we develop highly maintainable apps
                 ...
                 <div class="col-md-4">
                     ...
                     <p class="min-h">
                         To help your company find suitable candidates, we provide structured, dynamic, professional, and
                         well-optimized career website pages.
                         For HR solutions, we also provide activity management system, daily report management system, work
                         situation management, and telework management system for productivity improvement.
                     </p>
                     <div>
                         <a href="/en/services/recruitment-web-dev.php" target="_blank" class="btn btn-logic btn-md">Learn
                             more</a>
                     </div>
                 </div>
                 <div class="col-md-4">
                     ...
                     <p class="min-h">
                         ...
                         We will search for any gaps and potential infiltration, and then take precautions, such as SQL injection,
                         cross-site scripting, session jacking etc.
                     </p>
                     <div>
