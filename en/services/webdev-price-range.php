...
<body class="price-range-page">
  <header class="top-pricerange">
    ...
    <div class="top-header-continer">
      <div class="container">
        <div class="row">
          <div class="col-xs-6 col-sm-6">
            <a href="/en/" target="_blank" class="logo">
    ...
    <div class="breadcrumb-cont">
      <div class="container">
        <ol class="breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">
          ...
          <li   itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem" ><a itemprop="item" href="../services.php" ><span itemprop="name">Services</span></a><meta itemprop="position" content="2" /></li>
           <li class="active" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem" ><a itemprop="item" href="web-dev.php"><span itemprop="name">Website Production</span></a><meta itemprop="position" content="2" /></li>
          <li class="active" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem" >  <span itemprop="name">Web Price Range</span> <meta itemprop="position" content="2" /></li>
        </ol>
      </div>
    </div>
      ...
      <div class="row price-item pt-1">
        ...
        <div class="col-md-6  col-sm-7">
          <div class="price-cont">
            <div class="row ">
              <div class="col-xs-4 col-sm-4">Production Period</div>
              <div class="col-xs-8  col-sm-8">About 2 weeks</div>
            </div>
            <div class="row">
              <div class="col-xs-4  col-sm-4">Number of pages</div>
              <div class="col-xs-8 col-sm-8">1 page or 2 page (2 languages)</div>
            </div>
            <div class="row">
              <div class="col-xs-4  col-sm-4">Production Cost</div>
              <div class="col-xs-8 col-sm-8">20,000,000 IDR 〜</div>
            </div>
            <div class="row">
              <div class="col-xs-4  col-sm-4">Production Content </div>
              <div class="col-xs-8 col-sm-8">
                <ul class="product-content">
                  <li>Planning, configuration</li>
                  <li>Design</li>
                  <li>Coding</li>
                  <li>Responsive Process</li>
                  <li>Deploy or file delivery</li>
                </ul>
              </div>
            </div>
      ...
      <div class="row price-item pt-2">
        ...
        <div class="col-md-6 col-sm-7">
          <div class="price-cont">
            <div class="row">
              <div class="col-xs-4 col-sm-4">Production Period</div>
              <div class="col-xs-8 col-sm-8">About 1 month</div>
            </div>
            <div class="row">
              <div class="col-xs-4 col-sm-4">Number of pages</div>
              <div class="col-xs-8 col-sm-8">Up to about 10 pages</div>
            </div>
            <div class="row">
              <div class="col-xs-4 col-sm-4">Production Cost</div>
              <div class="col-xs-8 col-sm-8">40,000,000 IDR ～</div>
            </div>
            <div class="row">
              <div class="col-xs-4 col-sm-4">Production Content</div>
              <div class="col-xs-8 col-sm-8">
      ...
      <div class="row price-item pt-3">
        ...
        <div class="col-md-6 col-sm-7">
          <div class="price-cont">
            <div class="row">
              <div class="col-xs-4 col-sm-4">Production Period</div>
              <div class="col-xs-8 col-sm-8">About 2 months</div>
            </div>
            <div class="row">
              <div class="col-xs-4 col-sm-4">Number of pages</div>
              <div class="col-xs-8 col-sm-8">30 pages or more</div>
            </div>
            <div class="row">
              <div class="col-xs-4 col-sm-4">Production Cost</div>
              <div class="col-xs-8 col-sm-8">70,000,000 IDR 〜</div>
            </div>
            <div class="row">
              <div class="col-xs-4 col-sm-4">Production Content</div>
              <div class="col-xs-8 col-sm-8">
      ...
      <div class="row price-item pt-4">
        ...
        <div class="col-md-6 col-sm-7">
          <div class="price-cont">
            <div class="row">
              <div class="col-xs-4 col-sm-4">Production Period</div>
              <div class="col-xs-8 col-sm-8">About 2.5 months</div>
            </div>
            <div class="row">
              <div class="col-xs-4 col-sm-4">Number of pages</div>
              <div class="col-xs-8 col-sm-8">30 pages or more</div>
            ...
            <div class="row">
              <div class="col-xs-4 col-sm-4">Production Cost</div>
              <div class="col-xs-8 col-sm-8">100,000,000 IDR ～</div>
            </div>
            <div class="row">
              <div class="col-xs-4 col-sm-4">Production Content</div>
              <div class="col-xs-8 col-sm-8">
  ...
  <section class="section-style estimate-price-container">
    <div class="container">
      <div class="row">
        <div class="col-sm-8">
