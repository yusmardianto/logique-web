                    ...
                    <div class="col-md-7">
                        <div class="row">
                            <div class="col-md-6">
                                <h4>Layanan</h4>
                                <ul>
                                    <li><a target="_blank" href="/en/services/web-dev.php">Website Production Service</a></li>
                                    <li><a target="_blank" href="/en/services/system-dev.php">Web System Development Service</a></li>
                                    <li><a target="_blank" href="/en/services/mobile-app-dev.php">Pengembangan Aplikasi Mobile</a></li>
                                    <li><a target="_blank" href="/en/services/penetration-test.php">Penetration Testing Service</a></li>
                                    <li><a target="_blank" href="/en/services/digital-marketing/seo-service.php">Digital Marketing / SEO</a></li>
                                </ul>
                            </div>
                            <div class="col-md-6">
                                <h4>Produk</h4>
                                <ul>
                                    ...
                                    <li><a target="_blank" href="/en/product/nippo.php">Nippo <br>
                                    <span style="font-size: 12px;">(Daily Report Tool)</span></a></li>
                                    <li><a target="_blank" href="https://www.logique.co.id/en/product/sugoi-saiyo.php">Sugoi Saiyo <br>
                                    <span style="font-size: 12px;">(Employee Recruitment System)</span></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
