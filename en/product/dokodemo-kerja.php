				...
				<div class="container">
				  <div class="navbar-header">
					...
					<a class="navbar-brand" href="#" aria-label="Dokodemo Kerja Logo">
						<img src="img/dokodemo-kerja/dokodemo-logo.png" alt="Dokodemo Kerja Logo" class="img-responsive center-block">
					</a>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-6">
						...
						<video width="100%" height="300" controls poster="/en/product/img/dokodemo-kerja/thumb-dokodemo.png">
