     ...
     <div class="container">
       ...
       <section class="hidden-xs hidden-sm">
         ...
         <div class="col-md-push-3 col-md-8 col-md-pull-1">
           <p class="Nippo-adalah-aplikas"><b>Nippo</b> is a web-based application that assists managers in monitoring
       ...
       <section class="hidden-xs hidden-sm">
         ...
         <div class="col-md-12" style=" padding-top: 7em; ">
           <div class="col-md-6 text-right">
             <div class="col-md-10"><span class="Evaluasi-kinerja-sel">A lack of objective and fair employee evaluation.
                 To conduct this, numerically based assessments are needed.</span></div>
             <div class="col-md-2" style="margin-top:-5px;"><img src="img/nippo/checked.png" alt="Company Problems"
                 width="77px" height="77px"></div>
           </div>
           <div class="col-md-6 text-left">
             <div class="col-md-2" style="margin-top:-5px;"><img src="img/nippo/checked.png" alt="Company Problems"
                 width="77px" height="77px"></div>
             <div class="col-md-10"><span class="Evaluasi-kinerja-sel">Managers are unable to constantly regulate the
                 activities of those in their employ. Therefore, the quantity and quality of their work can remain
         ...
         <div class="col-md-12" style=" padding-top: 2em; ">
           ...
           <div class="col-md-6 text-left">
             <div class="col-md-2" style="margin-top:-5px;"><img src="img/nippo/checked.png" alt="Company Problems"
                 width="77px" height="77px"></div>
             <div class="col-md-10"><span class="Evaluasi-kinerja-sel">Tasks are done in an inefficient manner. Managers
       ...
       <section class="hidden-md hidden-lg">
         ...
         <div class="col-md-12" style=" padding-top: 2em; ">
           <div class="col-md-6">
             ...
             <div class="col-xs-9"><span class="Evaluasi-kinerja-sel">A lack of objective and fair employee evaluation.
                 To conduct this, numerically based assessments are needed.</span></div>
           </div>
           <div class="col-md-6">
             <div class="col-xs-3 text-center"><img src="img/nippo/checked.png" alt="Company Problems"
                 style="padding: 10px;height: 50px"></div>
             <div class="col-xs-9"><span class="Evaluasi-kinerja-sel">Managers are unable to constantly regulate the
                 activities of those in their employ. Therefore, the quantity and quality of their work can remain
                 surreptitiously inefficient for long periods of
                 time.</span></div>
           </div>
         ...
         <div class="col-md-12">
           <div class="col-md-6">
             <div class="col-xs-3 text-center"><img src="img/nippo/checked.png" alt="Company Problems"
                 style="padding: 10px;height: 50px"></div>
             <div class="col-xs-9"><span class="Evaluasi-kinerja-sel">Where internal communication is lacking, employees
           ...
           <div class="col-md-6">
             <div class="col-xs-3 text-center"><img src="img/nippo/checked.png" alt="Company Problems"
                 style="padding: 10px;height: 50px"></div>
             <div class="col-xs-9"><span class="Evaluasi-kinerja-sel">Tasks are done in an inefficient manner. Managers
                 will be unable to figure out who is spending
                 time on them.</span></div>
           </div>
     ...
     <div class="row row-fix-3">
       <div class="col-md-offset-2 col-md-8 text-center">
         ...
         <div class="col-md-4 text-left" style="padding:0;">
           ...
           <p class="NIPPO-system-menyedi">Register and manage project information, task types and the specific details
             of each task.</p>
         </div>
       </div>
     </div>
     <div class="row row-fix-3">
       <div class="col-md-offset-2 col-md-8 text-center">
         ...
         <div class="col-md-4 text-left" style="padding:0;">
           ...
           <p class="NIPPO-system-menyedi">Through tagging the colleagues each employee has collaborated with on every
             individual task,
     ...
     <div class="row row-fix-3">
       <div class="col-md-offset-2 col-md-8 text-center">
         ...
         <div class="col-md-4 text-left" style="padding:0;">
           ...
           <p class="NIPPO-system-menyedi">Manage your employee’s self-assessment evaluation score. It is also possible
         ...
         <div class="col-md-4 text-left" style="padding:0;">
           ...
           <p class="NIPPO-system-menyedi">Leave a like and comment on people’s work. You can also give a thumbs-up in
             regards to each
       ...
       <div class="row" style=" margin-right: 0; ">
         ...
         <div class="col-md-4 col-xs-12 text-center">
           <div class="OH1E290">
             ...
             <div class="Rectangle">Through this format, managers can easily keep tabs on and track the work content
         ...
         <div class="col-md-4 col-xs-12 text-center">
           <div class="OH1E290">
             ...
             <div class="Rectangle">Through Nippo, assessment is done in a <b>fair</b> and <b>practical manner</b>, and
       ...
       <div class="row m-top-0" style=" margin-right: 0; margin-top: 4em">
         <div class="col-md-4 col-xs-12 text-center">
           <div class="OH1E290">
             ...
             <div class="Rectangle">Since both <b>self assessment</b> and supervisor <b>evaluations</b> are managed
         ...
         <div class="col-md-4 col-xs-12 text-center">
           <div class="OH1E290">
             ...
             <div class="Rectangle">Internal communication is revitalized through a more interactive interface scheme.
               The ability to leave likes and comments will create a sense of comradery and recognition between team
               members.</div>
           </div>
         </div>
         <div class="col-md-4 col-xs-12 text-center">
           <div class="OH1E290">
             ...
             <div class="Rectangle">Remote workers get a chance to assess their skills based on the same criteria as
               regular workers.</div>
           </div>
         </div>
       </div>
         ...
         <div class="col-md-offset-1 col-md-10">
           <ol>
             <li class="-Bagaimana-cara-ke">
               ...
               <p class="Nippo-merupakan-sist">Nippo provides a daily reporting mechanism which calculates the man-hour
                 cost of each
             ...
             <li class="-Bagaimana-cara-ke">
               ...
               <p class="Nippo-merupakan-sist">With Nippo’s features, managers and HRD can accurately monitor the
             ...
             <li class="-Bagaimana-cara-ke">
               ...
               <p class="Nippo-merupakan-sist">Don’t worry, we provide user guidelines along with the application. If
             ...
             <li class="-Bagaimana-cara-ke">
               ...
               <p class="Nippo-merupakan-sist">Thank you for using our services. You can inform us directly through one
                 of the contacts we have provided.</p>
             </li>
             <li class="-Bagaimana-cara-ke">
               <h3>What’s the difference in interface options available to staff and managers?</h3>
               <p class="Nippo-merupakan-sist">Managers are able to evaluate each employee based on their overall
             ...
             <li class="-Bagaimana-cara-ke">
               ...
               <p class="Nippo-merupakan-sist">Yes, Nippo can be accessed through any browser, including mobile device
                 based browsers. If
           ...
           <form role="form" name='myForm' onsubmit='return validateForm()'
             ...
             <div class="row">
               <div class="col-sm-6 form-group">
                 <input type="text" class="form-control Rectangle-9" name="name" aria-label="Name" placeholder="Name"
       ...
       <div class="row" style="margin: 0">
         <div class="col-md-12 text-center">
           <div class="col-md-12">
             ...
             <p class="Nippo-adalah-aplikas2">Nippo is a web-based system that can manage, monitor and evaluate each
               employee’s
