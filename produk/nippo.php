     ...
     <div class="container">
       ...
       <section class="hidden-xs hidden-sm">
         ...
         <div class="col-md-push-3 col-md-8 col-md-pull-1">
           <p class="Nippo-adalah-aplikas"><b>Nippo</b> adalah aplikasi berbasis web yang dapat membantu para manajer
       ...
       <section class="hidden-xs hidden-sm">
         ...
         <div class="col-md-12" style=" padding-top: 7em; ">
           <div class="col-md-6 text-right">
             <div class="col-md-10"><span class="Evaluasi-kinerja-sel">Sulit untuk mengkalkulasikan total jam pengerjaan
                 suatu projek</span></div>
             <div class="col-md-2" style="margin-top:-5px;"><img src="img/nippo/checked.png" alt="Masalah perusahaan"
                 width="77px" height="77px"></div>
           </div>
         ...
         <div class="col-md-12" style=" padding-top: 2em; ">
           <div class="col-md-6 text-right">
             <div class="col-md-10"><span class="Evaluasi-kinerja-sel">Sulit untuk memantau manajemen kerja karyawan dan
           ...
           <div class="col-md-6 text-left">
             <div class="col-md-2" style="margin-top:-5px;"><img src="img/nippo/checked.png" alt="Masalah perusahaan"
                 width="77px" height="77px"></div>
             <div class="col-md-10"><span class="Evaluasi-kinerja-sel">Laporan pekerjaan harian yang dibuat karyawan
       ...
       <section class="hidden-md hidden-lg">
         ...
         <div class="col-md-12" style=" padding-top: 2em; ">
           <div class="col-md-6">
             ...
             <div class="col-xs-9"><span class="Evaluasi-kinerja-sel">Sulit untuk mengkalkulasikan total jam pengerjaan
                 suatu projek</span></div>
           </div>
           <div class="col-md-6">
             <div class="col-xs-3 text-center"><img src="img/nippo/checked.png" alt="Masalah Perusahaan"
         ...
         <div class="col-md-12">
           <div class="col-md-6">
             <div class="col-xs-3 text-center"><img src="img/nippo/checked.png" alt="Masalah Perusahaan"
                 style="padding: 10px;height: 50px"></div>
             <div class="col-xs-9"><span class="Evaluasi-kinerja-sel">Sulit untuk memantau manajemen kerja karyawan dan
                 perkembangan suatu projek</span></div>
           </div>
           <div class="col-md-6">
             <div class="col-xs-3 text-center"><img src="img/nippo/checked.png" alt="Masalah Perusahaan"
                 style="padding: 10px;height: 50px"></div>
             <div class="col-xs-9"><span class="Evaluasi-kinerja-sel">Laporan pekerjaan harian yang dibuat karyawan
                 tidak spesifik dan kurang jelas</span></div>
           </div>
     ...
     <div class="row row-fix-3">
       <div class="col-md-offset-2 col-md-8 text-center">
         ...
         <div class="col-md-4 text-left" style="padding:0;">
           ...
           <p class="NIPPO-system-menyedi">Perusahaan dapat membuat serta menambahkan informasi secara lengkap mengenai
         ...
         <div class="col-md-4 text-left" style="padding:0;">
           ...
           <p class="NIPPO-system-menyedi">Perusahaan dapat mengalkulasikan total jam kerja dari pengerjaan suatu
             projek. Dengan begitu, perusahaan dapat menganalisis suatu projek yang terlalu banyak memakan waktu. Hasil
             analisis dapat digunakan sebagai dasar pengambilan keputusan untuk kemajuan dan perkembangan suatu projek.
           </p>
         </div>
       </div>
     </div>
     <div class="row row-fix-3">
       <div class="col-md-offset-2 col-md-8 text-center">
         ...
         <div class="col-md-4 text-left" style="padding:0;">
           ...
           <p class="NIPPO-system-menyedi">Karyawan dapat menambahkan karyawan lain dalam laporan harian kerjanya jika
             mereka bekerja bersama melalui fitur Tag Person. Dengan begitu, perusahaan dapat mengetahui apabila
             terdapat pengisian laporan kerja yang cukup berbeda oleh kedua karyawan tersebut dengan membandingkan kedua
         ...
         <div class="col-md-4 text-left" style="padding:0;">
           ...
           <p class="NIPPO-system-menyedi">Dengan menggunakan Nippo, Anda dapat dengan mudah melakukan evaluasi kinerja
       ...
       <div class="col-md-offset-2 col-md-8 text-center">
         ...
         <div class="col-md-4 text-left" style="padding:0;">
           ...
           <p class="NIPPO-system-menyedi">Perusahaan dapat menambahkan batas waktu pekerjaan berdasarkan hari dan
             jumlah jam kerja melalui fitur Project Master. Selain itu, perusahaan dapat menambahkan informasi projek,
       ...
       <div class="row m-top-0" style=" margin-right: 0; margin-top: 4em">
         <div class="col-md-4 col-xs-12 text-center">
           <div class="OH1E290">
             ...
             <div class="Rectangle"><b>Manajemen kinerja</b> seluruh karyawan dapat diketahui oleh para manajer secara
         ...
         <div class="col-md-4 col-xs-12 text-center">
           <div class="OH1E290">
             ...
             <div class="Rectangle">Mempererat komunikasi internal. Meninggalkan like dan comment pada suatu laporan
               kerja dapat menumbuhkan rasa penghargaan dan apresiasi pada diri karyawan atas pekerjaannya.</div>
           </div>
         </div>
         <div class="col-md-4 col-xs-12 text-center">
           <div class="OH1E290">
             <img src="img/nippo/keuntungan-5.png" alt="San Francisco">
             <div class="Rectangle">Walaupun perusahaan memiliki pekerja remote, Anda dapat tetap memantau kinerja dan
         ...
         <div class="col-md-offset-1 col-md-10">
           <ol>
             <li class="-Bagaimana-cara-ke">
               ...
               <p class="Nippo-merupakan-sist">Nippo merupakan sistem yang dibuat untuk mempermudah karyawan dalam
                 melakukan laporan manajemen kerja harian. Selain itu, sistem ini juga dibuat untuk membantu manajerial
                 dalam memantau <b>manajemen kinerja</b> harian karyawan.</p>
             </li>
             <li class="-Bagaimana-cara-ke">
               <h3>Bagaimana Nippo dapat membantu manager dan staf HR?</h3>
               <p class="Nippo-merupakan-sist">Dengan fitur-fitur yang ada pada Nippo, manajer atau supervisor dapat
                 memantau manajemen kinerja dan produktivitas harian karyawan</p>
             </li>
             <li class="-Bagaimana-cara-ke">
               <h3>Sepertinya saya akan membutuhkan panduan yang lebih jelas dalam menggunakan Nippo. Apa saya akan
                 mendapatkannya?</h3>
               <p class="Nippo-merupakan-sist">Jangan khawatir. Kami menyediakan panduan penggunaannya untuk Anda. Jika
             ...
             <li class="-Bagaimana-cara-ke">
               ...
               <p class="Nippo-merupakan-sist">Anda bisa langsung menghubungi kami melalui salah satu kontak yang kami
                 sediakan. Kami siap melayani Anda dengan senang hati.</p>
             </li>
             <li class="-Bagaimana-cara-ke">
               <h3>Apa perbedaan laman kelola untuk staf dengan manajerial?</h3>
               <p class="Nippo-merupakan-sist">Pada halaman manajerial terdapat fungsi evaluasi sehingga manajer dapat
                 memberikan skor evaluasi kepada stafnya. Sedangkan untuk halaman staf hanya terdapat fungsi laporan
                 harian saja.</p>
             </li>
             <li class="-Bagaimana-cara-ke">
               <h3>Apakah Nippo bisa diakses oleh browser apa pun?</h3>
               <p class="Nippo-merupakan-sist">Ya, Nippo dapat diakses menggunakan browser apapun, termasuk oleh browser
             ...
             <li class="-Bagaimana-cara-ke">
               ...
               <p class="Nippo-merupakan-sist">Tidak. Nippo dirancang untuk memenuhi kebutuhan dari jenis perusahaan apa
                 pun.</p>
             </li>
             <li class="-Bagaimana-cara-ke">
           ...
           <form role="form" name='myForm' onsubmit='return validateForm()'
             ...
             <div class="row">
               <div class="col-sm-6 form-group">
                 <input type="text" class="form-control Rectangle-9" name="name" aria-label="Name" placeholder="NAMA"
       ...
       <div class="row" style="margin: 0">
         <div class="col-md-12 text-center">
           <div class="col-md-12">
             ...
             <p class="Nippo-adalah-aplikas2">Nippo adalah aplikasi berbasis web yang dapat membantu para manajer dalam
