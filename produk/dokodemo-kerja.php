 ...
 <body class="dokodemo">
         ...
         <nav class="navbar navbar-default navbar-dokdem">
             <div class="container">
                 ...
                 <div id="navbar" class="navbar-collapse collapse" aria-expanded="false" style="height: 1px;">
                     ...
                     <a class="logique-logo-link" href="/" target="_blank" aria-label="Logique Logo"><img
         ...
         <div class="container" id="introduction">
             <div class="row">
                 <div class="col-md-10 col-md-offset-1">
                     <div class="div-top">
                         <h1 class="anton title"> Solusi Kerja Fleksibel<br class="hidden-xs" /> yang Lebih Produktif
                         </h1>
                         <hr />
                         <p class="text-center">
                             Setiap hari, kemacetan dan lamanya perjalanan menuju kantor menjadi salah satu penyebab
                             stres bagi sebagian besar pekerja. Belum lagi jika sedang musim hujan, keterlambatan pun
                             menjadi hal yang terpaksa dimaklumi. Akibatnya, produktivitas jadi menurun. Target
                             perusahaan pun terpaksa ditunda. Jika saja karyawan bisa bekerja tanpa keterikatan waktu
                             dan tempat, bukankah produktivitas akan meningkat, dan hal-hal di atas tidak perlu
                             dipermasalahkan?
                         </p>
                     </div>
                 </div>
         ...
         <div class="container">
             <div class="row">
                 ...
                 <div class="col-md-6 text-justify">
                     ...
                     <span class="blue">Dokodemo-Kerja</span> adalah sistem kerja profesional yang dibuat untuk para
                     pekerja independen dan fleksibel, namun tetap ingin lebih dalam hal produktivitas kerja. Sistem
                     kerja ini merupakan solusi terbaik bagi perusahaan agar dapat mengetahui secara detail kinerja dari
                     seluruh karyawannya.<br /><br />
                     Dengan menggunakan sistem teknologi ini, perusahaan dapat menerapkan sistem kerja remote bagi
                     karyawannya di mana pun dan kapan pun. Karyawan pun dibebaskan dari kejenuhan dan ketatnya suasana
                     kerja dalam kantor.<br /><br />
                     Selain untuk karyawan dengan sistem <i>remote</i>, <span class="blue">Dokodemo-Kerja</span>
                     ternyata juga dapat Anda pergunakan untuk memantau produktivitas karyawan di kantor. Selain untuk
                     memantau pekerjaan, <span class="blue">Dokodemo-Kerja</span> juga dapat digunakan oleh HR dan
                     Manajer sebagai salah satu syarat untuk menentukan kinerja para karyawan.
                     <br /><br />
                     <div class="text-center">
                     ...
                     <div id="myCarousel" class="carousel slide" data-ride="carousel">
                         ...
                         <div class="carousel-inner">
                             <div class="item active">
                                 <img src="img/dokodemo-kerja/ss4.jpg" alt="Dokodemo Kerja"
                                     class="img-responsive center-block">
                             </div>
                             <div class="item">
                                 <img src="img/dokodemo-kerja/ss1.jpg" alt="Dokodemo Kerja"
                                     class="img-responsive center-block">
                             </div>
                             <div class="item">
                                 <img src="img/dokodemo-kerja/ss2.jpg" alt="Dokodemo Kerja"
                                     class="img-responsive center-block">
                             </div>
                             <div class="item">
                                 <img src="img/dokodemo-kerja/ss3.jpg" alt="Dokodemo Kerja"
                                     class="img-responsive center-block">
                             </div>
                             <div class="item">
                                 <img src="img/dokodemo-kerja/ss5.jpg" alt="Dokodemo Kerja"
                                     class="img-responsive center-block">
                             </div>
                         </div>
                     ...
                     <div class="col-md-6 col-md-offset-6">
                         <div class="bg-one-fitur">
                             <div class="one-fitur" style="margin-bottom: 0;">
                                 ...
                                 <strong>Dokodemo-Kerja</strong> mengambil cuplikan layar (screen capture) aktivitas
                                 kerja karyawan pada layar perangkat komputernya dalam waktu yang acak (random) dan
                                 mengirimnya pada tim manajemen (administrator).
                             </div>
                         </div>
                     </div>
                 </div>
             ...
             <div class="row" style="margin:0">
                 <div class="col-md-6" style="padding: 0;">
                     ...
                     <div class="dengan-fitur">
                         <div class="quote">“</div>Dengan fitur-fitur tersebut, <strong>Dokodemo-Kerja</strong> dapat
                         menjadi revolusi sistem kerja baru bagi perusahaan dan karyawan Anda.
                     </div>
                 </div>
                 <div class="col-md-6 one-fitur-btm">
                     ...
                     <div class="bg-one-fitur">
                         <div class="one-fitur">
                             ...
                             Mengkalkulasi total jam kerja para karyawan, termasuk penghitungan jam istirahat, secara
                             akurat hanya dengan satu klik secara mudah karena semua berjalan sesuai dengan real time
                     ...
                     <div class="bg-one-fitur">
                         <div class="one-fitur">
                             ...
                             Mengelola total jam kerja serta proyek atau konten yang dikerjakan oleh karyawan, sehingga
                             mampu membuat perusahaan dapat menentukan target waktu yang bisa dicapai oleh para
                             karyawannya.
                         </div>
                     </div>
                     <div class="bg-one-fitur">
                         <div class="one-fitur">
                             ...
                             Menampilkan total jam kerja seluruh karyawan dalam satu tampilan layar, sehingga memudahkan
                             perusahaan untuk menentukan kinerja dari seluruh karyawan yang ada di perusahaannya secara
                 ...
                 <div class="col-lg-6">
                     <div class="pl-25">
                         ...
                         <div class="desc-bantu">
                             <div class="quote">“</div>
                             <strong>Dokodemo-Kerja</strong> merupakan solusi sistem kerja yang menguntungkan, baik bagi
                             karyawan maupun perusahaan. Dengan sistem kerja efisien, <strong>Dokodemo-Kerja</strong>
                             bisa membantu perusahaan berkonsentrasi pada peningkatan produktivitas sekaligus memberikan
                             fleksibilitas pada karyawannya.
                         </div>
                     </div>
                 </div>
             </div>
             ...
             <div class="row">
                 <div class="col-lg-offset-6 col-lg-6">
                     <div class="pr-25" style="min-height: 185px;">
                         ...
                         <ul class="fa-ul">
                             <li><span class="fa-li"><i class="fa fa-circle"></i></span>Mempermudah perusahaan dalam
                                 memantau produktivitas karyawan yang bekerja dengan sistem jarak jauh
                                 (<i>freelance</i>, <i>sistem remote</i>, dsb).</li>
                             <li><span class="fa-li"><i class="fa fa-circle"></i></span>Membantu karyawan bekerja dengan
                                 fleksibel dan lebih produktif tanpa harus meninggalkan rumah.</li>
                         </ul>
                     </div>
                 </div>
             </div>
             ...
             <div class="row">
                 <div class="col-lg-6">
                     <div class="pl-25" style="min-height: 169px">
                         <ul class="fa-ul">
                             <li><span class="fa-li"><i class="fa fa-circle"></i></span>Mencegah karyawan mengisi
                                 laporan kerja yang tidak sesuai dengan kenyataannya.</li>
                             <li><span class="fa-li"><i class="fa fa-circle"></i></span>Mempermudah pencatatan dan
                                 pengelolaan aktivitas dan jam kerja karyawan secara tepat.</li>
                             <li><span class="fa-li"><i class="fa fa-circle"></i></span>Membantu mendorong karyawan
                                 untuk lebih bersemangat dalam bekerja dengan fleksibilitas waktu yang dimiliki.</li>
                         </ul>
                     </div>
                 </div>
             </div>
         ...
         <div class="container">
             ...
             <div class="row">
                 <div class="col-md-offset-1 col-md-10">
                     <div class="list-masalah">Anda memiliki cukup banyak kantor dan tidak memiliki manager pada setiap
                         kantor. Sulit bagi Anda untuk memantau pekerjaan karyawan dengan baik</div>
                     <div class="list-masalah">Anda tidak dapat memastikan apakah mereka bekerja dengan cukup baik.
                         Staff Anda berbeda lantai dan ruangan dengan Anda dan Anda juga seringkali keluar kantor.</div>
                     <div class="list-masalah">Sulit untuk memantau jam kerja para karyawan. Anda menggunakan alat
                         perekam kehadiran yang menggunakan sidik jari, namun masih terdapat celah dan kekurangan dari
                         alat tersebut.</div>
                     <div class="list-masalah">Beberapa karyawan menonton Youtube untuk waktu yang lama pada saat jam
                         kerja.</div>
         ...
         <div class="container">
             <div class="row">
                 <div class="col-md-offset-1 col-md-10">
                     ...
                     <br />
                     <div class="title anton">Dokodemo-Kerja adalah solusi sistem kerja berupa aplikasi yang mampu
                         merekam, menghitung, serta mengelola aktivitas dan jam kerja karyawan guna meningkatkan
                         produktivitas perusahaan.</div>
                     <hr />
                     <p>
                         Bagi perusahaan yang sedang mempertimbangkan sistem kerja jarak jauh (freelance, pekerja
                         remote, dsb). Bagi perusahaan yang ingin meningkatkan produktivitas sekaligus kebahagiaan
                         karyawan. Bagi perusahaan yang ingin membatasi penggunaan jam kerja yang tidak efisien, seperti
                         jeda merokok dan istirahat setelah beribadah, menonton video hiburan yang berlebihan, hingga
                         membuka media sosial pribadi.
                     </p>
                 </div>
             </div>
         </div>
     ...
     <div class="harga" id="price">
         <div class="container">
             ...
             <div class="text-center"><strong>Dokodemo-Kerja</strong> diciptakan bagi perusahaan untuk memantau dan
                 melacak waktu kerja karyawan mereka, para freelancer atau pekerja remote sehingga produktivitas
                 perusahaan meningkat. Berikut ini rincian kategori dari <strong>Dokodemo-Kerja</strong>. Semua harga
                 paket ini tidak dikenakan biaya tambahan.</div><br />
             <br />
             <div class="row">
                 <div class="col-md-offset-2 col-md-4">
                     <div class="card-harga">
                         ...
                         <div class="plan-list">
                             <ul class="fa-ul">
                                 <li><span class="fa-li"><i class="fa fa-circle"></i></span>Pelacak waktu</li>
                                 <li><span class="fa-li"><i class="fa fa-circle"></i></span>Screenshot monitoring</li>
                                 <li><span class="fa-li"><i class="fa fa-circle"></i></span>1 Screenshot per 10 menit
                                 </li>
                                 <li><span class="fa-li"><i class="fa fa-circle"></i></span>Screenshot disimpan selama 2
                                     bulan</li>
                                 <li><span class="fa-li"><i class="fa fa-circle"></i></span>
                                     <b>Untuk 10 orang pengguna*</b><br />
                                     <div style="font-size: 12px;color: #da0101;margin-top: 10px;font-style: italic;">
                                         Jika lebih dari 10 orang pengguna, maka setiap pengguna dikenakan biaya Rp
                                         50.000/ bulan</div>
                                 </li>
                             </ul>
                         </div>
                     ...
                     <div class="card-harga">
                         ...
                         <div class="plan-list">
                             <ul class="fa-ul">
                                 <li><span class="fa-li"><i class="fa fa-circle"></i></span>Pelacak waktu</li>
                                 <li><span class="fa-li"><i class="fa fa-circle"></i></span>Screenshot monitoring</li>
                                 <li><span class="fa-li"><i class="fa fa-circle"></i></span>1 Screenhot per 3
                                     menit</li>
                                 <li><span class="fa-li"><i class="fa fa-circle"></i></span>Screenshot disimpan selama 6
                                     bulan</li>
                                 <li><span class="fa-li"><i class="fa fa-circle"></i></span>
                                     <b>Untuk 20 orang pengguna*</b><br />
                                     <div style="font-size: 12px;color: #da0101;margin-top: 10px;font-style: italic;">
                                         Jika lebih dari 20 orang pengguna, maka setiap pengguna dikenakan biaya Rp
                                         75.000/ bulan</div>
                                 </li>
                             </ul>
                         </div>
                 ...
                 <div class="col-md-4">
                     <div class="card-harga">
                         ...
                         <div class="plan-list">
                             <ul class="fa-ul">
                                 <li><span class="fa-li"><i class="fa fa-circle"></i></span>Pelacak waktu</li>
                                 <li><span class="fa-li"><i class="fa fa-circle"></i></span>Screenshot monitoring
                                 </li>
                                 <li><span class="fa-li"><i class="fa fa-circle"></i></span>1 Screenhot per (#)
                                     menit</li>
                                 <li><span class="fa-li"><i class="fa fa-circle"></i></span>Screenshot disimpan
                                     selama (#)
                                     bulan</li>
                                 <li><span class="fa-li"><i class="fa fa-circle"></i></span>
                                     Untuk (#) orang pengguna<br />
                                 <li><span class="fa-li"><i class="fa fa-circle"></i></span>
                                     <b>+ Fitur Tambahan</b><br />
                                     <div class="text-center"
             ...
             <div class="row">
                 <div class="col-md-4">
                     <div class="testi-content">
                         ...
                         <p>
                             Macetnya lalu lintas menuju kantor saya cukup membuat saya stress. Lelah dan stress saya
                             menjadi bertambah, sebab rumah dengan kantor saya memiliki jarak yang cukup jauh. Setiap
                             harinya saya menghabiskan waktu selama empat jam di jalan, terus menerus seperti itu. Pada
                             akhirnya, perusahaan saya menggunakan Dokodemo-Kerja dan menerapkan sistem kerja remote di
                             kantor. Dengan Dokodemo-Kerja saya bisa bekerja secara fleksibel.
                         </p>
                 ...
                 <div class="col-md-4">
                     <div class="testi-content">
                         ...
                         <div class="clearfix"></div>
                         <p>
                             Sangat sulit bagi saya untuk memantau seluruh karyawan untuk tidak membuka sosial media,
                             youtube, dan bermain games. Setelah saya menggunakan Dokodemo-Kerja, saya dapat memantau
                             seluruh karyawan yang membuka sosial media, youtube dan bermain games dari screen capture
                             laptop masing-masing. Sekarang, para karyawan menon-aktifkan
                             Dokodemo-Kerja apabila mereka sedang istirahat ataupun bermain games. Aktivitas tersebut
                             tidak dihitung sebagai jam kerja mereka.
                         </p>
                         <div class="text-center"><span class="fs-16"><strong>Kevin</strong></span> - <span
                                 class="fs-14">Staff HR</span></div>
                     </div>
                     <br />
                 </div>
                 <div class="col-md-4">
                     <div class="testi-content">
                         ...
                         <div class="clearfix"></div>
                         <p>
                             Saya merasa sungkan untuk menegur karyawan yang menggunakan waktu untuk beribadah terlalu
                             lama. Saya ingin berlaku adil terhadap seluruh karyawan, apapun agama yang mereka anut.
                             Sekarang jam kerja yang adil dapat diberlakukan kepada seluruh karyawan. Saya merasa
                             terbantu dengan Dokodemo-Kerja.
                         </p>
                 ...
                 <div class="col-md-4">
                     <div class="testi-content">
                         ...
                         <div class="clearfix"></div>
                         <p>
                             Saya ingin melanjutkan pendidikan ke jenjang yang lebih tinggi. Dengan Dokodemo-Kerja saya
                             bisa membuktikan bahwa saya benar-benar bekerja selama delapan jam setiap harinya. Saya
                             bekerja di waktu siang untuk beberapa hari. Pada hari-hari selanjutnya, saya bekerja di
                             waktu malam. Dokodemo-Kerja membuat kualitas hidup saya meningkat.
                         </p>
                 ...
                 <div class="col-md-4">
                     <div class="testi-content">
                         ...
                         <div class="clearfix"></div>
                         <p>
                             Melakukan monitoring terhadap karyawan remote cukup sulit. Perbedaan tempat dan jarak yang
                             jauh membuat saya sulit untuk memantau karyawan. Semenjak menggunakan Dokodemo-Kerja, saya
                             dapat memantau karyawan dengan lebih baik. Saya bisa mengetahui produktivitas dan jam kerja
                             mereka. Terimakasih Dokodemo-Kerja.
                         </p>
                         <div class="text-center"><span class="fs-16"><strong>Arie</strong></span> - <span
                                 class="fs-14">HR</span></div>
                     </div>
                     <br />
                 </div>
                 <div class="col-md-4">
                     <div class="testi-content">
                         ...
                         <div class="clearfix"></div>
                         <p>
                             Saya kira, bekerja secara full remote adalah sesuatu yang mustahil. Sebab, perusahaan akan
                             sulit untuk memantau kinerja karyawan. Tapi anggapan saya berubah ketika saya mengenal
                             Dokodemo-Kerja. Oleh karena sistem ini, perusahaan di tempat saya bekerja memperbolehkan
                             karyawan untuk bekerja secara remote. Saya sangat bahagia sekali. Akhirnya saya dapat
                             bekerja sembari mengurus anak di rumah.
                         </p>
                 ...
                 <div class="col-md-4">
                     <div class="testi-content">
                         ...
                         <div class="clearfix"></div>
                         <p>
                             Seringkali saya menegur para karyawan yang terlalu lama keluar untuk merokok. Alasannya,
                             mereka tidak bekerja sesuai dengan jam kerja yang seharusnya berlaku. Kedua, saya ingin jam
                             kerja yang adil dapat berlaku untuk seluruh karyawan. Setelah menggunakan Dokodemo-Kerja,
                             sudah tidak ada lagi karyawan menggunakan waktu merokok terlalu lama. Saya pun dapat dengan
                             mudah mengalkulasi jam kerja karyawan.
                         </p>
                 ...
                 <div class="col-md-4">
                     <div class="testi-content">
                         ...
                         <div class="clearfix"></div>
                         <p>
                             Saya tidak bisa bekerja secara on site karena ibu saya sakit. Saya kira, saya harus
                             merelakan pekerjaan saya disaat-saat seperti ini. Namun, Dokodemo-Kerja dapat membantu saya
                             untuk tetap bekerja profesional dengan sistem kerja remote.
                         </p>
             ...
             <div class="row">
                 <div class="col-lg-12">
                     <div class="title text-center">
                         <span class="blue2">Untuk informasi lebih lanjut mengenai <strong>Dokodemo-Kerja</strong>,
                         </span><br />
             ...
             <form class="form-dokodemo" role="form" name='myForm' onsubmit='return validateForm()'
                 ...
                 <div class="row">
                     <div class="form-group">
                         ...
                         <div class="col-md-5">
                             <input required type="text" class="form-control" name="company" aria-label="Company"
                                 placeholder="Perusahaan" value='<?php echo $formproc->SafeDisplay('company') ?>' />
                         </div>
                         <div class="clearfix"></div>
                     </div>
                     <div class="form-group">
                         <div class="col-md-offset-1 col-md-5">
                             <input required type="number" class="form-control" name="phone" aria-label="Phone"
                                 placeholder="Nomor Ponsel" value='<?php echo $formproc->SafeDisplay('phone') ?>' />
                         </div>
                         <div class="col-md-5">
                     ...
                     <div class="form-group">
                         <div class="col-md-offset-1 col-md-5">
                             <div style="padding:10px;background:#fff">
                                 ...
                                 <div class="radiobuttons">
                                     <!-- <div class="rdio">
                                         <input name="needs" value="Untuk uji coba gratis Dokodemo-Kerja" id="radio2"
                                             type="radio" required>
                                         <label class="highlight-radio" for="radio2">Tentang uji coba gratis
                                             Dokodemo-Kerja</label>
                                     </div> -->
                                     <div class="rdio">
                                         <input name="needs" value="Untuk pendaftaran Dokodemo-Kerja" id="radio3"
                                             type="radio" required>
                                         <label class="highlight-radio" for="radio3">Tentang berlangganan
                                             Dokodemo-Kerja</label>
                                     </div>
                                     <div class="rdio">
                                         <input name="needs" value="Cara menggunakan Dokodemo-Kerja" id="radio4"
                                             type="radio" required>
                                         <label for="radio4">Tentang cara dan penggunaan Dokodemo-Kerja</label>
                                     </div>
                                     <div class="rdio">
                                         <input name="needs" value="Untuk kerja remote dengan Dokodemo-Kerja"
                                             id="radio5" type="radio" required>
                                         <label for="radio5">Tentang kerja remote dengan Dokodemo-Kerja</label>
                                     </div>
                                     <div class="rdio">
                                         <input name="needs"
                                             value="Untuk peningkatan produktivitas dengan Dokodemo-Kerja" id="radio6"
                                             type="radio" required>
                                         <label for="radio6">Tentang peningkatan produktivitas dengan
                                             Dokodemo-Kerja</label>
                                     </div>
                                     <div class="rdio">
                                         <input name="needs"
                                             value="Untuk monitor jam kerja karyawan dengan Dokodemo-Kerja" id="radio7"
                                             type="radio" required>
                                         <label for="radio7">Tentang monitor jam kerja karyawan dengan
                                             Dokodemo-Kerja</label>
                                     </div>
                                 </div>
                             </div>
                         ...
                         <div class="col-md-5">
                             <textarea required name="message" aria-label="Message" class="form-control"
                                 placeholder="Deskripsi"><?php echo $formproc->SafeDisplay('message') ?></textarea>
                         </div>
                         <div class="clearfix"></div>
                     </div>
                     <div class="form-group">
                     ...
                     <div class="row">
                                         ...
                                         <li class="have-submenu"><a href="/layanan/web-dev.php" target="_blank">Jasa
                                             ...
                                             <ul>
                                                 <li><a href="/layanan/pembuatan-web-karir.php" target="_blank">
                                                         Pembuatan Website Career</a> </li>
                                                 <li><a href="/layanan/pembuatan-web-klinik-gigi.php" target="_blank">
                                                         Website Klinik Gigi </a></li>
                                             </ul>
                                         </li>
                                         <li><a href="/layanan/pembuatan-sistem-web.php" target="_blank">Jasa
                                                 Pengembangan Sistem Web</a></li>
                                         <li><a href="/layanan/pembuatan-aplikasi-mobile.php"
                                                 target="_blank">Pengembangan Aplikasi Mobile </a></li>
                                         <li class="text-left"><a href="/layanan/penetration-test.php"
                                                 target="_blank">Pengetesan Keamanan Website (Pentest) </a></li>
                                         <li class="text-left"><a href="/layanan/digital-marketing.php"
                                                 target="_blank">Jasa Digital Marketing </a></li>
                                     </ul>
                                 </li>
                             </ul>
                                 ...
                                 <li class="have-submenu">
                                     ...
                                     <ul>
                                         <li><a href="https://dokodemo-kerja.com" target="_blank" rel="noreferrer">
                                                 Dokodemo-Kerja <br><span style="font-size: 11px;">(Sistem aplikasi bagi
                                                     pekerja remote) </span> </a>
                                         </li>
                                         <li>
                                             <a href="/produk/nippo.php" target="_blank"> Nippo <br> <span
                                                     style="font-size: 11px;">(Sistem aplikasi laporan pegawai
                                                     harian)</span> </a>
                                         </li>
                                         <li>
                                             <a href="/produk/sugoi-saiyo.php" target="_blank"> Sugoi Saiyo <br> <span
                                                     style="font-size: 11px;">(Sistem aplikasi perekrutan
                                                     pegawai)</span></a>
                                         </li>
                                     </ul>
                                 </li>
                         ...
                         <div class="col-sm-4 link-footer">
                             ...
                             <p style=" padding-bottom: 0px; padding-top: 0px;">
                                 <strong>Dokodemo-Kerja</strong> adalah sebuah tool yang dapat membuat karyawanmu
                                 bekerja remote, meningkatkan produktivitas dengan menghilangkan aktivitas yang membuang
                                 waktu dan tenaga, serta mengurangi beban HR dalam memantau kerjaan karyawan. Anda juga
                                 dapat menyesuaikan Dokodemo-Kerja berdasarkan kebutuhan perusahaan Anda. Hubungi kami
                                 jika Anda tertarik.
                             </p>
