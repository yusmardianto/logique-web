...
<html lang="en">
  <head>
    ...
    <meta property="og:title" content="重機検査システム開発（BUMA社向け）">
    ...
    ?>
          ...
          <div class="row">
            ...
            <div class="col-xs-6 text-right">
              <ul>
                ...
                <li class="active"><a href="/jp/case-study/sistem-inspeksi-alat-berat-buma/">JP</a></li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div class="cs-wrap">
        <section class="cs-top">
          ...
          <h2 class="cs-title-2 hidden-xs">インドネシアの大手マイニング会社<br>BUMA社向け車両検査システム開発</h2>
        </section>
        ...
        <section class="cs-section">
          ...
          <div class="row">
            ...
            <div class="col-sm-5 col-md-pull-6">
              <p class="cs-subtitle-top">BUMAについて</p>
              <p class="cs-desc">
        ...
        <section class="cs-section">
          ...
          <div class="row">
            ...
            <div class="col-sm-6 col-md-pull-6">
              <p class="cs-subtitle-top">重機の管理</p>
        ...
        <section class="cs-section">
          ...
          <div class="row">
            ...
            <div class="col-sm-7">
              <p class="cs-subtitle-top">ソリューション：デジタル検査システム</p>
              <p class="cs-desc">
        ...
        <section class="cs-section result-section" style="margin-bottom: -2px;">
          ...
          <div class="row">
            <div class="col-md-12">
              <br>
              <p class="text-center cs-subtitle-top">BUMA車両検査システム（DigiMan）のパフォーマンス</p>
