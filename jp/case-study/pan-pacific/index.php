      ...
      <div class="cs-wrap">
        ...
        <section class='cs-section client-info'>
            <div class="row">
                <div class="col-sm-7 text-container">
                    ...
                    <p>
                    PT. Pan Pacific Insuranceは、年々増加する類似の保険会社に対抗できるよう、総合的な保険商品をとり揃えている、地元の保険会社です。過去10年間で最も急成長し、最も信頼されている保険会社の1つとして、その地位を確立することに成功しました。
                  </p>
                </div>
        ...
        <section class='cs-section background-info bg-option1'>
            ...
            <div class="row flex__row">
                ...
                <div class="col-sm-6 text-container">
                    ...
                    <p>
                    日々の活動の中でPT. Pan Pacificは、預金、債券、株式、投資信託など、さまざまな商品に投資し、勢力的に投資活動を行っています。PT. Pan Pacificの投資活動は長期間行われてきましたが、記録や報告はいまだ手作業です。そのため、投資活動においては、「データの同期が取れない」「各方面への確認に時間がかかる」「既存書類の紛失・破損が発生する」などの問題が発生していました。その解決策として、LOGIQUE DIGITAL INDONESIAの協力のもと、投資全体を監視できるシステムを構築したのです。
                    </p>
                    <!-- <p>
        ...
        <section class='cs-section tect-info '>
            ...
            <div class="row flex__row">
                <div class="col-sm-7 text-container">
                    ...
                    <p>
                    PT. Pan Pacificの投資システム構築のために、PHPというプログラミング言語を使ったLaravelというフレームワーク技術が活用されています。Laravelフレームワークは、MVC構造のサポートやパフォーマンスの軽量化、良好なセキュリティなどの利点があるため、投資システムの開発において選択されました。このシステムは、PT. Pan Pacificが直接管理するAzureベースのクラウドインフラ上に実装されています。
                    </p> 
                </div>
        ...
        <section class='cs-section result-info bg-option2'>
            ...
            <div class="result-content-container" >
                    ...
                    <h2 class="section-title text-center">Pan Pacific Insurance Investment System Results</h2>
                    <p>
                    投資システム以前のPT. Pan Pacificでは、投資全体をモニタリングすることが困難で、さまざまなメディアを通じて多くの関係者にデータを確認した上で、情報を個別保管しなければならないため、データの紛失や記録ミスの可能性が非常に大きく、社員の集中力が低下していました。しかし、LOGIQUE DIGITAL INDONESIAの投資システムによって投資活動の手順が自動化されてからは、投資データの紛失や破損の心配がなくなり、業務が非常に効率化されたと感じています。
                  </p>
                  <div class="  text-center">
        ...
        <section class="cs-bottom">
          <div class="cs-bottom__text">
            <h2 class="cs-subtitle  ">ABOUT LOGIQUE</h2>
            <p class="cs-desc">
