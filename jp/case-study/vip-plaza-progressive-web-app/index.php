...
<html lang="en">
  ...
  <meta name="description" itemprop="description" content="インドネシアのIT/DXコンサルティング会社LOGIQUEの実績紹介。 Progressive Web Apps (PWA) Development プロジェクトのご紹介。インドネシアでWebシステム、Web・モバイルアプリ、デジタルマーケティング運用、Webセキュリティ検査などのサービス提供をしています。LOGIQUEデジタルインドネシアは受託制作会社でありIT/DXコンサルティング会社です。">
  ...
  <meta property="og:title" content="Progressive Web Apps (PWA) Development | Case Study | LOGIQUE Digital Indonesia">
  ...
  <meta property="og:description" content="インドネシアのIT/DXコンサルティング会社LOGIQUEの実績紹介。 Progressive Web Apps (PWA) Development プロジェクトのご紹介。インドネシアでWebシステム、Web・モバイルアプリ、デジタルマーケティング運用、Webセキュリティ検査などのサービス提供をしています。LOGIQUEデジタルインドネシアは受託制作会社でありIT/DXコンサルティング会社です。">
  ...
  <title>Progressive Web Apps (PWA) Development | ケーススタディ | インドネシアのWebシステム開発実績 | LOGIQUE</title>
        ...
        <section class="cs-section">
          ...
          <div class="row">
            ...
            <div class="col-sm-6 col-md-pull-6">
              ...
              <p class="cs-desc">
                VIP Plazaは、日々発展し続けるインドネシアのファッションとコスメティック関連のオンラインストアです。このファッションオンラインストアは、およそ800の人気地元ブランドと有名な海外ブランドから、30,000点以上の製品を提供しています。それだけでなく、毎日「フラッシュセール」というショッピングコンセプトで、顧客のショッピング体験をさらにエキサイティングで楽しいものにしています。もちろんこのオンラインストアは、いつでもどこでもショッピングを楽しめる、興味深いさまざまな機能を有しています。
              </p>
            </div>
          </div>
        </section>
        <section class="cs-section">
          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              ...
              <p class="cs-desc">
              成長し続けるオンラインストアの一つであり続けるために、VIP Plazaは、確実かつ着実に競争力を高めるための技術を改善する必要がありました。そのため、服やシューズ、バッグ、時計、その他さまざまなアクセサリーなど、さまざまなアイテムを購入したいというさまざまなニーズを喚起し、ユーザーの興味を満たすような積極的なウェブアプリ(PWA)を構築したいと考えていました。VIP PlazaのWebサイトでは、スマートフォンのパフォーマンスを低下させるアプリケーションをインストールすることなく、他のオンラインファッションストアとは異なる方法でショッピングできますが、ユーザーが低速、または不安定なインターネット接続を使用した場合でも、オフライン機能を活用できます。
              <br><br>
              ユーザーが望むWebアプリを構築するために、VIP Plazaは、システム開発をサポートするためにLOGIQUE DIGITAL INDONESIAと協力する必要性を感じていました。PWA は、Web アプリのパフォーマンスを向上させ、より良い状態にすることが期待されています。さらには、ユーザーにさまざまなショッピング体験を提供するための、プラットフォーム用の新しいアプリケーションのスタンダードタイプを作成しました。
              <br><br>
              </p>
            </div>
          </div>
        ...
        <section class="cs-section">
          ...
          <div class="row">
            ...
            <div class="col-sm-6 col-md-pull-6">
              ...
              <p class="cs-desc">
              このPWAを構築するために、「React.JS」をベースとした「Next.JS」という技術が活用されています。このフレームワークは、ブラウザとサーバーで動作可能なものです。このフレームワークは、zeitというスタートアップ企業から生まれたもので、2018年、最も人気のあるフレームワークとされています。
              <br><br>
              「pages」フォルダ内のすべてのコンポーネントが自動的にサーバーレンダリングされる、SEO Friendlyなどの利点があり、その他にもPWAシステムの開発をサポートするさまざまな利点があるため、今回の開発ではNext.JSが選ばれました。
              </p>
            </div>
          </div>
        </section>
        <section class="cs-section result-section">
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              VIP PlazaとLOGIQUE DIGITAL INDONESIAのコラボレーションにより、3ヶ月という短期間でVIPプラザのPWAシステム開発に成功しました。このシステムにより、VIP Plazaは、複雑で大量のデータを消費するアプリケーションをインストールすることなく、ユーザーに売買取引における新しい体験を提供し、Webサイトへの訪問者数増加を実現できるようになったのです。
              </p>
