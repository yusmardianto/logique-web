        ...
        <section class="cs-section">
          ...
          <div class="row">
            ...
            <div class="col-sm-5 col-md-pull-6">
              ...
              <p class="cs-desc">
              PT. AIA Financialは、インドネシアの大手保険会社の一つです。AIAは、生命保険、医療保険、傷害保険、投資連動型保険、従業員福祉プログラム、年金基金（DPLK）プログラムなど、幅広い保険商品を提供しています。
              <br><br>
              PT. AIA Financialは、インドネシアの大手保険会社の一つです。AIAは、生命保険、医療保険、傷害保険、投資連動型保険、従業員福祉プログラム、年金基金（DPLK）プログラムなど、幅広い保険商品を提供しています。
            </div>
          </div>
        ...
        <section class="cs-section">
          ...
          <div class="row">
            ...
            <div class="col-sm-7">
              ...
              <p class="cs-desc">
              AIAは、成長著しい大手保険会社の一つとして、顧客満足度の継続的な向上を目指しており、その一環として、保険契約の解約手続きをマニュアルからデジタルに移行することを検討しました。現在、テクノロジーの進化は著しく、誰もがあらゆることをオンラインベースのプラットフォームで行いたいと考えるようになっています。AIAはこのニーズに応えるため、このサイトを開発することにしました。
              <br><br>
              AIA Surrenderマイクロサイトを通じて、保険契約の解約手続きをオンラインで行うことができるー。それは、保険契約者が会社を訪問したり連絡したりすることなく、どこにいても簡単に手続きができるということです。さらに、マイクロサイトではリテンション・ツールも開発し、お客さまが解約の意思を維持・軽減できるようにも努めています。
              <br><br>
              その上で、PT. AIA Financialは、LOGIQUE DIGITAL INDONESIAと緊密に連携し、Webサイトをベースにした最適な解約システムの開発をさらに進化させています。このシステムにあらゆる世代がアクセスできるよう、ユーザーフレンドリーでわかりやすいUI/UXデザインによって、さらなるサポートがなされる必要があると考えました。そこで、今回のプロジェクト「AIA Surrender」を立ち上げ、保険契約の解約プロセスを効果的にデジタル化することを目指したのです。
              <br><br><br>
              </p>
            </div>
          </div>
        ...
        <section class="cs-section">
          ...
          <div class="row">
            ...
            <div class="col-sm-6 col-md-pull-6">
              ...
              AIA Surrenderマイクロサイトを作成するために、PHPプログラミング言語を使用するLaravelフレームワークの技術が使用されています。Laravelフレームワークが選ばれた理由は、MVC構造のサポート、パフォーマンスの高さ、良好なセキュリティーなどの利点があるためです。Laravelのモデルコンセプトは、高いチームコラボレーションとしても知られており、その1つが「migrate機能/コンポーネント」です。migrateコンポーネントを使えば、チームはLaravelコンポーザーから直接データベースを設計してMySQLクエリを実行できるので、phpmyadminを使って手動でTableを作成したり、MySQLデータベースファイルを共有する必要がありません。
              <br><br>
              なおUIには、Bootstrapフレームワークを使用したHTMLとCSSの技術が使用されています。Bootstrapは、レスポンシブWebサイト開発で最も人気のあるCSSフレームワークです。これにより、AIA Surrenderマイクロサイトは、PC、タブレット、スマートフォンなど、あらゆるデバイスで見栄えがよいものになります。
              <br><br><br>  
              </p>
            </div>
          </div>
        ...
        <section class="cs-section result-section" style="margin-bottom: -2px;">
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              PT. AIA FinancialとLOGIQUE DIGITAL INDONESIAのコラボレーションによる「AIA Surrenderマイクロサイト」の開発は、1ヶ月半の期間で成功裏に終わりました。PT. AIA Financialは、このマイクロサイトによって、保険契約の解約プロセスをデジタル化するという目的を達成することができると同時に、特異なデータ保有ツールによって、保険解約を希望するAIAの保険契約者は、保険を解約せずに保有するよう設定することができるようになりました。
              <br><br>
              マニュアル方式と比較すると、AIAが利用できる保険契約解除システムは、はるかに効果的かつ効率的なものです。契約者はサイトにアクセス、ツールの指示に従うだけです。契約を解除したい場合は、契約解除フォームに記入するだけでOK。解除後は24時間以内に、AIAから確認の連絡が来る仕組みになっています。
              </p>
              <br><br>
