                        ...
                        <ol class="breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">
                            ...
                            <li class="active" itemprop="itemListElement" itemscope
                                itemtype="http://schema.org/ListItem"><a itemprop="item"><span
                                        itemprop="name">LOGIQUE制作開発実績</span></a>
                                <meta itemprop="position" content="2" />
                            </li>
                        </ol>
                        <h1 class="tagline">
                            Webサイト・ホームページ制作、システム開発実績、モバイルアプリ開発、デジタルマーケティング実施事例などを紹介します。インドネシアの大手金融機関とも多く取引いただいています。</h1>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="form-container our-portfolio">
                    ...
                    <div class="portfolio-webdev page-part-container">
                        ...
                        <div class="row text-center">
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="addition-desc text-left">
                                    保険EC開発制作 (デザイン | プログラミング | CMS | 決済連携） <div class="grey-clr">CMS, 保険Eコマース, 金融, 保険
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                        ...
                        <div class="portfolio-webdev page-part-container panel-collapse collapse" id="hide-portfolio">
                            <div class="row text-center">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="addition-desc text-left">ランディングページ制作 (デザイン | マークアップ)<div
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="addition-desc text-left">WEB制作＆運用 (デザイン | コーディング | 運用)<div
                                            class="grey-clr">モバイル,セキュアなWEB,公共</div>
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                                <div class="col-sm-4">
                                    ...
                                    <div class="addition-desc text-left">WEB制作 (デザイン | コーディング | AWS運用)<div
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="addition-desc text-left">WEBサイト制作 (デザイン| コーディング |CMS)<div
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="addition-desc text-left">ECサイト構築 (デザイン| EC構築 | CMS構築 | 運用)<div
                                            class="grey-clr">EC,CMS,決済連携,マルチレベルマーケティング</div>
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                                <div class="col-sm-4">
                                    ...
                                    <div class="addition-desc text-left">AMP制作 (デザイン | AMPプログラミング）<div class="grey-clr">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="addition-desc text-left">WEBリニューアル制作 (デザイン| コーディング | AWS)<div
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="addition-desc text-left">WEBサイト制作 (デザイン | コーディング |運用)<div
                                            class="grey-clr">多言語,モバイル最適化,製造販売,美容</div>
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                                <div class="col-sm-4">
                                ...
                                <div class="col-sm-4">
                                    <img src="/img/portfolio/caroline.png" alt="Caroline"
                                        class="img-responsive center-block">
                                    Caroline
                                    <div class="addition-desc text-left">車マーケットプレイス開発運用 (デザイン | プログラミング | システム開発）<div
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="addition-desc text-left">WEB構築＆運用 (デザイン | CMS | システム構築｜コンテンツ制作 | 運用)<div
                                            class="grey-clr">CMS,マーケットプレイス,DB,Mobile,セキュアなWEB,WEBサービス</div>
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                                <div class="col-sm-4">
                                    ...
                                    <div class="addition-desc text-left">キャンペーンサイト制作＆運用 (デザイン | コーディング | Operation)<div
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="addition-desc text-left">キャンペーンページ制作 (デザイン | コーディング | CMS開発)<div
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="addition-desc text-left">WEBサイト制作 (デザイン | コーディング | 運用)<div
                                            class="grey-clr">多言語,モバイル最適化,LPO,A/Bテスト,美容・エステ</div>
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                                <div class="col-sm-4">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="addition-desc text-left">ランディングページ制作 (デザイン | コーディング）<div
                                            class="grey-clr">キャンペーンページ, モバイル最適化,コンサルティングサービス,四輪</div>
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                                <div class="col-sm-4">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="addition-desc text-left">ランディングページ制作 (デザイン | コーディング)<div
                                            class="grey-clr">モバイル,キャンペーンページ</div>
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                                <div class="col-sm-4">
                                    ...
                                    <div class="addition-desc text-left">WEBサイト制作 (デザイン | コーディング | 運用 | WEBサーバー運用)<div
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="addition-desc text-left">WEB構築＆運用 (デザイン | CMS |コンテンツ制作 | 運用)<div
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="addition-desc text-left">WEBサイト制作 (デザイン | コーディング | 保守 | WEBサーバー運用)<div
                                            class="grey-clr">多言語,モバイル,バイクサービス</div>
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                                <div class="col-sm-4">
                                    ...
                                    <div class="addition-desc text-left">WEB構築＆運用 (デザイン | Coding | Wordpress | 運用)<div
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="addition-desc text-left">WEB構築＆運用 (デザイン | Coding | Wordpress | AWS運用)
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="addition-desc text-left">参加申込フォーム (デザイン | PHPフォーム)<div class="grey-clr">
                                            多言語,モバイル, 申込フォーム開発,公共</div>
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                                <div class="col-sm-4">
                                    ...
                                    <div class="addition-desc text-left">WEBサイト制作 (デザイン | コーディング)<div class="grey-clr">
                                            多言語,モバイル,製造業</div>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="addition-desc text-left">WEB制作 (デザイン | コーディング)<div class="grey-clr">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="addition-desc text-left">WEB制作 (デザイン | コーディング | 保守)<div
                                            class="grey-clr">モバイル,多言語,Wordpress,ブログ,不動産</div>
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                                <div class="col-sm-4">
                                    ...
                                    <div class="addition-desc text-left">WEB構築＆運用 (デザイン | CMS | 運用)<div
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="addition-desc text-left">WEBリデザイン(デザイン | コーディング)<div class="grey-clr">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="addition-desc text-left">WEBサイト制作 (デザイン| コーディング |運用)<div
                                            class="grey-clr">モバイル最適化,オンラインブッキング,スポーツ</div>
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                                <div class="col-sm-4">
                                    ...
                                    <div class="addition-desc text-left">ランディングページ制作 (デザイン | マークアップ | 広告)<div
                                            class="grey-clr">モバイル最適化, 多言語, イベント</div>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    ...
                                    <div class="addition-desc text-left">WEB再制作 & 改善ワーク(デザイン | コーディング | コンテンツ制作 | 運用)
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="addition-desc text-left">スマホページ再制作 (PWAとして再開発)<div class="grey-clr">PWA,
                                            モバイル, Eコマース</div>
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                                <div class="col-sm-4">
                                    ...
                                    <div class="addition-desc text-left">WEBリニューアル制作 (PDCA | SEO | AWS)<div
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="addition-desc text-left">EラーニングWEB開発 (デザイン | CMS | PWA開発）<div
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="addition-desc text-left">コーポレートWEB制作 (デザイン | コーディング）<div
                                            class="grey-clr">レスポンシブ制作, 多言語WEB, コーポレート動画制作, 鉄鋼商社</div>
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                                <div class="col-sm-4">
                                    ...
                                    <div class="addition-desc text-left">LP制作（Bootstrap | コンテンツ企画）<div class="grey-clr">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="addition-desc text-left">AMP制作（AMP | DB連動ダイナミックページ）<div
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="addition-desc text-left">クリエイターズマーケットプレイス開発（デザイン制作 | WEBシステム開発 |
                                        セキュリティアセスメント）<div class="grey-clr">　WEBシステム, 検索システム,スマホ最適, マーケットプレイス</div>
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                                <div class="col-sm-4">
                                    ...
                                    <div class="addition-desc text-left">WEBホスティング (コーディング | CMSフィッティング)<div
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="addition-desc text-left">HTML/CSSコーディング (コーディング) <div class="grey-clr">
                                ...
                                <div class="col-sm-4">
                                    <img src="/img/portfolio/jba-redesign.png" alt="JBA Re-design"
                                        class="img-responsive center-block">
                                    JBA Re-design
                                    <div class="addition-desc text-left">WEB構築＆運用 (デザイン | CMS | システム構築｜運用 | AWS運用)<div
                                            class="grey-clr">オンラインオークション,高アクセスWEB,DB-WEB,セキュアなWEB,自動車,バイク,金融</div>
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                                <div class="col-sm-4">
                                    ...
                                    <div class="addition-desc text-left">
                                        WEB制作＆運用 (デザイン | コーディング | コンテンツ制作 | 運用) <div class="grey-clr">CMS, multi-bahasa,
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="addition-desc text-left">CMS WEBサイト制作 (デザイン | コーディング | CMS))<div
                    ...
                    <div class="digital-marketing-container  page-part-container">
                        ...
                        <div class="row text-center">
                            ...
                            <div class="col-sm-4">
                                ...
                                在インドネシア日本国大使館
                                <div class="addition-desc text-center">
                                    <small class="text-muted">(SNSマーケティング, SNS運用, SNS広告, インスタグラム広告, フェイスブック広告,
                                        ソーシャルメディア)</small>
                                </div><br />
                            </div>
                            <div class="col-sm-4">
                    ...
                    <div class="other-portfolio-container  page-part-container">
                        ...
                        <div class="slider-other-client-container">
                            ...
                            <div class="other-client-item">
                                <div class="img-thumb"><img src="../img/portfolio/video-otomart.jpg"
                                        alt="2D ビデオ制作 (OTOmart)" class="img-responsive center-block">
                                </div>
                                2D ビデオ制作 (OTOmart)
                            </div>

                            <div class="other-client-item">
                                <div class="img-thumb"><img src="../img/portfolio/video-otomart2.jpg"
                                        alt="2D ビデオ制作 (OTOmart)" class="img-responsive center-block"></div>
                                2D ビデオ制作 (OTOmart)
                            </div>
                            <div class="other-client-item">
                                <div class="img-thumb"><img src="../img/portfolio/mufg-mockup.png" alt="会社案内制作"
                                        class="img-responsive center-block"></div>
                                会社案内制作
                            </div>
                            <div class="other-client-item">
                                <div class="img-thumb"><img src="../img/portfolio/onitsuka-mockup.jpg" alt="会社案内制作"
                                        class="img-responsive center-block"></div>
                                会社案内制作
                            </div>

                            <div class="other-client-item">
                                <div class="img-thumb"><img src="../img/portfolio/maison-news.png" alt="コンテンツ制作"
                                        class="img-responsive center-block"></div>
                                コンテンツ制作
                            </div>
                            <div class="other-client-item" style="font-size:12px;">
                                <div class="img-thumb"><img src="../img/portfolio/insta-vid.png" alt="インスタグラムビデオ投稿コンテスト"
                                        class="img-responsive center-block insta-vid"></div>
                                インスタグラムビデオ投稿コンテスト
                            </div>
                            <div class="other-client-item">
                                <div class="img-thumb"><img src="../img/portfolio/frangipani-photoshot.png"
                                        alt="Frangipani スパ 写真撮影" class="img-responsive center-block insta-vid"></div>
                                Frangipani スパ 写真撮影
                            </div>

                            <div class="other-client-item">
                                <div class="img-thumb"><img src="/img/portfolio/drone1.png" alt="ドローン撮影"
                                        class="img-responsive center-block"></div>
                                ドローン撮影
                            </div>
                            <div class="other-client-item">
                                <div class="img-thumb"><img src="/img/portfolio/drone2.png" alt="ドローン撮影"
                                        class="img-responsive center-block"></div>
                                ドローン撮影
                            </div>
                            <div class="other-client-item">
                                <div class="img-thumb"><img src="/img/portfolio/sunlife-flyer.jpg" alt="リーフレット制作＆印刷"
                                        class="img-responsive center-block"></div>
                                リーフレット制作＆印刷
                            </div>

                            <div class="other-client-item">
                                <div class="img-thumb"><img src="/img/portfolio/sunlife-banner.jpg" alt="バナー制作"
                                        class="img-responsive center-block"></div>
                                バナー制作
                            </div>
                            <div class="other-client-item">
                                <div class="img-thumb"><img src="/img/portfolio/sunlife-polo-shirt.jpg" alt="ユニフォーム制作"
                                        class="img-responsive center-block"></div>
                                ユニフォーム制作
                            </div>
                            <div class="other-client-item">
                                <div class="img-thumb"><img src="/img/portfolio/Eria.jpg" alt="チラシ制作＆印刷"
                                        class="img-responsive center-block"></div>
                                チラシ制作＆印刷
                            </div>

                            <div class="other-client-item">
                                <div class="img-thumb"><img src="/img/portfolio/bumbu-warasa-1.jpg" alt="プロダクトデザイン"
                                        class="img-responsive center-block"></div>
                                プロダクトデザイン
                            </div>
                            <div class="other-client-item">
                                <div class="img-thumb"><img src="/img/portfolio/minum-warasa-1.jpg" alt="プロダクトデザイン"
                                        class="same-height img-responsive center-block"></div>
                                プロダクトデザイン
                            </div>
                            <div class="other-client-item">
                            ...
                            <div class="other-client-item">
                                <div class="img-thumb"><img src="/img/portfolio/caroline-1.jpg" alt="フライヤー制作＆印刷"
                                        class="img-responsive center-block" style="height: 224px"> </div>
                                フライヤー制作＆印刷
                            </div>
                            <div class="other-client-item">
                                <div class="img-thumb"><img src="/img/portfolio/sunlife-book.jpg" alt="販促＆配布品制作"
                                        class="img-responsive center-block" style="height: 224px"> </div>
                                販促＆配布品制作
                            </div>
                            <div class="other-client-item">
                                <div class="img-thumb"><img src="/img/portfolio/sunlife-book2.jpg" alt="販促＆配布品制作"
                                        class="img-responsive center-block" style="height: 224px"> </div>
                                販促＆配布品制作
                            </div>

                            <div class="other-client-item">
                                <div class="img-thumb"><img src="/img/portfolio/60jpid_catalog.png" alt="カタログ制作＆印刷"
                                        class="img-responsive center-block" style="height: 224px"> </div>
                                カタログ制作＆印刷
                            </div>
                        </div>
