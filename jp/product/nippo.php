       ...
       <section class="hidden-xs hidden-sm">
         ...
         <div class="col-md-12" style=" padding-top: 7em; ">
           <div class="col-md-6 text-right">
             <div class="col-md-10"><span class="Evaluasi-kinerja-sel">適切でフェアな人事評価ができていない。客観性のある数値で管理された評価を行いたい。</span>
             </div>
       ...
       <section class="hidden-md hidden-lg">
         ...
         <div class="col-md-12" style=" padding-top: 2em; ">
           <div class="col-md-6">
             ...
             <div class="col-xs-9"><span class="Evaluasi-kinerja-sel">適切でフェアな人事評価ができていない。客観性のある数値で管理された評価を行いたい。</span>
             </div>
           </div>
           <div class="col-md-6">
             <div class="col-xs-3 text-center"><img src="img/nippo/checked.png" alt="Company Problems"
           ...
           <ol>
             <li class="-Bagaimana-cara-ke">
               ...
               <p class="Nippo-merupakan-sist">Nippo merupakan sistem yang dibuat untuk mempermudah karyawan dalam
                 melakukan laporan kerja harian. Selain itu, sistem ini juga dibuat untuk membantu manajerial dalam
           ...
           <form role="form" name='myForm' onsubmit='return validateForm()'
             ...
             <div class="row">
               <div class="col-sm-6 form-group">
                 <input type="text" class="form-control Rectangle-9" name="name" aria-label="Name" placeholder="お名前"
             ...
             <div class="row">
               ...
               <div class="col-sm-6 form-group">
                 <input type="number" class="form-control Rectangle-9" name="phone" aria-label="Phone" placeholder="TEL"
