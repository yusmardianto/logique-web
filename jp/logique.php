                        ...
                        <div class="col-md-offset-2 col-md-8">
                            ...
                            <div class="custombox__slider">
                                ...
                                <p class="custombox__slider-btn">
                                    IT、Digitalマーケッティング関連サービスをワンストップで提供します
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <section id="companyOverview">
                <div class="container__">
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            <h1 class="title-index">LOGIQUEの概要</h1>
                            <hr class="title__yellow-line">
                            ...
                            <ul class="company__content">
                                ...
                                <li>事業内容</li>
                                <li class="company__bold">ITコンサルティング、WEBサイト制作、システム開発運用、アプリ開発、デザイン制作</li>
                                <hr class="company__divider">

                                <li>代表者</li>
                                <li class="company__bold">Takashi Yoshitsugu (吉次 敬)</li>
                                <hr class="company__divider">

                                <li>従業員数</li>
                                <li class="company__bold">59名 (2019年11月現在）</li>
                                <hr class="company__divider">
                                ...
                                <div class="director__content">
                                    ...
                                    <div>
                                        ...
                                        <p style="text-align: justify">
                                            1976年に山口県出身の両親の元、東京で生まれる。横浜育ち。1999年に早稲田大学理工学部経営システム工学科を卒業。株式会社日本総合研究所やコンサルティングファームなどを経て2005年よりEコマース事業、輸入商社、コンサルティング会社を起業。2012年よりインドネシアに移住し会社運営。
                                    </div>
                                </div>
                            </div>
                        </div>
