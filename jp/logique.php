                        ...
                        <div class="col-md-8"><br><br>
                            <div class="principle">
                                <div class="principle__content">
                                    <p>
                                    こちらから英語版のPT LOGIQUE DIGITAL INDONESIAの会社概要をダウンロードいただけます。LOGIQUEが提供するサービス、プロダクトやいままでの実績についても記載していますので、ご覧いただければ幸いです。インドネシアでIT/DX関連のご支援が必要であればお気軽にお問い合わせいただければと思います。インドネシアで10年以上、プロジェクト数300以上の経験を活かしてご支援いたします。
                                   </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="custombox__custom-slider">
                                <div id="profile" class="carousel slide" data-ride="carousel">
                                    <div class="bg--dark">
                                        <p align="center">IT/DXコンサルティングサービスをインドネシアでワンストップで提供しています</p>
                                    </div><br>
                                    <div>
                                        <div id="txtCarousel" class="carousel-inner">
                                            <div class="item active">
                                                <p style="margin-left:20px"><b>ゴールとご予算に応じて柔軟に最適なソリューションをご提供します。Agileプロジェクトマネジメントを得意としています。<div style="color: rgba(0, 0, 0, 0.001); -moz-user-select: none;">Agileプロジェクトマネジメントを得意としています。</div></b></p>
                                            </div>
                                            <div class="item">
                                                <p style="margin-left:20px"><b>プロジェクトのご相談、お見積のご依頼、入札への参加依頼、業務提携の相談などお気軽にご連絡ください。ジャカルタ視察時の当社へのご来訪もスケジュールが合えば受け付けております。</b></p>
                                            </div>
                                            <div class="item">
                                                <p style="margin-left:20px"><b>インドネシアでの事業に関して業務提携のご相談に応じます。まずはお気軽に（日本語で問題ありません）ご連絡ください。日本でのお打ち合わせも可能です。 </b></p>
                                            </div>
                                            <div class="item">
                ...
                <div class="container__">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <p>LOGIQUEはインドネシアにベースを置くWeb制作/システム受託開発会社です。日本人がオーナーですが日本に法人はなく、日本式にこだわりはありません。インドネシアへの深い理解をもってインドネシアで成功するやり方を知っています。豊富な実績と確かなクオリティで信頼いただいており、多くのインドネシアの大企業、日系のインドネシア法人のお客様とお取引させていただいています。</p><br><br>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <p>システム開発の領域では、中古車流通関係で多くの実績をもっています。保険のE-Commerceも豊富な経験があります。インドネシアのほとんどのPayment Gatewayと繋ぎ込み経験があります。PWA開発はインドネシアのなかでもTopランナーだと自負しています。</p><br><br>
                        </div>
                        <div class="col-md-6">
                            <img src="/img/logique/Karakteristik4.png" width="14%"/><br><br>
                            <p>IT/DXの内製化をお考えの企業が増えています。これをご支援するために定額制のDX/DMサービスを提供しており、段階的な内製化をご支援しています。グループ会社のKAZOKKUより提供しているITスペシャリストの派遣サービスのご利用も内製化の助けになると考えています。</p><br><br>
                        </div>
                    </div>
                    <div align="center">
                ...
                <div class="container__">
                    ...
                    <div class="row" style="margin-top:-100px">
                        ...
                        <div class="col-sm-6">
                            ...
                            <p>インドネシアのWeb制作開発業界の発展に寄与し、インドネシア人のWebデベロッパーにより良い機会を与えます。</p><br><br>
                        </div>
                    </div>
                </div>
            </section>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="director">
                                ...
                                <div class="director__content">
                                    ...
                                    <div>
                                        <p>1976年に山口県出身の両親の元、東京で生まれる。横浜育ち。1999年に早稲田大学理工学部経営システム工学科を卒業。複数のコンサルティングファームなどを経て2005年よりEコマース事業、輸入商社、コンサルティング会社を日本で起業。2012年よりインドネシアに移住し会社運営。2022年現在、ジャカルタと福岡を毎月行き来する生活。日本やインドネシアのスタートアップ複数社の取締役も務める。</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="col-md-5 bg--grey" align="center">
                                ...
                                <a class="career-section__btn" href="/jp/services.php" style="padding:10px; font-size:16px;"><b>See Service List</b></a>
                            </div>
                            <div class="col-md-1"></div>
                            <div class="col-md-5 bg--grey" align="center">
                                <img src="/img/logique/TentangKami2.png" width="138px" class="img-responsive"/>
                                <a class="career-section__btn" href="/jp/product.php" style="padding:10px; font-size:16px;"><b>See Product List</b></a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="bg--gradient col-md-5">
                            <div class="row" style="margin-top:15px; margin-bottom:15px">
                                <a href="/jp/services/penetration-test.php">
                                    ...
                                    <div class="col-md-10">
                                        <p style="font-size:16px; color:black"><b>Web/アプリのセキュリティ脆弱性検査サービス</b></p>
                                        <p style="font-size:14px; color:black">CEH認定資格保有者がセキュリティ脆弱性を検査してレポートするサービス</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="bg--gradient col-md-5">
                            <div class="row" style="margin-top:15px; margin-bottom:15px">
                                <a href="/jp/services/digital-marketing/seo-service.php">
                                    ...
                                    <div class="col-md-10">
                                        <p style="font-size:16px; color:black;"><b>SEO対策サービス</b></p>
                                        <p style="font-size:14px; color:black;">インドネシア語、英語、日本語のSEO対策、10年超の実績があります。</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="bg--gradient col-md-5" style="margin-top:-10px">
                            <div class="row" style="margin-top:15px; margin-bottom:15px">
                                <a href="/jp/services/system-dev.php">
                                    ...
                                    <div class="col-md-10">
                                        <p style="font-size:16px; color:black;"><b>Webアプリ/システム開発サービス</b></p>
                                        <p style="font-size:14px; color:black;">Agileで柔軟にクオリティも高いシステムを開発します</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                        <div class="col-md-1"></div>
                            <div class="bg--gradient col-md-5" style="margin-top:-10px">
                                <div class="row" style="margin-top:15px; margin-bottom:15px">
                                    ...
                                    <div class="col-md-10">
                                        <p style="font-size:16px; color:black"><b>ITエンジニアの派遣サービス（インドネシア内）</b></p>
                                        <p style="font-size:14px; color:black">関連会社KAZOKKUが提供するTプロフェッショナル派遣サービス</p>
                                    </div>
                                </a>
                            </div>
                        </div>
