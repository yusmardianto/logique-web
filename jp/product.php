                    ...
                    <section>
                        <div class="text-center">
                            ...
                            <p class="title__description">LOGIQUEが提供する製品を紹介します。<br>
                                リモートワーク｜テレワークがインドネシアでより普及するのに貢献したく、リモートワーカーを管理しながら生産性向上にも寄与するDokodemo-Kerjaを販売しています。月額１万円以下の利用料で大きな効果が得られる優れたツールです。<br>
                            ...
                            <p class="title__description">
                                インドネシアで人事業務を効果的に運営するために作成されたHRクラウドサービスを提供しています。生産性向上ツール、採用管理ツール、日報ツールを展開しています。全てのツールは元々、当社向けに開発して運用していたものです。インドネシア事情に沿っているツールとなっております。まずはトライアル利用をしていただければと思います。
                ...
                <div class="container__">
                    ...
                    <section>
                        <div class="product-slogan">
                            ...
                            <p class="product-slogan__text">"インドネシアでの課題を解決する人事クラウドツールを提供しています。<br>
                                勤怠＆リモート管理ツール、採用管理ツール、日報管理ツールを提供しています。"</p>
                        </div>
                    </section>
            ...
            <div class="content-wrapper__">
                <div class="container__">
                    ...
                    <section>
                        ...
                        <h4 class="title-index__sub">リモートワークと生産性向上を両方実現することを可能にするツール</h4>
                        <p class="title__description--full">リモートワーク（テレワーク）を可能にして、従業員の生産性を向上させ、管理者の管理工数を減らす画期的なツールです。
            ...
            <div class="content-wrapper__gray">
                <div class="container__">
                    ...
                    <section>
                        ...
                        <hr class="title__yellow-line">
                        <h4 class="title-index__sub">インドネシア事情に完全対応した採用管理ツール</h4>
                        <p class="title__description--full">
                        ...
                        <div class="product-snap-shot">
                            ...
                            <div class="product-snap-shot__item">
                                <img class="product-snap-shot__img--3-col" src="../img/product/sugoi_saiyo/sugoi_saiyo_3.png"
                                    alt="sugoi saiyo 3">
                                <p class="product-snap-shot__text">レジュメだけでなく他のドキュメントのアップロードも可能です</p>
                            </div>
                        </div>
                        ...
                        <div class="text-center">
                            <a class="btn--yellow" href="product/sugoi-saiyo.php">Sugoi採用について詳しくみる</a>
                        </div>
                    </section>
