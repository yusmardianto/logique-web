			...
			<div id="contentsArea">
				<div id="contents">
					...
					<div class="bg-grey">
						...
						Q. 日本人同士で日本語で相談・プロジェクト進行できるのか？<br/>
						A. 案件の内容によりますが、可能です。インドネシアでのプロジェクトを日本の部署の日本人担当者さまと、弊社日本人がやり取りさせていただきながらの進行も可能です。オフショア案件のご相談も受け付けております。<br/><br/>

						Q. 日本で打ち合わせすることは可能ですか？<br/>
						A. まずはご相談ください。原則、SKYPEミーティングなどをお願いしておりますが、ご相談内容により検討いたします。<br/><br/>

						Q. いま委託しているWEB・システム会社から乗り換えを検討している<br/>
						A. ドキュメントが無いなどで運用会社の変更を躊躇されるお客様が多いのですが、十分な引継ぎがなくても一般的なテクノロジーで作られたWEB/システムであれば、引継ぎ、修正、運用が可能なケースがほとんどです。お気軽にご相談ください。<br/><br/>

						Q. ○☓管理システムを開発できる会社を探しているのだが<br/>
						A. インドネシアで顧客管理システム、債権管理、販売管理、採用管理、ポイント管理、e-Commerce、コンテンツ管理システムなど様々なシステムを構築運用してきました。オープンなWEBシステム技術を使ったシステム開発が得意です。柔軟に早く開発することが可能ですので、まずはご相談ください。<br/><br/>

						Q. インドネシアでの制作パートナーとして検討したい<br/>
						A. ぜひ詳細をご相談させてください。ジャカルタ視察旅行の機会には是非ともお立ち寄りください。<br/><br/>

						Q. モバイルアプリ開発を検討している<br/>
						A. アンドロイドアプリ、iOSアプリ開発のどちらも可能です。企画の段階から関与する形態も可能ですのでご相談ください。<br/><br/>

						Q. 販促物を作りたいのだがデザインだけじゃなくて印刷や製作まで可能なのか？<br/>
						A. パンフレット、リーフレットなど通常の印刷物はもちろん可能です。うちわやTシャツなどであれば、こういったものへの印刷も可能ですが、大きな製作物や複雑なものだと専門業者に委託されたほうが良いかもしれません。いずれにしろご相談いただければ、弊社にて専門業者をご紹介することも可能です。<br/><br/>

						Q. インドネシア語のSEO対策が可能ですか？<br/>
						A. 可能です。金融系キーワードや旅行（訪日旅行）キーワード、教育系でSEO対策の経験があり、ビッグキーワードで上位表示を獲得しました。インドネシア人コンテンツライターとマーケッターがチームを組んで対策しますのでインドネシア語SEO対策が一番得意です。英語、日本語も可能です。<br/><br/>
					</div>
						<br/><br/>
