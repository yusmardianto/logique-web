                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-offset-1 col-sm-11">
                            <a href="index.php"><img src="../img/logo.png" alt="Logo" class="img-responsive logo--update-design" />
                            </a>
                            <ul class="list-inline">
                                <li><a href="../en/contact.php">EN</a></li>
                                <li><a href="../hubungi-kami.php">ID</a></li>
                        ...
                        <div class="col-sm-12">
                            <ol class="breadcrumb breadcrumb--update-design" itemscope
                                ...
                                <li class="active" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a
                                        itemprop="item"><span itemprop="name">&nbsp;お問い合わせ</span></a>
                ...
                <div class="container__">
                    <div class="clearfix">
                        <div class="contact-us-cont">
                            ...
                            <div class="col-sm-6 paddingless-mobile" style="padding-top: 5%;">
                                <dt class="d-title" style="background: #ffd02a; padding:1em;">
                                    デジタルマーケティングやWeb、アプリ開発運用で課題があれば、LOGIQUEがご支援します！<br>
                                    <span class="d-description"><a href="https://wa.me/+62811870321?text=Halo%20Sahabat%20LOGIQUE"
                                            target="_blank" rel="noreferrer" style="color: #000; text-decoration: underline;"> +62
                                            811-870-321</a> / <a href="tel:021-2270-8935"
                                            style="color: #000; text-decoration: underline;">021-2270-8935</a> /
                                ...
                                <form class="contactform mt-12" id="moresco-contactform" role="form" name='myForm'
                                    ...
                                    <div class="col-md-8 col-md-offset-2 col-sm-offset-1 col-sm-10">
                                        <div class="checkbox">
                                            <label>
                                                ...
                                                <span class="cr"><i class="cr-icon glyphicon glyphicon-ok"></i></span>Web /
                                                ホームページ制作運用について
                                            </label>
                                        </div>
                                        <div class="checkbox">
                                        ...
                                        <div class="checkbox">
                                            <label>
                                                ...
                                                <span class="cr"><i
                                                        class="cr-icon glyphicon glyphicon-ok"></i></span>デジタルマーケティング・SEOなどについて
                                            </label>
                                        </div>
                                        <div class="checkbox">
                                            <label>
                                                ...
                                                <span class="cr"><i
                                                        class="cr-icon glyphicon glyphicon-ok"></i></span>インドネシアのネット広告に関して
                                            </label>
                                        </div>
                                        <div class="checkbox">
                                            <label>
                                                ...
                                                <span class="cr"><i
                                                        class="cr-icon glyphicon glyphicon-ok"></i></span>コンテンツ制作や販促物制作に関して
                                            </label>
                                        </div>
                                        <div class="checkbox">
                                            <label>
                                        ...
                                        <div class="checkbox">
                                            <label>
                                                ...
                                                <span class="cr"><i
                                                        class="cr-icon glyphicon glyphicon-ok"></i></span>インドネシア進出に関して相談したい
                                            </label>
                                        </div>
                                        <div class="checkbox">
                                            <label>
                                                ...
                                                <span class="cr"><i
                                                        class="cr-icon glyphicon glyphicon-ok"></i></span>ジャカルタ視察旅行時に会社訪問したい
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-4 col-sm-offset-4">
                                        <button type="submit" class="btn btn-block"
                                            onclick="ga('send', 'event', 'Button-Kirim-JP', 'Action-Click', 'Button-Kirim-JP-Label');"
                                            style="background: #f4ce58; font-size: larger;">送信</button>
                                    </div>
                                </form>
                            </div>
                        </div>
