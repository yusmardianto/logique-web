					...
					<div class="form-container our-portfolio">
						...
						<div class="row text-center">
							...
							<div class="col-sm-4">
								...
								<div class="addition-desc text-left">
									<br>WEB再制作 & 改善ワーク(デザイン | コーディング | コンテンツ制作 | 運用)<br>
									<br><div class="grey-clr">CMS, モバイル, セキュアなWEB, 金融, 自動車ローン</div><br><br><br>
								</div>
							</div>
							<div class="col-sm-4">
							...
							<div class="col-sm-4">
								...
								<div class="addition-desc text-left">
									<br>HTML/CSSコーディング (コーディング) <br>
									<br><div class="grey-clr">モバイル最適化, キャンペーンページ</div><br><br><br>
								</div>
							</div>
							<div class="col-sm-4">
