	...
	<body class="mobileapp-page">
		<header>
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<a href="/jp/"><img alt="logo" class="img-responsive" src="assets/img/img-mobileapps/logo_logique.png"/></a>
					</div>
				</div>
				<div class="row">
					<div class="col-md-7">
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-4">
						...
						<a href="/jp/contact.php" target="_blank"><img alt="Logo" src="assets/img/img-mobileapps/logo_logique_footer.png" class="img-responsive"/></a>
