			...
			<div class="top-header-continer">
				<div class="container">
					<div class="row">
						...
						<a href="/jp/" target="_blank" class="logo">
			...
			<div class="breadcrumb-cont">
				...
				<ol class="breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">
				  ...
				  <li   itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem" ><a itemprop="item" href="../services.php" ><span itemprop="name">サービス</span></a><meta itemprop="position" content="2" /></li>
				   <li class="active" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem" ><a itemprop="item" " href="web-dev.php"><span itemprop="name">Web・ホームページ制作</span></a><meta itemprop="position" content="2" /></li>
				  <li class="active" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem" >  <span itemprop="name">Price Range</span> <meta itemprop="position" content="2" /></li>
				</ol>
				</div>
			</div>
				...
				<div class="row price-item pt-1">
					...
					<div class="col-md-6  col-sm-7">
						<div class="price-cont">
							<div class="row ">
								<div class="col-xs-4 col-sm-4">制作期間</div>
								<div class="col-xs-8  col-sm-8">約2週間〜</div>
							</div>
							<div class="row">
								<div class="col-xs-4  col-sm-4">ページ数</div>
								<div class="col-xs-8 col-sm-8">1ページ or 2ページ（2言語）〜</div>
							</div>
							<div class="row">
								<div class="col-xs-4  col-sm-4">制作費用</div>
								<div class="col-xs-8 col-sm-8">20,000,000 IDR 〜</div>
							</div>
							<div class="row">
								<div class="col-xs-4  col-sm-4">制作内容 </div>
				...
				<div class="row price-item pt-2">
					...
					<div class="col-md-6 col-sm-7">
						<div class="price-cont">
							<div class="row">
								<div class="col-xs-4 col-sm-4">制作期間</div>
								<div class="col-xs-8 col-sm-8">約1ヶ月〜</div>
							</div>
							<div class="row">
								<div class="col-xs-4 col-sm-4">ページ数</div>
								<div class="col-xs-8 col-sm-8">10ページ程度まで）</div>
							</div>
							<div class="row">
								<div class="col-xs-4 col-sm-4">制作費用</div>
				...
				<div class="row price-item pt-3">
					...
					<div class="col-md-6 col-sm-7">
						<div class="price-cont">
							<div class="row">
								<div class="col-xs-4 col-sm-4">制作期間</div>
								<div class="col-xs-8 col-sm-8">約2ヶ月〜</div>
							</div>
							<div class="row">
								<div class="col-xs-4 col-sm-4">ページ数</div>
								<div class="col-xs-8 col-sm-8">30ページ以上）</div>
							</div>
							<div class="row">
								<div class="col-xs-4 col-sm-4">制作費用</div>
				...
				<div class="row price-item pt-4">
					...
					<div class="col-md-6 col-sm-7">
						<div class="price-cont">
							<div class="row">
								<div class="col-xs-4 col-sm-4">制作期間</div>
								<div class="col-xs-8 col-sm-8">約2.5ヶ月〜</div>
							</div>
							<div class="row">
								<div class="col-xs-4 col-sm-4">ページ数</div>
								<div class="col-xs-8 col-sm-8">30ページ以上</div>
			...
			<div class="container">
				...
				<div class="other-estimate">
					<div class="other-estimate-title">
						<h3>その他制作諸費用の目安</h3>
						<div>当社の価格は、作業の難易度やスケジュールの緊急度などによって幅がありますが、個別の作業依頼は以下のようになります。あくまで目安としてお考えください。</div>
					</div>
				</div>
