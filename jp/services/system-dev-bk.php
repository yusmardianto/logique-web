...
?>
 ...
 <head>
     ...
     <link href="assets/css/style-systemdev-bk.css" rel="stylesheet">
 ...
 <body>
     ...
     <section class="style-2">
         <div class="container">
             <div class="row">
                 <div
                     class="col-lg-offset-5 col-lg-7 col-md-offset-3 col-md-9 col-sm-offset-4 col-sm-10 col-xs-offset-3 col-xs-9">
                     <div class="new5">
         ...
         <div class="container">
             <div class="row">
                 <div class="col-md-3 justify-content-center">
                     ...
                     <img class="img img-responsive yellow-stripes clearfix" src="assets/img/img-systemdev/yellow-stripes.png"
                         alt="">
                     <p class="new4">
                         アジャイル開発を基本としています。スピード感こそが最も大事だと思います。当社がリードして柔軟でスピーディに開発していきます。ニーズに合わせた開発体制を敷きます。ラボ型開発サービスも提供しています。</p>
                 </div>
                 <div class="col-md-3 justify-content-center">
                     ...
                     <p class="new4">
                         高品質なシステム構築を行います。通常のテストに加えセキュリティ脆弱性テストを実施することをお奨めしています。SQLインジェクション、パストラバーサル、クロスサイトスクリプティングなどPenetrationテストを行いリスクを最小限にします
                     </p>
                     <a href="../services/penetration-test.php" class="btn-contact-us-black-pent col-md-12"
                         style="margin-top: 12px;">セキュリティ脆弱性診断はこちら</a>
                 </div>
                 <div class="col-md-3 justify-content-center">
                     <h3 class="new1">インドネシアでの豊富な経験</h3>
                     <img class="img img-responsive yellow-stripes" src="assets/img/img-systemdev/yellow-stripes.png" alt="">
                     <p class="new4">
                         自動車産業、金融、政府系団体など向けにインドネシアで多くのシステム開発を行ってきました。E-Commerceを構築するなかでインドネシアの決済連携事情なども熟知しています。業務理解が早く、要件定義コンサルティングもいたします。
                     </p>
                 </div>
                 <div class="col-md-3 justify-content-center">
                     ...
                     <img class="img img-responsive yellow-stripes" src="assets/img/img-systemdev/yellow-stripes.png" alt="">
                     <p class="new4">
                         インドネシア国内外のクラウドサーバーの設計構築を行います。AWSやGCP、Alibabaクラウドなどの環境構築＆雲鷹経験が豊富です。オンプレミスサーバーからクラウドサーバーへのマイグレーションも多数実績あります。
                     </p>
                 </div>
             </div>
         </div>
                     ...
                     <div class="card">
                         <div class="row">
                             <div class="col-md-offset-1 col-md-10 m-t-10">
                                 ...
                                 <p>JBAインドネシアはインドネシア最大の車・バイクのオークションハウスです。当社では、Webサイトの制作運用、JBAのオークションコンダクターシステム、Biddingアプリ、オンラインオークション、検査モバイルアプリ、Financialシステムなど多くのシステム構築プロジェクトを通してご支援してきました。クリティカルなシステムなのでエラーのない開発が必要ですが、同時にスピードも求められるチャレンジングなプロジェクトを多く経験できています。定例でミーティングをしていて既存システムの改善も常に行っています。
                                 </p>
                             </div>
                         </div>
                         <div class="row">
             ...
             <div class="row">
                 <div class="col-sm-4">
                     <div class="osc-item">
                         ...
                         <h4>スピーディーな開発</h4>
                         <div class="osc-desc"> 僅か3ヶ月でゼロから基幹業務システムを構築。オンラインで中古車を売買するマーケットプレイスを構築した。<a
                                 href="../../case-study/caroline-bidding-system/">もっと見る</a></div>
                 ...
                 <div class="col-sm-4">
                     <div class="osc-item">
                         ...
                         <div class="osc-desc">
                             約5年に渡ってZuttoRide社のCRMシステムをゼロから開発、フェージングを適切にコントロールしながら機能追加、システム改善のPDCAサイクルを一緒に回してきた。<a
                                 href="../../case-study/zuttoride-customer-management-system/">もっと見る</a></div>
                 ...
                 <div class="list-study-container">
                     <ul class="circle-list">
                         <li>
                             ...
                             <small class="text-muted">6months, AWS, Linux, MySQL, PHP Framework | <a data-toggle="modal"
                                     data-target="#pop1" href="#">See More</a></small>
                         </li>
                         <!-- modal 1 -->
                         ...
                         <li>
                             ...
                             <small class="text-muted">6months, AWS, Linux, MySQL, PHP Framework | <a data-toggle="modal"
                                     data-target="#pop2" href="#">See More</a></small>
                         </li>
                         <!-- modal 2 -->
                         ...
                         <li>
                             ...
                             <small class="text-muted">6months, AWS, Linux, MySQL, PHP Framework, Node.js | <a data-toggle="modal"
                                     data-target="#pop3" href="#">See More</a></small>
                         </li>
                         <!-- modal 3 -->
                         ...
                         <li>
                             ...
                             <small class="text-muted">2months, Android, node.js, JAVA, AWS | <a data-toggle="modal"
                                     data-target="#pop4" href="#">See More</a></small>
                         </li>
                         <!-- modal 4 -->
                         ...
                         <li>
                             ...
                             <small class="text-muted">4months, Android, node.js, JAVA, AWS | <a data-toggle="modal"
                                     data-target="#pop5" href="#">See More</a></small>
                         </li>
                         <!-- modal 5 -->
                         ...
                         <li>
                             ...
                             <small class="text-muted">3months, PHP Framework, Payment Gateway, AWS | <a data-toggle="modal"
                                     data-target="#pop6" href="#">See More</a></small>
                         </li>
                         <!-- modal 6 -->
                         ...
                         <li>
                             ...
                             <small class="text-muted">2months, PHP Framework, MySQL, AWS | <a data-toggle="modal"
                                     data-target="#pop7" href="#">See More</a></small>
                         </li>
                         <!-- modal 7 -->
                         ...
                         <li>
                             出版社向け広告台割管理システム.<br>
                             <small class="text-muted">2.5 months, JQuery, HTML5, PHP Framework, MySQL | <a data-toggle="modal"
                                     data-target="#pop8" href="#">See More</a></small>
                         </li>
                         <!-- modal 8 -->
                         ...
                         <li>
                             ...
                             <small class="text-muted">2.5 months, JQuery, HTML5, PHP Framework, MySQL | <a data-toggle="modal"
                                     data-target="#pop9" href="#">See More</a></small>
                         </li>
                         <!-- modal 9 -->
                         ...
                         <li>
                             デジタルマップシステム開発.<br>
                             <small class="text-muted">3 months, PHP Framework, MySQL, Google map API, Java Script | <a
                                     data-toggle="modal" data-target="#pop10" href="#">See More</a></small>
                         </li>
                         <!-- modal 10 -->
                         ...
                         <li>
                             ...
                             <small class="text-muted">2 months, PHP Framework, MySQL, JQuery/Ajax, HTML5/CSS3 | <a
                                     data-toggle="modal" data-target="#pop11" href="#">See More</a></small>
                         </li>
                         <!-- modal 11 -->
                     ...
                     <div class="row">
                         <div class="col-md-12">
                             <ol class="ol-position">
                                 <li class="h4">
                                     <h4 class="new3">IT Department
                                         Headとして今まで数多くのシステム開発プロジェクトを経験したが、LOGIQUEほど、柔軟に対応してくれて、しかもそのクオリティーが高い開発会社はなかった。どうしてもユーザー部門から開発後期になってからの変更要望が出てしまったが、素早く対応して貰ったことに大変満足している。システム保守についてもお願いし、変わらずタイムリーで間違いのない対応をしてもらっており感謝している。
                                     </h4>
                                 </li>
                                 <li class="h4">
                                     <h4 class="new3">
                                         前開発会社と契約解消することになったために、LOGIQUEに引き継ぎ開発や既存システムの保守依頼をすることになった。ドキュメントや十分な情報がないなかで柔軟に効果的な仕事をしてくれて感謝している。私達も把握していなかった仕様上の問題点などを指摘していただき、依頼されたことだけをやるのとは真逆のことをしていただいた。
                                     </h4>
                                 </li>
                                 <li class="h4">
                                     <h4 class="new3">
                 ...
                 <div class="row" style="display: flex; flex-wrap: wrap;">
                     ...
                     <div class="col-md-8">
                         ...
                         <div class="row">
                             <div class="col-md-12">
                                 <h4 class="bold">経験</h4>
                                 <h4 class="" style="font-weight: 200;">
                                     LOGIQUEはインドネシアで豊富なシステム開発経験をもっています。スケジューリング、要件定義、システム開発、テスト、インフラ設計、Deploy、ユーザートレーニングなど、各工程でこの経験を活かします。
                                 </h4>
                             </div>
                         </div>
                         <br>
                         <div class="row">
                             <div class="col-md-12">
                                 ...
                                 <h4 class="" style="font-weight: 200;">
                                     ビジネスのスピードは日に日に早くなっています。システム開発に6ヶ月以上もかけていては、環境変化についていけません。LOGIQUEではスピードを最重要視しています。アジャイル開発で迅速に、要件の変更などにも柔軟に対応します。
                                 </h4>
                             </div>
                         </div>
                         <br>
                         <div class="row">
                             <div class="col-md-12">
                                 ...
                                 <h4 class="" style="font-weight: 200;">
                                     クオリティは犠牲にはできません。標準化された開発を行うことで不具合が少ない、メンテナンス性の高い開発をします。セキュリティ脆弱性のリスクも最小化した上で納品します。</h4>
                             </div>
                         </div>
                     </div>
                     <div class="col-md-12">
