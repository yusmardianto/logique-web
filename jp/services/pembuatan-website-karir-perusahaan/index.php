		...
		<div class="wrapper">
			...
			<section >
				<div class="solution-container">
					<div class="container">
						<div class="row">
							<div class="col-lg-7 col-md-6 col-sm-6 "><img src="images/bubble-text.png" class="img-responsive"></div>
			...
			<section class="reason-container">
				<div class="container">
					<center><img src="images/shadow1.png" alt="" style="margin-top: -5px;" class="img-responsive"></center>
					<div class="row">
						<div class="col-sm-4">
							<center>
