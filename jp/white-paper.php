    ...
    <div class="wrapper wrapper--update-design wrapper--update-design-font">
        ...
        <div class="whitepaper">
                    ...
                    <div class="container__">
                        <ol class="breadcrumb breadcrumb--update-design" itemscope itemtype="http://schema.org/BreadcrumbList">
                            <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item"
                                    href="/jp"><span itemprop="name">ホーム</span></a>
                                    <meta itemprop="position" content="1" />
                            </li>
                            <li class="active" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a
                                    itemprop="item"><span itemprop="name">&nbsp; ホワイトペーパー</span></a>
                    ...
                    <div class="py--40px container__">
                        <div class="row flex__row">
                            <div class="col-xs-12 col-md-8">
                                <h1 class="title-index fs--28px">インドネシアでのWeb制作、システム開発、ディジタルマーケティングに関するホワイトペーパー</h1>

                                <p class="my--20px">
                                    <!-- <strong>LOGIQUE</strong>  -->
                                    ロジックデジタルインドネシアは、Webサイト制作サービス、システム開発、Webアプリケーション開発、Webセキュリティ検査、およびその他のデジタルサービスを提供するITコンサルティング会社として、インドネシアでビジネスするクライアントのご支援をしてまいりました。
                                </p> 
                                <p>
                                    重ねてきた経験と培ってきたノウハウを活かしてクライアントの成功を支援し続けてまいりますが、一部、公開可能な情報をホワイトペーパーの形でご提供いたします。インドネシアでの効果的なウェブサイトやアプリケーション開発方法に関すること、また、潜在的なセキュリティ攻撃に対する保護、その影響、およびそれらを防止する方法についてのガイダンスも提供します。 無料でダウンロードできるホワイトペーパードキュメントの形式で提供していますのでお気軽にリクエストください。
                                </p>
                            </div>
                                ...
                                <div class="col-xs-12 col-md-8">
                                    <div class="contact__content">
                                        ...
                                        <p>
                                            LOGIQUEのコンサルタントにご相談                                            
                                            <br class="hidden-xs">
                                            <b class="text-uppercase">インドネシアのIT・デジタルマーケティングのことならLOGIQUEに相談</b> 
                                        </p>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-md-3">
                                    <a href="/hubungi-kami.php" class="form-control btn btn--yellow contact__btn"><b>「お問い合わせ」</b></a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section class="whitepaper__article">
                <div class="content-wrapper__">
                    <div class="container__">
                        <h3 class="mb--40px section-title">ダウンロード可能なホワイトペーパー一覧</h3>
            ...
            <section class="mb--40px whitepaper__link">
                <div class="content-wrapper__">
                    <div class="container__">
                        <h3 class="mb--40px section-title">
                             <strong>LOGIQUE</strong> デジタルインドネシアのサービス
                        </h3>
                        <p>
                            <strong>LOGIQUE</strong> 
                            デジタルインドネシアは、Webサイト、Webシステムおよびモバイルアプリケーション（Android | iOS |ハイブリッド）の開発、Webセキュリティ、デジタルマーケティングに関するコンサルティングを通してクライアントのインドネシアでの成功を支援しています
                        </p>
                        <?php include($_SERVER['DOCUMENT_ROOT'].'/layanan/assets/components/dm-links-jp.php') ?>
                    </div>
                </div>
            </section>
