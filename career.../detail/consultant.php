...
<head>
  ...
  <meta name="description" itemprop="description"
    content="Dicari Consultant yang mampu memberi saran strategis seputar teknologi, mendesain sistem dan IT network, merevisi sistem dan membantu masalah teknis. Must skill: sarjana, pengalaman IT consultant, sistem operasi dan database. Salary negotiable.">
  <meta name="keywords"
    content="lowongan, kerja, jakarta, remote job jakarta, kerja remote jakarta,  networking, Consultant, indonesia, web development, digital marketing, software consultation, salary, negotiable, sistem IT, komputer, IT, sistem operasi, database, analisa, skill, pengalaman, sarjana">
  ...
  <meta property="og:description"
    content="Dicari Consultant yang mampu menganalisa dan merekomendasikan solusi sistem web dan website terbaik untuk memecahkan masalah dalam proses bisnis. Seorang Consultant harus memiliki pengetahuan yang luas baik dari sisi bisnis maupun teknikal.">
  <link rel="shortcut icon" type="image/x-icon" href="/favicon.ico">
  <title>Lowongan - Consultant</title>
  ...
  <script type="application/ld+json">
  {
    ...
    "@type": "JobPosting",
    "title": "Consultant",
    "url": "https://www.logique.co.id/career/detail/consultant.php",
    "hiringOrganization": {
      "@type": "Corporation",
                ...
                <div class="content-vacancy">
                  <div class="div-job desc-job">
                    ...
                    <ul class="joinus-ul">
                      ...
                      <li>Terlibat dalam proses dan juga aktifitas sales</li>
                    </ul>
                    <br>
                    ...
                    <div class="text-center">
                      <br>
                      <a class="btn btn-yellow smooth" id="apply-c" href="https://logique.sugoisaiyo.com/"
                        onclick="ga('send', 'event', 'C-Apply-Button', 'Action-Click', 'C-Apply-Button-Label');"
