...
<head>
    ...
    <meta name="description" itemprop="description"
        content="Portofolio pembuatan & mengembangan aplikasi mobile (Android & iOS), Native & Hybrid dengan teknologi Flutter terkini berkualitas Internasional | LOGIQUE">
    <meta name="keywords"
    ...
    <meta property="og:title" content="Portofolio Jasa Pembuatan Aplikasi Mobile (Android & iOS)">
    ...
    <title>Portofolio Jasa Pembuatan Aplikasi Mobile (Android & iOS)</title>
    ...
    <link rel="canonical" href="https://www.logique.co.id/portofolio/mobile-app.php"/>
    <?php 
    ...
    <div class="wrapper wrapper--update-design wrapper--update-design-font">
        ...
        <div class="portfolio-update">
            ...
            <section class="portfolio__banner portfolio__banner-detail">
                <div class="content-wrapper__ --top">
                        ...
                        <div class="row flex__row align-items-center contact__content">
                            <div class="col-xs-12 col-md-8 content__image">
                                <div class="d-flex align-items-center">
                                    ...
                                    <p class="">Ingin Membuat dan Mengembangkan Aplikasi Mobile untuk Bisnis Anda? <br> Konsultasikan Kebutuhan Anda Bersama <span class="logo-font">LOGIQUE</span></p>        
                                </div>
                            </div>
